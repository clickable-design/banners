...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/angry_03.png?1468495741220", id:"angry_03"},
		{src:"images/angry_07.png?1468495741220", id:"angry_07"},
		{src:"images/angry_10.png?1468495741220", id:"angry_10"},
		{src:"images/angry_12.png?1468495741221", id:"angry_12"},
		{src:"images/bone.png?1468495741221", id:"bone"},
		{src:"images/btn.png?1468495741221", id:"btn"},
		{src:"images/cube.png?1468495741221", id:"cube"},
		{src:"images/fish.png?1468495741221", id:"fish"},
		{src:"images/good_03.png?1468495741221", id:"good_03"},
		{src:"images/good_06.png?1468495741221", id:"good_06"},
		{src:"images/good_10.png?1468495741221", id:"good_10"},
		{src:"images/good_12.png?1468495741221", id:"good_12"},
		{src:"images/good_13.png?1468495741221", id:"good_13"},
		{src:"images/gwregw.jpg?1468495741221", id:"gwregw"},
		{src:"images/nimb.png?1468495741221", id:"nimb"}
	]
};
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(83.1,63.5,1,1,0,0,0,64,17.7);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({y:56.5,alpha:1},10,cjs.Ease.get(1)).to({y:63.5},5,cjs.Ease.get(1)).wait(31).to({y:73.5},5,cjs.Ease.get(1)).to({y:-86.5},5,cjs.Ease.get(1)).wait(1));

	// Слой 1
	this.instance_1 = new lib.Символ43();
	this.instance_1.setTransform(-103.1,64,1.33,1.33,0,0,0,50,19.9);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(40).to({_off:false},0).to({y:57,alpha:1},10,cjs.Ease.get(1)).to({y:64},5,cjs.Ease.get(1)).wait(40).to({y:74},5,cjs.Ease.get(1)).to({y:-86},5,cjs.Ease.get(1)).wait(1));

	// Слой 3
	this.instance_2 = new lib.Символ42();
	this.instance_2.setTransform(-7.5,-48.4,1,1,0,0,0,98.2,21.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:61.6},9,cjs.Ease.get(1)).to({y:51.6},5,cjs.Ease.get(1)).wait(15).to({y:61.6},5,cjs.Ease.get(1)).to({y:-58.4},5,cjs.Ease.get(1)).to({_off:true},2).wait(65));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-105.7,-69.8,196.6,42.7);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({y:258.3},3,cjs.Ease.get(1)).to({y:274.4},1,cjs.Ease.get(1)).to({y:354.4},4,cjs.Ease.get(1)).wait(1));
	...
	this.instance_3.setTransform(88.8,52.1,1,1,0,0,0,94.2,34.2);
...
p.nominalBounds = new cjs.Rectangle(-33.5,-160.1,214,536);
...
(lib.pokormi_zverya_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.text.setTransform(170.8,57.1,0.754,0.754,0,0,0,94.2,34.3);

	this.instance = new lib.btn();
	this.instance.setTransform(70,200.8,0.757,0.757);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text}]}).to({state:[{t:this.instance}]},719).wait(1));

	// zver
	this.cat = new lib.Символ1();
	this.cat.setTransform(161,101.7,0.754,0.754,0,0,0,90,117.5);

	this.instance_1 = new lib.Символ25();
	this.instance_1.setTransform(104.4,208.1,0.718,0.718,4,0,0,40,33);

	this.instance_2 = new lib.Символ24();
	this.instance_2.setTransform(210.4,213.9,0.718,0.718,-6,0,0,83.5,51.6);

	this.instance_3 = new lib.Символ30();
	this.instance_3.setTransform(157.5,100.4,0.718,0.718,0,0,0,78,61);

	this.instance_4 = new lib.Символ28();
	this.instance_4.setTransform(155.8,156.4,0.718,0.718,2,0,0,68,37.5);

	this.instance_5 = new lib.Символ26();
	this.instance_5.setTransform(155.1,153.5,0.718,0.718,0,0,0,83,70);

	this.instance_6 = new lib.Символ27();
	this.instance_6.setTransform(158.6,211.7,0.718,0.718,0,0,0,90,86);
	...
	this.bg.setTransform(163.7,-80.5,0.754,0.754,0,0,0,295.2,97);

	this.instance_7 = new lib.Символ44();
	this.instance_7.setTransform(224,37.1,0.809,0.809,0,0,0,64,17.7);

	this.instance_8 = new lib.Символ43();
	this.instance_8.setTransform(73.3,37.5,1.076,1.076,0,0,0,50,19.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.bg}]}).to({state:[{t:this.instance_8},{t:this.instance_7}]},719).wait(1));

	// ramka
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#333333").ss(1,1,1).p("A5DwgIAAnCA5DwgMAurAAAAVywWIAAAKMAAAAmpIAABGAVowMIAKAAA5DXjIAAhGMAAAgmzIAAgKAVyWdMgu1AAAIiIAAAVywWIFaAAAbMWdIlaAAAVy3iIAAHMA7LwWICIAA");
	this.shape.setTransform(160.6,105.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(720));

	// Слой 4
	this.instance_9 = new lib.Символ61();
	this.instance_9.setTransform(120,36.5,2.196,0.51);
	...
	this.fon.setTransform(152,202.5);

	this.timeline.addTween(cjs.Tween.get(this.fon).to({_off:true},719).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-77.1,-3.6,710.1,662.1);
