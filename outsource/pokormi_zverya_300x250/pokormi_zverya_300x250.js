...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/angry_03.png?1468247399717", id:"angry_03"},
		{src:"images/angry_07.png?1468247399717", id:"angry_07"},
		{src:"images/angry_10.png?1468247399717", id:"angry_10"},
		{src:"images/angry_12.png?1468247399717", id:"angry_12"},
		{src:"images/bone.png?1468247399717", id:"bone"},
		{src:"images/btn.png?1468247399717", id:"btn"},
		{src:"images/cube.png?1468247399717", id:"cube"},
		{src:"images/fish.png?1468247399717", id:"fish"},
		{src:"images/good_03.png?1468247399717", id:"good_03"},
		{src:"images/good_06.png?1468247399717", id:"good_06"},
		{src:"images/good_10.png?1468247399717", id:"good_10"},
		{src:"images/good_12.png?1468247399717", id:"good_12"},
		{src:"images/good_13.png?1468247399717", id:"good_13"},
		{src:"images/nimb.png?1468247399717", id:"nimb"}
	]
};
...
(lib.pokormi_zverya_300x250 = function(mode,startPosition,loop) {
	...
	// ramka
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#333333").ss(1,1,1).p("A5DwgIAAnCA5DwgMAurAAAAVowMIAKAAMAAAAmpMgu1AAAMAAAgmzIAAgKAVywWIAAAKA5DXjIAAhGIiIAAAVyWdIAABGAbMWdIlaAAAVywWIFaAAAVy3iIAAHMA7LwWICIAA");
	this.shape.setTransform(160.6,105.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(720));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(135.6,35.6,350,573.6);
