...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/angry_03.png?1468832796793", id:"angry_03"},
		{src:"images/angry_07.png?1468832796793", id:"angry_07"},
		{src:"images/angry_10.png?1468832796793", id:"angry_10"},
		{src:"images/angry_12.png?1468832796793", id:"angry_12"},
		{src:"images/bone.png?1468832796793", id:"bone"},
		{src:"images/btn.png?1468832796793", id:"btn"},
		{src:"images/cube.png?1468832796793", id:"cube"},
		{src:"images/fish.png?1468832796793", id:"fish"},
		{src:"images/good_03.png?1468832796793", id:"good_03"},
		{src:"images/good_06.png?1468832796793", id:"good_06"},
		{src:"images/good_10.png?1468832796793", id:"good_10"},
		{src:"images/good_12.png?1468832796793", id:"good_12"},
		{src:"images/good_13.png?1468832796793", id:"good_13"},
		{src:"images/gwregw.jpg?1468832796793", id:"gwregw"},
		{src:"images/nimb.png?1468832796793", id:"nimb"}
	]
};
...
(lib.Символ59 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-437.8,-437.8,1.592,1.592);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-437.8,-437.8,875.7,875.7);
...
(lib.Символ60 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0,1.204,1.204);
...
p.nominalBounds = new cjs.Rectangle(-527.1,-527.1,1054.2,1054.2);
...
(lib.Символ44 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(64,18.7,1.395,1.395,0,0,0,64,17.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 2
	this.instance_1 = new lib.Символ46();
	this.instance_1.setTransform(64.1,17.3,1.395,1.395,0,0,0,75,27.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-41.2,-21.8,210.6,78.1);
...
(lib.Символ43 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(50.1,19.3,1.713,1.713,0,0,0,44.5,16.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-26.1,-9.2,152.4,57.2);
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(44.5,-223.1,1,1,0,0,0,18.1,10.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// text
	this.instance_1 = new lib.Символ19();
	this.instance_1.setTransform(46.1,-164.1,1,1,0,0,0,60.1,6.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-14,-195.1,126.9,37.9);
...
(lib.Символ8_1 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(73.3,-159.2,1,1,0,0,0,77,18.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(39).to({_off:false},0).to({y:158.1},9,cjs.Ease.get(1)).to({y:128.4},5,cjs.Ease.get(1)).wait(16).to({y:158.1},5).to({y:-156.5,alpha:0},5,cjs.Ease.get(1)).wait(1));

	// 1
	this.instance_2 = new lib.Символ9();
	this.instance_2.setTransform(94.2,-115.5,1,1,0,0,0,94.2,34.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:182.1},9,cjs.Ease.get(1)).to({y:152.4},5,cjs.Ease.get(1)).wait(15).to({y:182.1},5).to({y:-112.8,alpha:0},5,cjs.Ease.get(1)).to({_off:true},1).wait(40));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-3.7,-197.7,154.2,76.3);
...
(lib.Символ42 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(97.9,-98.6,1.304,1.304,0,0,0,53.7,28.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Символ 39
	this.instance_1 = new lib.Символ39();
	this.instance_1.setTransform(98,-32.6,1.49,1.49,0,0,0,9,6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Символ 38
	this.instance_2 = new lib.Символ38();
	this.instance_2.setTransform(97.8,31.4,1.415,1.415,0,0,0,52.6,28.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(23.3,-136.1,149.2,207.2);
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-8.2,40.3,1,1,0,0,0,64,17.7);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({y:33.3,alpha:1},10,cjs.Ease.get(1)).to({y:40.3},5,cjs.Ease.get(1)).wait(31).to({y:50.3},5,cjs.Ease.get(1)).to({y:-109.7},5,cjs.Ease.get(1)).wait(1));

	// Слой 1
	this.instance_1 = new lib.Символ43();
	this.instance_1.setTransform(-8.2,-104.3,1.33,1.33,0,0,0,50,19.9);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(40).to({_off:false},0).to({y:-111.3,alpha:1},10,cjs.Ease.get(1)).to({y:-104.3},5,cjs.Ease.get(1)).wait(40).to({y:-94.3},5,cjs.Ease.get(1)).to({y:-254.3},5,cjs.Ease.get(1)).wait(1));

	// Слой 3
	this.instance_2 = new lib.Символ42();
	this.instance_2.setTransform(-5.7,-275.7,1,1,0,0,0,98.2,21.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:31.3},9,cjs.Ease.get(1)).to({y:-10.3},5,cjs.Ease.get(1)).wait(15).to({y:21.3},0).to({y:31.3},5,cjs.Ease.get(1)).to({y:-275.7},5,cjs.Ease.get(1)).to({_off:true},2).wait(65));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-80.6,-433.3,149.2,207.2);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-159,218.5,1,1,0,0,0,107,28);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({x:73.3},3,cjs.Ease.get(1)).wait(1).to({x:-159},4,cjs.Ease.get(1)).wait(1));

	// mouse
	this.instance_1 = new lib.Символ18();
	this.instance_1.setTransform(84.1,286,1,1,0,0,0,60.1,6.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({y:187.5},0).to({alpha:0},3,cjs.Ease.get(1)).wait(1).to({alpha:1},4,cjs.Ease.get(1)).wait(1));

	// 2
	this.instance_2 = new lib.Символ32();
	this.instance_2.setTransform(141.6,53.9,1,1,0,0,0,61.7,34.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).to({alpha:1},3,cjs.Ease.get(1)).wait(1).to({alpha:0},4,cjs.Ease.get(1)).wait(1));

	// 1
	this.instance_3 = new lib.Символ8_1();
	this.instance_3.setTransform(94.2,-64.3,1,1,0,0,0,94.2,34.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({y:34.2},0).to({alpha:0},3,cjs.Ease.get(1)).wait(1).to({alpha:1},4,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-266,-296.2,416.4,536.2);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(8.5,483,1,1,0,0,0,90,86);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({y:193},3,cjs.Ease.get(1)).wait(1).to({y:483},4,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-104.7,130,302.1,495);
...
(lib.pokormi_zverya_160x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.text.setTransform(94.6,198.9,0.71,0.71,0,0,0,94.3,34.2);

	this.instance = new lib.btn();
	this.instance.setTransform(4.1,248.1,0.71,0.71);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text}]}).to({state:[{t:this.instance}]},719).wait(1));

	// zver
	this.cat = new lib.Символ1();
	this.cat.setTransform(45.6,651.2,0.89,0.89,0,0,0,47.1,375.7);

	this.instance_1 = new lib.Символ25();
	this.instance_1.setTransform(11.6,531,1,1,4,0,0,40,33);

	this.instance_2 = new lib.Символ24();
	this.instance_2.setTransform(159.2,539,1,1,-6,0,0,83.5,51.6);

	this.instance_3 = new lib.Символ30();
	this.instance_3.setTransform(85.6,381,1,1,0,0,0,78,61);

	this.instance_4 = new lib.Символ28();
	this.instance_4.setTransform(83.2,459,1,1,2,0,0,68,37.5);

	this.instance_5 = new lib.Символ26();
	this.instance_5.setTransform(82.1,455,1,1,0,0,0,83,70);

	this.instance_6 = new lib.Символ27();
	this.instance_6.setTransform(87.1,536,1,1,0,0,0,90,86);
	...
	this.bg.setTransform(115.2,152,1,1,0,0,0,295.2,97);

	this.instance_7 = new lib.Символ44();
	this.instance_7.setTransform(80,162,0.683,0.683,0,0,0,64,17.7);

	this.instance_8 = new lib.Символ43();
	this.instance_8.setTransform(80.5,67.8,0.943,0.943,0,0,0,49.9,20);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.bg}]}).to({state:[{t:this.instance_8},{t:this.instance_7}]},719).wait(1));

	// ramka
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#333333").ss(1,1,1).p("EAH+g+VIAAAKIKyAAEgRVg+LIAKAAIAAgKIZJAAAxLfPIgKAAMAAAhdaAHqfPI41AAASwfPIqyAAIgUAAEAHqg+LMAAABdaEgRLA/1MAAAggmAH+fPMAAAAgmAxVfPIhaAAEgSvg+LIBaAAEAH+g/0IAABfEgRLg+VIAAhf");
	this.shape.setTransform(111,399.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#333333").ss(1,1,1).p("EAH+g+VIAAAKIKyAAEgRVg+LIAKAAIAAgKIZJAAAxLfPIgKAAMAAAhdaAHqfPI41AAASwfPIqyAAIgUAAEAHqg+LMAAABdaAH+fPMAAAAgmEgRLA/1MAAAggmEgSvg+LIBaAAAxVfPIhaAAEgRLg+VIAAhfEAH+g/0IAABf");
	this.shape_1.setTransform(111,399.1);
	...
	this.instance_9.setTransform(120,193.5);
	...
	this.fon.setTransform(85,489.3);

	this.timeline.addTween(cjs.Tween.get(this.fon).to({_off:true},719).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-362.1,262.2,1054.2,1054.2);
