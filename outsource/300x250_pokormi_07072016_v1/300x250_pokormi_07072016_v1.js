...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/eee1.png?1467903441083", id:"eee1"},
		{src:"images/fasdfasdf.jpg?1467903441083", id:"fasdfasdf"},
		{src:"images/qqq.png?1467903441083", id:"qqq"},
		{src:"images/rhdhjhd.png?1467903441083", id:"rhdhjhd"},
		{src:"images/rrr1.png?1467903441083", id:"rrr1"}
	]
};
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-53.2,-36.5,1.291,1.291);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 3
	this.instance_1 = new lib.fasdfasdf();
	this.instance_1.setTransform(-97.2,-175.9,0.845,0.845);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-103.9,-175.9,209.5,338.1);
...
(lib.Символ27 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(242.1,-422.7,0.803,0.803);
	new cjs.ButtonHelper(this.instance, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149.7,-449.3,189,60);
