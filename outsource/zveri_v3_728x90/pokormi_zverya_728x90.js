...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/angry_03.png?1468495871746", id:"angry_03"},
		{src:"images/angry_07.png?1468495871746", id:"angry_07"},
		{src:"images/angry_10.png?1468495871746", id:"angry_10"},
		{src:"images/angry_12.png?1468495871746", id:"angry_12"},
		{src:"images/bone.png?1468495871746", id:"bone"},
		{src:"images/btn.png?1468495871746", id:"btn"},
		{src:"images/cube.png?1468495871746", id:"cube"},
		{src:"images/fish.png?1468495871746", id:"fish"},
		{src:"images/good_03.png?1468495871746", id:"good_03"},
		{src:"images/good_06.png?1468495871746", id:"good_06"},
		{src:"images/good_10.png?1468495871746", id:"good_10"},
		{src:"images/good_12.png?1468495871746", id:"good_12"},
		{src:"images/good_13.png?1468495871746", id:"good_13"},
		{src:"images/gwregw.jpg?1468495871746", id:"gwregw"},
		{src:"images/nimb.png?1468495871746", id:"nimb"}
	]
};
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({y:-35},3,cjs.Ease.get(1)).wait(1).to({y:45},4,cjs.Ease.get(1)).wait(1));

	// mouse
	this.instance_1 = new lib.Символ18();
	this.instance_1.setTransform(598.6,-7.3,1,1,0,0,0,60.1,6.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({_off:false},0).to({y:-30.1,alpha:1},3,cjs.Ease.get(1)).to({y:-17.1},1,cjs.Ease.get(1)).to({alpha:0},4,cjs.Ease.get(1)).wait(1));

	// 1
	this.instance_3 = new lib.Символ8_1();
	this.instance_3.setTransform(94.2,1.2,1,1,0,0,0,94.2,34.2);
...
p.nominalBounds = new cjs.Rectangle(-3.7,-211,655.1,277.5);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({y:227},3,cjs.Ease.get(1)).wait(1).to({y:475.4},4,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-104.7,130,327.1,467);
...
(lib.pokormi_zverya_728x90 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance = new lib.btn();
	this.instance.setTransform(494,18);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text}]}).to({state:[{t:this.instance}]},719).wait(1));

	// zver
	this.cat = new lib.Символ1();
	this.cat.setTransform(367.5,-6,0.552,0.552,0,0,0,90,117.5);

	this.instance_1 = new lib.Символ25();
	this.instance_1.setTransform(394.9,69.2,0.415,0.415,4,0,0,40,33);

	this.instance_2 = new lib.Символ24();
	this.instance_2.setTransform(456.1,72.6,0.415,0.415,-6,0,0,83.5,51.6);

	this.instance_3 = new lib.Символ30();
	this.instance_3.setTransform(425.6,6.9,0.415,0.415,0,0,0,78,61);

	this.instance_4 = new lib.Символ28();
	this.instance_4.setTransform(424.6,39.3,0.415,0.415,2,0,0,68,37.5);

	this.instance_5 = new lib.Символ26();
	this.instance_5.setTransform(424.1,37.7,0.415,0.415,0,0,0,82.9,70);

	this.instance_6 = new lib.Символ27();
	this.instance_6.setTransform(426.2,71.3,0.415,0.415,0,0,0,90,86);
	...
	this.bg.setTransform(381.4,-102.4,0.553,0.553,0,0,0,295.2,97);

	this.instance_7 = new lib.Символ44();
	this.instance_7.setTransform(272.7,47,1,1,0,0,0,64,17.7);

	this.instance_8 = new lib.Символ43();
	this.instance_8.setTransform(112.8,46.2,1.33,1.33,0,0,0,50,19.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.bg}]}).to({state:[{t:this.instance_8},{t:this.instance_7}]},719).wait(1));

	// ramka
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#333333").ss(1,1,1).p("EA58gfPIhJAAIAAAHIAAN3MhxpAAAEA46gRLIgHAAIAAgGEA9DgRLIkJAAMAAAAwbEg9CgfPIEMAAIAAAHMBxpAAAEg42gRLIAAgGIAAt3Eg42AfQMAAAgwbIjPAA");
	this.shape.setTransform(364,200);
...
p.nominalBounds = new cjs.Rectangle(113.9,-486.6,1206.3,1206.2);
