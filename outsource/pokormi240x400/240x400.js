...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/eee.jpg?1466758014256", id:"eee"},
		{src:"images/qqq.png?1466758014256", id:"qqq"},
		{src:"images/rrr.png?1466758014256", id:"rrr"},
		{src:"images/ttt.png?1466758014256", id:"ttt"},
		{src:"images/www.jpg?1466758014256", id:"www"},
		{src:"images/yyyy.png?1466758014256", id:"yyyy"}
	]
};
...
(lib.Символ49 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-56.1,-7.8,112.4,15.7);
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-20.1,-7.8,40.3,15.6);
...
(lib.Символ47 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-42,-7.1,84,14.2);
...
(lib.Символ46 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-53.3,-9.9,106.7,19.8);
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-77.1,-6.4,154.3,12.8);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#AA6FB0").s().p("");
	this.shape.setTransform(-4.2,4.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-45.3,-4.2,82.3,17.9);
...
(lib.Символ40 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-31.5,4.8,1,1,0,0,0,-56.1,-7.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(29).to({scaleX:1.26,scaleY:1.26},10).to({scaleX:1,scaleY:1},10).wait(31));

	// Символ 48
	this.instance_1 = new lib.Символ48();
	this.instance_1.setTransform(-40.5,4.9,1,1,0,0,0,20.2,-7.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({regX:20.1,scaleX:1.34,scaleY:1.34,x:-40.6},10).to({regX:20.2,scaleX:1,scaleY:1,x:-40.5},10).wait(41));

	// Символ 47
	this.instance_2 = new lib.Символ47();
	this.instance_2.setTransform(15.4,-2.1,1,1,0,0,0,-42,7.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(9).to({regY:7,scaleX:1.21,scaleY:1.21,y:-2.2},10).to({regY:7.1,scaleX:1,scaleY:1,y:-2.1},10).wait(51));

	// Символ 46
	this.instance_3 = new lib.Символ46();
	this.instance_3.setTransform(7.1,-2.3,1,1,0,0,0,53.1,8.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({scaleX:1.18,scaleY:1.18},9).to({scaleX:1,scaleY:1},10).wait(61));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-99.3,-20.5,198.7,41);
...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(59).call(this.frame_59).wait(16).call(this.frame_75).wait(15).call(this.frame_90).wait(15).call(this.frame_105).wait(15));

	// Слой 10
	this.instance = new lib.Символ40();
	this.instance.setTransform(1.1,-175.3);
