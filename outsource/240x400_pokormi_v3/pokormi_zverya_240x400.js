...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/angry_03.png?1468482148161", id:"angry_03"},
		{src:"images/angry_07.png?1468482148161", id:"angry_07"},
		{src:"images/angry_10.png?1468482148161", id:"angry_10"},
		{src:"images/angry_12.png?1468482148161", id:"angry_12"},
		{src:"images/bone.png?1468482148161", id:"bone"},
		{src:"images/btn.png?1468482148161", id:"btn"},
		{src:"images/cube.png?1468482148161", id:"cube"},
		{src:"images/fish.png?1468482148161", id:"fish"},
		{src:"images/good_03.png?1468482148161", id:"good_03"},
		{src:"images/good_06.png?1468482148161", id:"good_06"},
		{src:"images/good_10.png?1468482148161", id:"good_10"},
		{src:"images/good_12.png?1468482148161", id:"good_12"},
		{src:"images/good_13.png?1468482148161", id:"good_13"},
		{src:"images/gwregw.jpg?1468482148161", id:"gwregw"},
		{src:"images/nimb.png?1468482148161", id:"nimb"}
	]
};
...
(lib.Символ59 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-275,-275);
...
p.nominalBounds = new cjs.Rectangle(-331,-331,662.1,662.1);
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(44.5,-55.1,1,1,0,0,0,18.1,10.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// text
	this.instance_1 = new lib.Символ19();
	this.instance_1.setTransform(46.1,3.9,1,1,0,0,0,60.1,6.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-14,-27.1,126.9,37.9);
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({y:72.7,alpha:1},10,cjs.Ease.get(1)).to({y:79.7},5,cjs.Ease.get(1)).wait(31).to({y:89.7},5,cjs.Ease.get(1)).to({y:-70.3},5,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(40).to({_off:false},0).to({y:6.9,alpha:1},10,cjs.Ease.get(1)).to({y:13.9},5,cjs.Ease.get(1)).wait(40).to({y:23.9},5,cjs.Ease.get(1)).to({y:-136.1},5,cjs.Ease.get(1)).wait(1));

	// Слой 3
	this.instance_2 = new lib.Символ42();
	this.instance_2.setTransform(-5.7,-78.7,1,1,0,0,0,98.2,21.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:61.3},9,cjs.Ease.get(1)).to({y:41.3},5,cjs.Ease.get(1)).wait(15).to({y:51.3},5,cjs.Ease.get(1)).to({y:-88.7},5,cjs.Ease.get(1)).to({_off:true},2).wait(65));
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(73.5,354.4,1,1,0,0,0,107,28);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({y:274.4},3,cjs.Ease.get(1)).wait(1).to({y:354.4},4,cjs.Ease.get(1)).wait(1));

	// mouse
	this.instance_1 = new lib.Символ18();
	this.instance_1.setTransform(84.1,118.7,1,1,0,0,0,60.1,6.9);
	...
	this.instance_3.setTransform(94.2,34.2,1,1,0,0,0,94.2,34.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({alpha:0},3,cjs.Ease.get(1)).wait(1).to({alpha:1},4,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-33.5,-178,214,553.9);
...
(lib.pokormi_zverya_240x400 = function(mode,startPosition,loop) {
	...
	this.instance = new lib.btn();
	this.instance.setTransform(13,338);
	...
	this.instance_1.setTransform(52.7,344,1,1,4,0,0,40,33);

	this.instance_2 = new lib.Символ24();
	this.instance_2.setTransform(200.3,352,1,1,-6,0,0,83.5,51.6);

	this.instance_3 = new lib.Символ30();
	this.instance_3.setTransform(126.7,194,1,1,0,0,0,78,61);

	this.instance_4 = new lib.Символ28();
	this.instance_4.setTransform(124.3,272,1,1,2,0,0,68,37.5);

	this.instance_5 = new lib.Символ26();
	this.instance_5.setTransform(123.2,268,1,1,0,0,0,83,70);

	this.instance_6 = new lib.Символ27();
	this.instance_6.setTransform(128.2,349,1,1,0,0,0,90,86);
	...
	this.instance_7.setTransform(120.9,111.7,1,1,0,0,0,64,17.7);

	this.instance_8 = new lib.Символ43();
	this.instance_8.setTransform(121,45.9,1.33,1.33,0,0,0,50,19.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(720));

	// Слой 3
	this.instance_10 = new lib.Символ60();
	this.instance_10.setTransform(85,247.5);

	this.instance_11 = new lib.Символ59();
	this.instance_11.setTransform(85,247.5,1.204,1.204);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10}]}).to({state:[{t:this.instance_11}]},719).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-126.1,108.6,662.1,798.8);
