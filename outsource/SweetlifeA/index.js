...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/bg3.jpg?1465569497569", id:"bg3"},
		{src:"images/boch.png?1465569497569", id:"boch"},
		{src:"images/bochkaemp.png?1465569497569", id:"bochkaemp"},
		{src:"images/bochkaemp_1.png?1465569497569", id:"bochkaemp_1"},
		{src:"images/body.png?1465569497569", id:"body"},
		{src:"images/hand1.png?1465569497569", id:"hand1"},
		{src:"images/hand2.png?1465569497569", id:"hand2"},
		{src:"images/head.png?1465569497569", id:"head"},
		{src:"images/headl.png?1465569497569", id:"headl"},
		{src:"images/headr.png?1465569497569", id:"headr"},
		{src:"images/hendopen.png?1465569497569", id:"hendopen"},
		{src:"images/oblako.png?1465569497569", id:"oblako"},
		{src:"images/os.png?1465569497569", id:"os"},
		{src:"images/puzo.png?1465569497569", id:"puzo"},
		{src:"images/shadow.png?1465569497569", id:"shadow"}
	]
};
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(400.1,224.3,1.103,1.676,0,0,0,362.6,134.4);
	...
	this.arrow.setTransform(385.3,150.1,1.543,1.543,0,0,0,14.6,13.6);

	this.timeline.addTween(cjs.Tween.get(this.arrow).wait(1));

	// Слой 9
	this.boch2 = new lib.Символ22();
	this.boch2.setTransform(179.2,330.8,1.289,1.289,0,0,0,43,53.4);

	this.timeline.addTween(cjs.Tween.get(this.boch2).wait(1));

	// Слой 10
	this.instance_1 = new lib.Symbol44();
	this.instance_1.setTransform(107.3,89.2,1.514,1.514,0,0,180);

	this.instance_2 = new lib.Symbol44();
	this.instance_2.setTransform(206,243.7,1.514,1.514,0,0,180);

	this.instance_3 = new lib.Symbol44();
	this.instance_3.setTransform(263.8,128,1.514,1.514,0,0,180);

	this.instance_4 = new lib.Symbol44();
	this.instance_4.setTransform(223.4,13.5,1.514,1.514,0,0,180);
	...
	this.instance_5.setTransform(577.7,233.3,1.514,1.514);

	this.instance_6 = new lib.Symbol44();
	this.instance_6.setTransform(559.3,117.6,1.514,1.514);

	this.instance_7 = new lib.Symbol44();
	this.instance_7.setTransform(608,36.5,1.514,1.514);
	...
	this.boch1.setTransform(625.4,328.9,1.31,1.31,0,0,0,43,53.5);

	this.timeline.addTween(cjs.Tween.get(this.boch1).wait(1));

	// Слой 2
	this.miha = new lib.Symbol60();
	this.miha.setTransform(403.9,258,1.367,1.367,0,0,0,77.4,104.1);

	this.timeline.addTween(cjs.Tween.get(this.miha).wait(1));

	// shadow
	this.instance_8 = new lib.shadow();
	this.instance_8.setTransform(533.6,356.4,1.173,0.795);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1));

	// shadow
	this.instance_9 = new lib.shadow();
	this.instance_9.setTransform(106.9,359.9,1.024,0.694);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1));

	// shadow
	this.instance_10 = new lib.shadow();
	this.instance_10.setTransform(280.8,313.6,1.543,1.543);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1));

	// Слой 7
	this.instance_11 = new lib.Символ37();
	this.instance_11.setTransform(398.4,224.8,1.136,1.714,0,0,0,362.9,134.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-140.1,165.3,1360.9,516.1);
