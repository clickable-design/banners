...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/angry_03.png?1467889965014", id:"angry_03"},
		{src:"images/angry_07.png?1467889965014", id:"angry_07"},
		{src:"images/angry_10.png?1467889965014", id:"angry_10"},
		{src:"images/angry_12.png?1467889965014", id:"angry_12"},
		{src:"images/bone.png?1467889965014", id:"bone"},
		{src:"images/cube.png?1467889965014", id:"cube"},
		{src:"images/fish.png?1467889965014", id:"fish"},
		{src:"images/good_03.png?1467889965014", id:"good_03"},
		{src:"images/good_06.png?1467889965014", id:"good_06"},
		{src:"images/good_10.png?1467889965014", id:"good_10"},
		{src:"images/good_12.png?1467889965014", id:"good_12"},
		{src:"images/good_13.png?1467889965014", id:"good_13"},
		{src:"images/nimb.png?1467889965014", id:"nimb"}
	]
};
...
(lib.Символ44 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(64,18.3,1,1,0,0,0,64,17.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 2
	this.instance_1 = new lib.Символ46();
	this.instance_1.setTransform(64.1,17.3,1,1,0,0,0,75,27.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-11.4,-10.7,151,56);
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(44.5,-64.1,1,1,0,0,0,18.1,10.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// text
	this.instance_1 = new lib.Символ19();
	this.instance_1.setTransform(46.1,-5.1,1,1,0,0,0,60.1,6.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-14,-36.1,126.9,37.9);
...
(lib.Символ8_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(60).to({_off:false},0).to({y:20.2},9,cjs.Ease.get(1)).to({y:10.2},5,cjs.Ease.get(1)).wait(35).to({y:0.2},5,cjs.Ease.get(1)).to({y:60.2,alpha:0},5,cjs.Ease.get(1)).wait(1));

	// 1
	this.instance_2 = new lib.Символ9();
	this.instance_2.setTransform(94.2,-95.8,1,1,0,0,0,94.2,34.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:44.2},9,cjs.Ease.get(1)).to({y:34.2},5,cjs.Ease.get(1)).wait(35).to({y:24.2},5,cjs.Ease.get(1)).to({y:84.2,alpha:0},5,cjs.Ease.get(1)).to({_off:true},1).wait(60));
...
(lib.Символ42 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(97,19.8,0.8,0.8,0,0,0,9,6);

	this.instance_1 = new lib.Символ38();
	this.instance_1.setTransform(156.5,21.5,0.76,0.76,0,0,0,52.6,28.2);

	this.instance_2 = new lib.Символ37();
	this.instance_2.setTransform(37.6,20.9,0.7,0.7,0,0,0,53.7,28.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,196.6,42.7);
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-8.2,79.7,1,1,0,0,0,64,17.7);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(79).to({_off:false},0).to({y:72.7,alpha:1},10,cjs.Ease.get(1)).to({y:79.7},5,cjs.Ease.get(1)).wait(50).to({y:89.7},5,cjs.Ease.get(1)).to({y:-70.3},5,cjs.Ease.get(1)).wait(1));

	// Слой 1
	this.instance_1 = new lib.Символ43();
	this.instance_1.setTransform(-8.2,13.9,1.33,1.33,0,0,0,50,19.9);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(70).to({_off:false},0).to({y:6.9,alpha:1},10,cjs.Ease.get(1)).to({y:13.9},5,cjs.Ease.get(1)).wait(59).to({y:23.9},5,cjs.Ease.get(1)).to({y:-136.1},5,cjs.Ease.get(1)).wait(1));

	// Слой 3
	this.instance_2 = new lib.Символ42();
	this.instance_2.setTransform(-5.7,-78.7,1,1,0,0,0,98.2,21.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:31.3},9,cjs.Ease.get(1)).to({y:21.3},5,cjs.Ease.get(1)).wait(45).to({y:31.3},5,cjs.Ease.get(1)).to({y:-88.7},5,cjs.Ease.get(1)).to({_off:true},1).wait(85));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-103.9,-100.1,196.6,42.7);
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(163.8,77,1,1,0,0,0,109.9,151);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(53.9,-74,219.9,302.1);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(84.1,118.7,1,1,0,0,0,60.1,6.9);
	...
	this.instance_1.setTransform(141.6,-17.1,1,1,0,0,0,61.7,34.2);
	this.instance_1.alpha = 0;
	...
	this.instance_2.setTransform(94.2,34.2,1,1,0,0,0,94.2,34.2);
...
p.nominalBounds = new cjs.Rectangle(-24,-178,196.6,291.6);
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(142.8,110.3,0.89,0.89,0,0,0,123,98.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1,scaleY:1,x:152.8,y:106.3},29,cjs.Ease.get(1)).to({scaleX:0.89,scaleY:0.89,x:189.8,y:111.3},30,cjs.Ease.get(1)).to({x:142.8,y:110.3},40,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(9,18.5,247.6,184.7);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(8.5,503,1,1,0,0,0,90,86);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({y:213},3,cjs.Ease.get(1)).wait(1).to({y:503},4,cjs.Ease.get(1)).wait(1));

	// evil
	this.instance_1 = new lib.Символ17();
	this.instance_1.setTransform(60.4,254,1,1,0,0,0,142.2,107.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({y:414},3,cjs.Ease.get(1)).wait(1).to({y:254},4,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-72.8,164.6,265.1,480.4);
...
(lib.pokormi_zverya_240x400 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.text.setTransform(141.5,120.9,1,1,0,0,0,94.2,34.2);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

	// zver
	this.cat = new lib.Символ1();
	this.cat.setTransform(120.5,200,1,1,0,0,0,90,117.5);

	this.timeline.addTween(cjs.Tween.get(this.cat).wait(1));

	// box
	this.bg = new lib.Символ40();
	this.bg.setTransform(124.2,-47,1,1,0,0,0,295.2,97);

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1));

	// ramka
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#333333").ss(1,1,1).p("Ayv/PMAlfAAAMAAAA+fMglfAAAg");
	this.shape.setTransform(120,200);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(77.7,108.6,283.4,818.8);
