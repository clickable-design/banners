...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/eee.jpg?1466767982858", id:"eee"},
		{src:"images/qqq.png?1466767982858", id:"qqq"},
		{src:"images/rrr.png?1466767982858", id:"rrr"},
		{src:"images/ttt.png?1466767982858", id:"ttt"},
		{src:"images/www.jpg?1466767982858", id:"www"},
		{src:"images/yyyy.png?1466767982858", id:"yyyy"}
	]
};
...
(lib.Символ44 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-20.5,-37.1,0.204,0.204);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-20.5,-37.1,41.1,74.3);
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-70.7,-10.5,141.2,20.7);
...
(lib.Символ28 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#A35630","#F88147"],[0,1],0,27.5,0,-27.5).s().p("AvzEXIAAotIfnAAIAAItg");
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#AA6FB0").s().p("Az8sqMAn5AAAIAAWiMgn5ACzg");
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#AA6FB0").s().p("");
	this.shape.setTransform(-2.3,-5.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-20.1,-9.6,35.7,7.8);
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#AA6FB0").s().p("");
	this.shape.setTransform(7.7,-5.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-4.5,-9.6,24.6,8.7);
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-46.8,-11.6,93.7,23.3);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-18.3,-11.5,36.6,23.1);
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-32.2,-10.3,64.5,20.7);
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-43.2,-13.6,86.5,27.3);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(24.5,12.1,1.334,1.334);

	this.instance_1 = new lib.Символ15();
	this.instance_1.setTransform(-47,12.1,1.334,1.334);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-53,-0.8,98.3,11.6);
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-25,5.9,1,1,0,0,0,-46.8,-11.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({regX:0,regY:0,scaleX:1.09,scaleY:1.09,x:26,y:18.5},0).wait(1).to({scaleX:1.16,scaleY:1.16,x:29.4,y:19.3},0).wait(1).to({scaleX:1.21,scaleY:1.21,x:31.7,y:19.9},0).wait(1).to({scaleX:1.25,scaleY:1.25,x:33.5,y:20.4},0).wait(1).to({scaleX:1.28,scaleY:1.28,x:34.7,y:20.7},0).wait(1).to({scaleX:1.3,scaleY:1.3,x:35.6,y:20.9},0).wait(1).to({scaleX:1.31,scaleY:1.31,x:36.3,y:21.1},0).wait(1).to({scaleX:1.32,scaleY:1.32,x:36.9,y:21.2},0).wait(1).to({scaleX:1.34,scaleY:1.34,x:37.4,y:21.3},0).wait(1).to({regX:-46.8,regY:-11.6,scaleX:1.34,scaleY:1.34,x:-25,y:5.9},0).wait(1).to({regX:0,regY:0,scaleX:1.25,scaleY:1.25,x:33.6,y:20.4},0).wait(1).to({scaleX:1.18,scaleY:1.18,x:30.2,y:19.6},0).wait(1).to({scaleX:1.13,scaleY:1.13,x:27.9,y:19},0).wait(1).to({scaleX:1.09,scaleY:1.09,x:26.1,y:18.5},0).wait(1).to({scaleX:1.07,scaleY:1.07,x:24.9,y:18.2},0).wait(1).to({scaleX:1.05,scaleY:1.05,x:24,y:18},0).wait(1).to({scaleX:1.03,scaleY:1.03,x:23.3,y:17.8},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:22.7,y:17.7},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:22.2,y:17.6},0).wait(1).to({regX:-46.8,regY:-11.6,scaleX:1,scaleY:1,x:-25,y:5.9},0).wait(31));

	// Символ 7
	this.instance_1 = new lib.Символ7();
	this.instance_1.setTransform(-31.8,6,1,1,0,0,0,18.2,-11.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(20).to({regX:0,regY:0,scaleX:1.11,scaleY:1.11,x:-52.1,y:18.9},0).wait(1).to({scaleX:1.2,scaleY:1.2,x:-53.7,y:19.9},0).wait(1).to({scaleX:1.26,scaleY:1.26,x:-54.8,y:20.6},0).wait(1).to({scaleX:1.31,scaleY:1.31,x:-55.7,y:21.1},0).wait(1).to({scaleX:1.34,scaleY:1.34,x:-56.2,y:21.5},0).wait(1).to({scaleX:1.36,scaleY:1.36,x:-56.7,y:21.8},0).wait(1).to({scaleX:1.38,scaleY:1.38,x:-57,y:22},0).wait(1).to({scaleX:1.4,scaleY:1.4,x:-57.3,y:22.2},0).wait(1).to({scaleX:1.41,scaleY:1.41,x:-57.5,y:22.3},0).wait(1).to({regX:18.2,regY:-11.6,scaleX:1.42,scaleY:1.42,x:-31.8,y:6},0).wait(1).to({regX:0,regY:0,scaleX:1.31,scaleY:1.31,x:-55.7,y:21.2},0).wait(1).to({scaleX:1.22,scaleY:1.22,x:-54.1,y:20.2},0).wait(1).to({scaleX:1.16,scaleY:1.16,x:-53,y:19.4},0).wait(1).to({scaleX:1.12,scaleY:1.12,x:-52.1,y:18.9},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:-51.6,y:18.5},0).wait(1).to({scaleX:1.06,scaleY:1.06,x:-51.1,y:18.3},0).wait(1).to({scaleX:1.04,scaleY:1.04,x:-50.8,y:18.1},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:-50.5,y:17.9},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:-50.3,y:17.7},0).wait(1).to({regX:18.2,regY:-11.6,scaleX:1,scaleY:1,x:-31.8,y:6},0).wait(41));

	// Символ 6
	this.instance_2 = new lib.Символ6();
	this.instance_2.setTransform(14.3,-4.5,1,1,0,0,0,-32.2,10.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(10).to({regX:0,regY:0,scaleX:1.13,scaleY:1.13,x:50.6,y:-16.1},0).wait(1).to({scaleX:1.23,scaleY:1.23,x:53.8,y:-17.1},0).wait(1).to({scaleX:1.3,scaleY:1.3,x:56.1,y:-17.9},0).wait(1).to({scaleX:1.35,scaleY:1.35,x:57.7,y:-18.4},0).wait(1).to({scaleX:1.39,scaleY:1.39,x:58.9,y:-18.8},0).wait(1).to({scaleX:1.41,scaleY:1.41,x:59.8,y:-19.1},0).wait(1).to({scaleX:1.43,scaleY:1.43,x:60.5,y:-19.3},0).wait(1).to({scaleX:1.45,scaleY:1.45,x:61,y:-19.5},0).wait(1).to({scaleX:1.46,scaleY:1.46,x:61.5,y:-19.6},0).wait(1).to({regX:-32.2,regY:10.3,scaleX:1.48,scaleY:1.48,x:14.3,y:-4.5},0).wait(1).to({regX:0,regY:0,scaleX:1.35,scaleY:1.35,x:57.8,y:-18.4},0).wait(1).to({scaleX:1.25,scaleY:1.25,x:54.6,y:-17.4},0).wait(1).to({scaleX:1.18,scaleY:1.18,x:52.3,y:-16.7},0).wait(1).to({scaleX:1.13,scaleY:1.13,x:50.7,y:-16.1},0).wait(1).to({scaleX:1.09,scaleY:1.09,x:49.5,y:-15.8},0).wait(1).to({scaleX:1.07,scaleY:1.07,x:48.6,y:-15.5},0).wait(1).to({scaleX:1.05,scaleY:1.05,x:47.9,y:-15.3},0).wait(1).to({scaleX:1.03,scaleY:1.03,x:47.4,y:-15.1},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:46.9,y:-14.9},0).wait(1).to({regX:-32.2,regY:10.3,scaleX:1,scaleY:1,x:14.3,y:-4.5},0).wait(51));

	// Символ 5
	this.instance_3 = new lib.Символ5();
	this.instance_3.setTransform(7.7,-4.5,1,1,0,0,0,43.2,11);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({regX:0,regY:0,scaleX:1.08,scaleY:1.08,x:-38.8,y:-16.3},0).wait(1).to({scaleX:1.13,scaleY:1.13,x:-41.3,y:-17},0).wait(1).to({scaleX:1.17,scaleY:1.17,x:-43,y:-17.4},0).wait(1).to({scaleX:1.2,scaleY:1.2,x:-44.2,y:-17.7},0).wait(1).to({scaleX:1.22,scaleY:1.22,x:-45,y:-17.9},0).wait(1).to({scaleX:1.24,scaleY:1.24,x:-45.6,y:-18.1},0).wait(1).to({scaleX:1.25,scaleY:1.25,x:-46.1,y:-18.2},0).wait(1).to({scaleX:1.25,scaleY:1.25,x:-46.5,y:-18.3},0).wait(1).to({regX:43.2,regY:11,scaleX:1.26,scaleY:1.26,x:7.7,y:-4.5},0).wait(1).to({regX:0,regY:0,scaleX:1.19,scaleY:1.19,x:-43.9,y:-17.6},0).wait(1).to({scaleX:1.14,scaleY:1.14,x:-41.5,y:-17},0).wait(1).to({scaleX:1.1,scaleY:1.1,x:-39.8,y:-16.6},0).wait(1).to({scaleX:1.07,scaleY:1.07,x:-38.6,y:-16.3},0).wait(1).to({scaleX:1.05,scaleY:1.05,x:-37.7,y:-16.1},0).wait(1).to({scaleX:1.04,scaleY:1.04,x:-37.1,y:-15.9},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:-36.6,y:-15.8},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:-36.2,y:-15.7},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:-35.8,y:-15.6},0).wait(1).to({regX:43.2,regY:11,scaleX:1,scaleY:1,x:7.7,y:-4.5},0).wait(61));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-78.7,-29.1,157.5,58.3);
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(16.8,29.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 3
	this.instance_1 = new lib.yyyy();
	...
	this.instance_2.setTransform(281.2,-116.4,0.217,0.247,0,0,180);
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(37.2,-39.9,0.275,0.275,0,0,180);
...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-1.6,-175.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(120));

	// Символ 1
	this.instance_1 = new lib.Символ22();
	this.instance_1.setTransform(0,-144.9);
...
p.nominalBounds = new cjs.Rectangle(-292.8,-231.9,677.7,610);
