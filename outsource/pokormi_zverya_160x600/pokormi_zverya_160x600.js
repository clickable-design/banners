...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/angry_03.png?1468246277802", id:"angry_03"},
		{src:"images/angry_07.png?1468246277802", id:"angry_07"},
		{src:"images/angry_10.png?1468246277802", id:"angry_10"},
		{src:"images/angry_12.png?1468246277802", id:"angry_12"},
		{src:"images/bone.png?1468246277802", id:"bone"},
		{src:"images/btn.png?1468246277802", id:"btn"},
		{src:"images/cube.png?1468246277802", id:"cube"},
		{src:"images/fish.png?1468246277802", id:"fish"},
		{src:"images/good_03.png?1468246277802", id:"good_03"},
		{src:"images/good_06.png?1468246277802", id:"good_06"},
		{src:"images/good_10.png?1468246277802", id:"good_10"},
		{src:"images/good_12.png?1468246277802", id:"good_12"},
		{src:"images/good_13.png?1468246277802", id:"good_13"},
		{src:"images/nimb.png?1468246277802", id:"nimb"}
	]
};
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.instance_3.setTransform(94.2,14.5,1,1,0,0,0,94.2,34.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({y:113},0).to({alpha:0},3,cjs.Ease.get(1)).wait(1).to({alpha:1},4,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-266,-197.7,416.4,467.7);
...
p.nominalBounds = new cjs.Rectangle(-81.3,289.6,393.3,883.4);
