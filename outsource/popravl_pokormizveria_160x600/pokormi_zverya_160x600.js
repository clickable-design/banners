...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/angry_03.png?1468830910861", id:"angry_03"},
		{src:"images/angry_07.png?1468830910861", id:"angry_07"},
		{src:"images/angry_10.png?1468830910861", id:"angry_10"},
		{src:"images/angry_12.png?1468830910861", id:"angry_12"},
		{src:"images/bone.png?1468830910861", id:"bone"},
		{src:"images/btn.png?1468830910861", id:"btn"},
		{src:"images/cube.png?1468830910861", id:"cube"},
		{src:"images/fish.png?1468830910861", id:"fish"},
		{src:"images/good_03.png?1468830910861", id:"good_03"},
		{src:"images/good_06.png?1468830910861", id:"good_06"},
		{src:"images/good_10.png?1468830910861", id:"good_10"},
		{src:"images/good_12.png?1468830910861", id:"good_12"},
		{src:"images/good_13.png?1468830910861", id:"good_13"},
		{src:"images/gwregw.jpg?1468830910861", id:"gwregw"},
		{src:"images/nimb.png?1468830910861", id:"nimb"}
	]
};
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(44.5,-341.3,1,1,0,0,0,18.1,10.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// text
	this.instance_1 = new lib.Символ19();
	this.instance_1.setTransform(46.1,-282.3,1,1,0,0,0,60.1,6.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-14,-313.3,126.9,37.9);
...
(lib.Символ8_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(39).to({_off:false},0).to({y:20.2},9,cjs.Ease.get(1)).to({y:10.2},5,cjs.Ease.get(1)).wait(16).to({y:0.2},5,cjs.Ease.get(1)).to({y:60.2,alpha:0},5,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-266,-276.5,416.4,516.5);
...
(lib.pokormi_zverya_160x600 = function(mode,startPosition,loop) {
	...
	this.text.setTransform(94.6,168.9,0.71,0.71,0,0,0,94.3,34.2);
	...
	// ramka
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#333333").ss(1,1,1).p("EAH+g+VIAAAKIKyAAEgRVg+LIAKAAIAAgKIZJAAAxLfPIgKAAMAAAhdaAHqfPI41AAASwfPIqyAAIgUAAEAHqg+LMAAABdaAH+fPMAAAAgmEgRLA/1MAAAggmEgSvg+LIBaAAAxVfPIhaAAEgRLg+VIAAhfEAH+g/0IAABf");
	this.shape.setTransform(111,399.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#333333").ss(1,1,1).p("EAH+g+VIAAAKIKyAAEgRVg+LIAKAAIAAgKIZJAAAxLfPIgKAAMAAAhdaAHqfPI41AAASwfPIqyAAIgUAAEAHqg+LMAAABdaEgRLA/1MAAAggmAH+fPMAAAAgmAxVfPIhaAAEgSvg+LIBaAAEAH+g/0IAABfEgRLg+VIAAhf");
	...
	this.instance_9.setTransform(120,73.5);
...
p.nominalBounds = new cjs.Rectangle(-362.1,248.3,1054.2,1068.2);
