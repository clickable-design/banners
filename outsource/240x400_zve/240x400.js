...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/eee1.png?1467730840890", id:"eee1"},
		{src:"images/fasdfasdf.jpg?1467730840890", id:"fasdfasdf"},
		{src:"images/qqq.png?1467730840890", id:"qqq"},
		{src:"images/rhdhjhd.png?1467730840890", id:"rhdhjhd"},
		{src:"images/rrr1.png?1467730840890", id:"rrr1"}
	]
};
...
(lib.Символ3 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-38.6,25.8,1.291,1.291);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 3
	this.instance_1 = new lib.fasdfasdf();
	this.instance_1.setTransform(-83.8,-140.1,0.7,0.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-89.3,-140.1,173.6,280);
...
p.nominalBounds = new cjs.Rectangle(-292.8,-226.9,420.6,605);
...
p.nominalBounds = new cjs.Rectangle(-304.4,-349.6,725.1,657.1);
...
p.nominalBounds = new cjs.Rectangle(-101.7,139,725.1,658.1);
