...
(lib.Символ10 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#155983").s().p("");
	this.shape.setTransform(-24.1,8.3);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-112.2,-26.1,176.3,68.9);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:277,regY:124.5,x:23.5,y:511.8},0).wait(1).to({y:451.9},0).wait(1).to({y:415.2},0).wait(1).to({y:389.2},0).wait(1).to({y:367.1},0).wait(1).to({y:349},0).wait(1).to({y:334.8},0).wait(1).to({y:323.8},0).wait(1).to({y:315.4},0).wait(1).to({y:309.2},0).wait(1).to({y:304.8},0).wait(1).to({y:301.9},0).wait(1).to({y:300.3},0).wait(1).to({regX:276.8,regY:124.2,x:23.3,y:299.6},0).wait(44).to({regX:277,regY:124.5,x:23.5,y:301.9},0).wait(1).to({y:305.3},0).wait(1).to({y:310.4},0).wait(1).to({y:317.8},0).wait(1).to({y:328.3},0).wait(1).to({y:342.9},0).wait(1).to({y:362.6},0).wait(1).to({y:387.8},0).wait(1).to({y:417.9},0).wait(1).to({y:456},0).wait(1).to({y:510.5},0).wait(1).to({regX:276.8,regY:124.2,x:23.3,y:606.8},0).wait(191).to({regX:277,regY:124.5,x:23.5,y:524},0).wait(1).to({y:467.4},0).wait(1).to({y:429.8},0).wait(1).to({y:402.6},0).wait(1).to({y:380.9},0).wait(1).to({y:363.6},0).wait(1).to({y:349.8},0).wait(1).to({y:338.6},0).wait(1).to({y:329.2},0).wait(1).to({y:321.3},0).wait(1).to({y:314.8},0).wait(1).to({y:309.4},0).wait(1).to({y:305.1},0).wait(1).to({y:302},0).wait(1).to({regX:276.8,regY:124.2,x:23.3,y:299.6},0).wait(67).to({regX:277,regY:124.5,x:23.5,y:274.1},0).wait(1).to({y:265.7},0).wait(1).to({y:262.4},0).wait(1).to({regX:276.8,regY:124.2,x:23.3,y:260.8},0).wait(1).to({regX:277,regY:124.5,x:23.5,y:265.9},0).wait(1).to({y:272.8},0).wait(1).to({y:282.1},0).wait(1).to({y:294.2},0).wait(1).to({y:310.1},0).wait(1).to({y:332},0).wait(1).to({y:362.1},0).wait(1).to({y:413.5},0).wait(1).to({regX:276.8,regY:124.2,x:23.3,y:497.3},0).to({_off:true},1).wait(20));

	// Режим изоляции
	this.instance_1 = new lib.Символ9();
	this.instance_1.setTransform(23.3,-537.2,1,1,0,0,0,276.8,124.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:277,regY:124.5,x:23.5,y:-475.6},0).wait(1).to({y:-437},0).wait(1).to({y:-413.4},0).wait(1).to({y:-396.6},0).wait(1).to({y:-382.4},0).wait(1).to({y:-370.8},0).wait(1).to({y:-361.6},0).wait(1).to({y:-354.6},0).wait(1).to({y:-349.2},0).wait(1).to({y:-345.2},0).wait(1).to({y:-342.4},0).wait(1).to({y:-340.5},0).wait(1).to({y:-339.5},0).wait(1).to({regX:276.8,regY:124.2,x:23.3},0).wait(44).to({regX:277,regY:124.5,x:23.5,y:-340.5},0).wait(1).to({y:-342.7},0).wait(1).to({y:-345.9},0).wait(1).to({y:-350.7},0).wait(1).to({y:-357.5},0).wait(1).to({y:-366.9},0).wait(1).to({y:-379.6},0).wait(1).to({y:-395.8},0).wait(1).to({y:-415.1},0).wait(1).to({y:-439.7},0).wait(1).to({y:-474.7},0).wait(1).to({regX:276.8,regY:124.2,x:23.3,y:-537.2},0).wait(191).to({regX:277,regY:124.5,x:23.5,y:-479.1},0).wait(1).to({y:-439.8},0).wait(1).to({y:-413.7},0).wait(1).to({y:-394.8},0).wait(1).to({y:-379.6},0).wait(1).to({y:-367.6},0).wait(1).to({y:-358.1},0).wait(1).to({y:-350.3},0).wait(1).to({y:-343.7},0).wait(1).to({y:-338.3},0).wait(1).to({y:-333.7},0).wait(1).to({y:-330},0).wait(1).to({y:-327},0).wait(1).to({y:-324.8},0).wait(1).to({regX:276.8,regY:124.2,x:23.3,y:-323.7},0).wait(67).to({regX:277,regY:124.5,x:23.5,y:-301.9},0).wait(1).to({y:-294.9},0).wait(1).to({y:-292.2},0).wait(1).to({regX:276.8,regY:124.2,x:23.3,y:-291.4},0).wait(1).to({regX:277,regY:124.5,x:23.5,y:-295.8},0).wait(1).to({y:-302.5},0).wait(1).to({y:-311.4},0).wait(1).to({y:-323.2},0).wait(1).to({y:-338.7},0).wait(1).to({y:-360.1},0).wait(1).to({y:-389.3},0).wait(1).to({y:-439.3},0).wait(1).to({regX:276.8,regY:124.2,x:23.3,y:-521.4},0).to({_off:true},1).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(53).to({_off:false},0).wait(5).to({regX:-0.1,regY:0.1,x:-0.1,y:-46.3},0).wait(1).to({y:-81.3},0).wait(1).to({y:-104.7},0).wait(1).to({y:-121.2},0).wait(1).to({y:-134.1},0).wait(1).to({y:-144.1},0).wait(1).to({y:-151.4},0).wait(1).to({y:-156.8},0).wait(1).to({y:-160.8},0).wait(1).to({y:-163.8},0).wait(1).to({y:-166.1},0).wait(1).to({regX:0,regY:0,x:0,y:-168.3},0).to({_off:true},90).wait(89).to({_off:false,y:-223},0).to({y:-170.4},5,cjs.Ease.get(-1)).to({y:-104.5},6,cjs.Ease.get(1)).wait(89).to({y:-104.8},0).to({y:-214,alpha:0},5).to({_off:true},1).wait(20));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(159).to({_off:false},0).wait(2).to({regX:-0.1,regY:0.1,x:-0.1,y:-210},0).wait(1).to({y:-227.6},0).wait(1).to({y:-237.9},0).wait(1).to({y:-244.1},0).wait(1).to({y:-247.6},0).wait(1).to({y:-249.4},0).wait(1).to({regX:0,regY:0,x:0,y:-250.5},0).to({_off:true},81).wait(126));
	...
	this.instance_5.setTransform(12.7,104.2,1.743,1.743,0,0,0,102.5,14);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(268).to({_off:false},0).wait(80).to({y:103.8},0).to({y:197.2,alpha:0},5).to({_off:true},1).wait(20));

	// Слой 27
	this.instance_6 = new lib.Символ19();
	this.instance_6.setTransform(5.8,12.8,4.755,4.755,15);
	this.instance_6.alpha = 0.172;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(259).to({_off:false},0).to({scaleX:3.56,scaleY:3.56,rotation:7.3,y:12.7,alpha:0.59},3,cjs.Ease.get(-1)).to({scaleX:2.19,scaleY:2.19,rotation:0,y:12.8,alpha:1},3,cjs.Ease.get(1)).to({scaleX:2.36,scaleY:2.36},3,cjs.Ease.get(1)).wait(80).to({y:12.5},0).to({y:67.5,alpha:0},5).to({_off:true},1).wait(20));
	...
	this.instance_9.setTransform(8.4,19.2,0.217,0.217,-90);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(171).to({_off:false},0).wait(1).to({scaleX:0.41,scaleY:0.41,rotation:-58.5,alpha:0.35},0).wait(1).to({scaleX:0.51,scaleY:0.51,rotation:-41.3,alpha:0.541},0).wait(1).to({scaleX:0.58,scaleY:0.58,rotation:-30.6,alpha:0.66},0).wait(1).to({scaleX:0.63,scaleY:0.63,rotation:-22.5,alpha:0.75},0).wait(1).to({scaleX:0.66,scaleY:0.66,rotation:-16.2,alpha:0.82},0).wait(1).to({scaleX:0.69,scaleY:0.69,rotation:-11.8,alpha:0.869},0).wait(1).to({scaleX:0.71,scaleY:0.71,rotation:-8.5,alpha:0.905},0).wait(1).to({scaleX:0.72,scaleY:0.72,rotation:-6,alpha:0.933},0).wait(1).to({scaleX:0.74,scaleY:0.74,rotation:-4.1,alpha:0.954},0).wait(1).to({scaleX:0.75,scaleY:0.75,rotation:-2.5,alpha:0.972},0).wait(1).to({scaleX:0.75,scaleY:0.75,rotation:-1.2,alpha:0.987},0).wait(1).to({regX:-0.1,scaleX:0.76,scaleY:0.76,rotation:0,alpha:1},0).to({regX:0,scaleX:0.96,scaleY:0.96,rotation:65.7,x:8.3,y:19.5},54).wait(1).to({scaleX:0.94,scaleY:0.94,rotation:67.4,alpha:0.982},0).wait(1).to({scaleX:0.92,scaleY:0.92,rotation:70.2,alpha:0.95},0).wait(1).to({scaleX:0.88,scaleY:0.88,rotation:74.3,alpha:0.905},0).wait(1).to({scaleX:0.84,scaleY:0.84,rotation:80,y:19.4,alpha:0.842},0).wait(1).to({scaleX:0.77,scaleY:0.77,rotation:88,alpha:0.753},0).wait(1).to({scaleX:0.67,scaleY:0.67,rotation:99.6,alpha:0.623},0).wait(1).to({scaleX:0.52,scaleY:0.52,rotation:118.3,x:8.2,y:19.3,alpha:0.416},0).wait(1).to({scaleX:0.21,scaleY:0.21,rotation:155.7,x:8.3,y:19.2,alpha:0},0).to({_off:true},1).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(165).to({_off:false},0).to({x:7.9,y:-71.4,alpha:0.5},3,cjs.Ease.get(-1)).to({x:7.8,y:-101,alpha:1},3,cjs.Ease.get(1)).wait(66).to({y:-46.3,alpha:0},8).to({_off:true},1).wait(128));
	...
	this.instance_13.setTransform(40.4,267.2,2.35,2.35);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(103).to({_off:false},0).wait(1).to({regX:-8.1,regY:-2.6,x:21.4,y:250.1,alpha:0.554},0).wait(1).to({y:246.1,alpha:0.756},0).wait(1).to({y:243.4,alpha:0.893},0).wait(1).to({y:242.2,alpha:0.95},0).wait(1).to({y:241.7,alpha:0.979},0).wait(1).to({regX:0,regY:0,x:40.4,y:247.4,alpha:1},0).wait(42).to({y:211.2,alpha:0.602},3,cjs.Ease.get(-1)).to({y:197.9,alpha:0},2,cjs.Ease.get(1)).to({_off:true},1).wait(217));

	// Слой 19
	this.instance_14 = new lib.Символ11();
	this.instance_14.setTransform(10.9,173.6);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(87).to({_off:false},0).wait(1).to({regY:-5,y:145,alpha:0.554},0).wait(1).to({y:136.5,alpha:0.756},0).wait(1).to({y:130.6,alpha:0.893},0).wait(1).to({y:128.2,alpha:0.95},0).wait(1).to({y:127,alpha:0.979},0).wait(1).to({regY:0,y:131.1,alpha:1},0).wait(53).to({y:101.4,alpha:0.398},3,cjs.Ease.get(-1)).to({y:81.6,alpha:0},2,cjs.Ease.get(1)).to({_off:true},1).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(75).to({_off:false},0).wait(1).to({regX:-24.1,regY:8.3,x:-6.1,y:5.5,alpha:0.606},0).wait(1).to({y:-0.9,alpha:0.821},0).wait(1).to({y:-4.2,alpha:0.933},0).wait(1).to({y:-5.4,alpha:0.974},0).wait(1).to({regX:0,regY:0,x:21.4,y:-15.7,alpha:1},0).wait(61).to({y:-35.5,alpha:0.602},3,cjs.Ease.get(-1)).to({y:-65.2,alpha:0},2,cjs.Ease.get(1)).to({_off:true},1).wait(227));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(83).to({_off:false},0).wait(1).to({regX:0.2,x:-129.1,y:28.4},0).wait(1).to({y:59.1},0).wait(1).to({y:77.5},0).wait(1).to({y:91.6},0).wait(1).to({y:101.2},0).wait(1).to({y:107.3},0).wait(1).to({y:111.1},0).wait(1).to({y:113.6},0).wait(1).to({regX:0,x:-129.3,y:115.4},0).wait(54).to({y:95.6,alpha:0.602},2,cjs.Ease.get(-1)).to({y:65.9,alpha:0},3,cjs.Ease.get(1)).to({_off:true},1).wait(222));

	// Слой 13
	this.instance_18 = new lib.Символ4();
	this.instance_18.setTransform(-129.3,115.4);
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(97).to({_off:false},0).wait(1).to({regX:0.2,x:-129.1,y:162.4},0).wait(1).to({y:186.9},0).wait(1).to({y:201.7},0).wait(1).to({y:212.9},0).wait(1).to({y:220.6},0).wait(1).to({y:225.4},0).wait(1).to({y:228.5},0).wait(1).to({y:230.5},0).wait(1).to({regX:0,x:-129.3,y:231.9},0).wait(45).to({y:212.1,alpha:0.602},2,cjs.Ease.get(-1)).to({y:182.4,alpha:0},3,cjs.Ease.get(1)).to({_off:true},1).wait(217));
	...
	this.instance_20.setTransform(6.2,-15.2,0.834,0.834);
	this.instance_20.alpha = 0;
	this.instance_20.shadow = new cjs.Shadow("rgba(255,0,0,1)",0,0,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(1).to({scaleX:1.6,scaleY:1.6,alpha:0.355},0).wait(1).to({scaleX:2.03,scaleY:2.03,alpha:0.558},0).wait(1).to({scaleX:2.27,scaleY:2.27,alpha:0.671},0).wait(1).to({scaleX:2.46,scaleY:2.46,alpha:0.757},0).wait(1).to({scaleX:2.61,scaleY:2.61,alpha:0.826},0).wait(1).to({scaleX:2.72,scaleY:2.72,alpha:0.879},0).wait(1).to({scaleX:2.8,scaleY:2.8,alpha:0.919},0).wait(1).to({scaleX:2.87,scaleY:2.87,alpha:0.95},0).wait(1).to({scaleX:2.92,scaleY:2.92,alpha:0.972},0).wait(1).to({scaleX:2.95,scaleY:2.95,alpha:0.988},0).wait(1).to({scaleX:2.97,scaleY:2.97,alpha:0.997},0).wait(1).to({scaleX:2.98,scaleY:2.98,alpha:1},0).wait(26).to({scaleX:2.05,scaleY:2.05,x:-49.6,y:-8.1},0).wait(1).to({scaleX:1.63,scaleY:1.63,x:-74.6,y:-4.8},0).wait(1).to({scaleX:1.41,scaleY:1.41,x:-87.5,y:-3.2},0).wait(1).to({scaleX:1.28,scaleY:1.28,x:-95.7,y:-2.1},0).wait(1).to({scaleX:1.19,scaleY:1.19,x:-101.1,y:-1.4},0).wait(1).to({scaleX:1.13,scaleY:1.13,x:-104.8,y:-1},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:-107.4,y:-0.6},0).wait(1).to({scaleX:1.05,scaleY:1.05,x:-109.3,y:-0.4},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:-110.8,y:-0.2},0).wait(1).to({scaleX:1,scaleY:1,x:-112.2,y:0},0).wait(6).to({_off:true},1).wait(320));
...
(lib.adsniper_240x400 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#666666").ss(1,1,1).p("AyqfLMAAAg+aMAlVAAAMAAAA+agAyqfQIAAgF");
	this.shape.setTransform(119.5,200);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Слой 3
	this.main = new lib.Символ1();
	this.main.setTransform(118.9,202.2,0.603,0.603);

	this.timeline.addTween(cjs.Tween.get(this.main).wait(1));

	// Слой 1
	this.instance = new lib.Символ28();
	this.instance.setTransform(122.6,226.1,0.851,0.851,0,0,0,150,300.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(86.1,3.5,333.9,839.6);
