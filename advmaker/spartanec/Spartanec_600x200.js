...
(lib.Символ86 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(80.3,12.9);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,160.6,25.8);
...
(lib.Символ85 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FDD835").s().p("");
	this.shape.setTransform(90.6,24);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,8.1,181.1,31.9);
...
(lib.Символ90 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-49.3},39,cjs.Ease.get(-1)).to({y:85.7},30,cjs.Ease.get(1)).wait(1));
...
(lib.Символ88 = function() {
	...
	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(15.5,72.3);

	// Слой 3
	this.instance = new lib.Символ90();
	this.instance.setTransform(15.6,55.2,1,1,0,0,0,19.5,2.2);

	// Слой 1
	this.instance_1 = new lib.Символ89();
	this.instance_1.setTransform(16,70.5,1,1,0,0,0,16,70.5);

	this.addChild(this.instance_1,this.instance,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-3.4,0,39,141);
...
(lib.Символ87 = function() {
	...
	this.instance.setTransform(16,70.5,1,1,0,0,0,16,70.5);
...
(lib.Символ73 = function() {
	...
	this.instance.setTransform(80.3,15.8,1,1,0,0,0,80.3,12.8);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,3,160.6,25.8);
...
(lib.Символ72 = function() {
	...
	this.instance.setTransform(30.9,12.6,0.57,0.57,0,0,0,55.7,16.8);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-0.8,7.6,103.3,18.2);
...
p.nominalBounds = new cjs.Rectangle(-3.7,10.8,195.7,70.5);
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-227.7,93.1,1,1,0,0,0,31.6,10.6);
...
p.nominalBounds = new cjs.Rectangle(-263,-30.7,734,194.6);
