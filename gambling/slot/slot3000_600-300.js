...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/b1.png?1471339513379", id:"b1"},
		{src:"images/b2.png?1471339513379", id:"b2"},
		{src:"images/b3.png?1471339513379", id:"b3"},
		{src:"images/back.jpg?1471339513379", id:"back"},
		{src:"images/butt.png?1471339513379", id:"butt"},
		{src:"images/doll.png?1471339513379", id:"doll"},
		{src:"images/pole.png?1471339513379", id:"pole"},
		{src:"images/radial.png?1471339513379", id:"radial"},
		{src:"images/slotto.png?1471339513379", id:"slotto"},
		{src:"images/tree.png?1471339513379", id:"tree"},
		{src:"images/zero.png?1471339513379", id:"zero"}
	]
};
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("СДЕЛАТЬ ДЕПОЗИТ И ПОЛУчИТЬ БОНУС 3000$", "37px 'Bebas Neue Cyrillic'", "#330066");
	this.text.textAlign = "center";
	this.text.lineHeight = 39;
	this.text.lineWidth = 533;
	this.text.setTransform(213.7,2.4,0.962,0.962);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-42.8,2.4,516.9,87.2);
...
p.nominalBounds = new cjs.Rectangle(0,0,625,133.2);
