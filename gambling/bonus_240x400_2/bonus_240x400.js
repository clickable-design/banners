...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/bg.jpg?1467903475078", id:"bg"},
		{src:"images/girl_03.png?1467903475078", id:"girl_03"},
		{src:"images/girl_04.png?1467903475078", id:"girl_04"},
		{src:"images/girl_06.png?1467903475078", id:"girl_06"},
		{src:"images/girl_10.png?1467903475078", id:"girl_10"},
		{src:"images/logo.png?1467903475078", id:"logo"},
		{src:"images/slot_04.png?1467903475078", id:"slot_04"},
		{src:"images/slot_06.png?1467903475078", id:"slot_06"},
		{src:"images/slot_11.png?1467903475078", id:"slot_11"},
		{src:"images/slot_14.png?1467903475078", id:"slot_14"}
	]
};
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(133,227,1,1,18,0,0,64,12);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:16,y:227.1},5,cjs.Ease.get(1)).to({rotation:15,y:227},10,cjs.Ease.get(1)).to({regX:64.1,rotation:14},10,cjs.Ease.get(1)).to({regX:64,rotation:18},14,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-45,68,242.6,332.9);
...
p.nominalBounds = new cjs.Rectangle(0,0,242.6,332.9);
...
p.nominalBounds = new cjs.Rectangle(-26.9,-7.1,255.5,334);
...
p.nominalBounds = new cjs.Rectangle(-71.9,60.9,291.2,334);
