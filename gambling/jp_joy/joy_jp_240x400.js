...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/b1.png?1465376426711", id:"b1"},
		{src:"images/fr4.png?1465376426711", id:"fr4"},
		{src:"images/h1.png?1465376426711", id:"h1"},
		{src:"images/h2.png?1465376426711", id:"h2"},
		{src:"images/ha1.png?1465376426711", id:"ha1"},
		{src:"images/ha2.png?1465376426711", id:"ha2"},
		{src:"images/he1.png?1465376426711", id:"he1"},
		{src:"images/jp_fon.jpg?1465376426711", id:"jp_fon"},
		{src:"images/le1.png?1465376426712", id:"le1"},
		{src:"images/le2.png?1465376426712", id:"le2"},
		{src:"images/logo.png?1465376426712", id:"logo"},
		{src:"images/p6.png?1465376426712", id:"p6"},
		{src:"images/p78.png?1465376426712", id:"p78"},
		{src:"images/se04.png?1465376426712", id:"se04"},
		{src:"images/se1.png?1465376426712", id:"se1"},
		{src:"images/se2.png?1465376426712", id:"se2"},
		{src:"images/se3.png?1465376426712", id:"se3"},
		{src:"images/sr4.png?1465376426712", id:"sr4"},
		{src:"images/ti.png?1465376426712", id:"ti"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,144,60);
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-72,-30);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-72,-30,144,60);
...
(lib.Символ38 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.113},6,cjs.Ease.get(-1)).to({alpha:0},8,cjs.Ease.get(1)).to({alpha:0.094},7,cjs.Ease.get(-1)).to({alpha:0.359},8,cjs.Ease.get(1)).wait(1));
...
(lib.joy_jp_240x400 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_3.setTransform(120,35.1);
