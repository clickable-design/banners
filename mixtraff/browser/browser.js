...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/eattt.png?1466665811606", id:"eattt"},
		{src:"images/stripe.png?1466665811606", id:"stripe"},
		{src:"images/txttt.png?1466665811606", id:"txttt"}
	]
};
...
(lib.Символ36 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.txttt();
	this.instance.setTransform(-135.7,-38.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-135.7,-38.2,272,76);
...
(lib.Символ33 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("РЕКОМЕНДУЕТСЯ УСТАНОВИТЬ\nНОВЫЙ БРАУЗЕР", "bold 30px 'Helvetica'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 42;
	this.text.lineWidth = 781;
	this.text.setTransform(-1.5,-85.5,0.731,0.731);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-287.1,-85.4,574.3,81.3);
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(0.9,-35.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-215.7,-78.5,431.4,157);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(0.1,-93.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-392.6,-130.9,785.3,111.2);
...
(lib.Символ4 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-98.1,-4.2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-253,-39.5,431.1,118);
...
(lib.Символ19 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(70).call(this.frame_70).wait(1));
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-1.7,26.2,0.967,0.967);
...
p.nominalBounds = new cjs.Rectangle(-171,-31,332,95.4);
...
p.nominalBounds = new cjs.Rectangle(-212.4,-57,423.9,72);
...
(lib.Символ29 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(100).call(this.frame_100).wait(15).call(this.frame_115).wait(1));

	// Слой 10
	this.instance = new lib.Символ12копия();
	this.instance.setTransform(-2.1,137,1.17,1.17);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(98).to({_off:false},0).to({scaleX:0.75,scaleY:0.75,x:-2.3,y:136.1,alpha:1},6).wait(12));

	// FlashAICB
	this.instance_1 = new lib.Символ35();
	this.instance_1.setTransform(-6,133.1,1.566,1.566);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(98).to({_off:false},0).to({scaleX:1,scaleY:1,x:-4.8,y:133.6,alpha:1},6).wait(12));

	// Слой 4
	this.proc = new lib.Символ19();
	this.proc.setTransform(-1.6,54.5);

	this.timeline.addTween(cjs.Tween.get(this.proc).wait(13).to({scaleX:1.22,scaleY:1.22,x:-1.8,y:85.1},19).wait(62).to({y:213.1,alpha:0},6).wait(16));

	// Слой 7
	this.instance_2 = new lib.Символ31();
	this.instance_2.setTransform(-0.4,52.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({scaleX:1.22,scaleY:1.22,y:83.2},19).wait(62).to({y:211.2,alpha:0},6).wait(16));

	// mask
	this.mask = new lib.Символ16();
	this.mask.setTransform(-1.9,-7);

	this.timeline.addTween(cjs.Tween.get(this.mask).wait(13).to({scaleX:1.22,scaleY:1.22,x:-2.3,y:9.9},19).wait(62).to({y:137.9,alpha:0},6).wait(16));

	// Слой 3
	this.instance_3 = new lib.Символ12();
	this.instance_3.setTransform(0,62.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(13).to({scaleX:1.22,scaleY:1.22,x:0.1,y:95.3},19).wait(62).to({y:223.3,alpha:0},6).to({_off:true},1).wait(15));

	// Слой 8
	this.instance_4 = new lib.Символ32();
	this.instance_4.setTransform(-10,-209.8);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(100).to({_off:false},0).to({scaleX:1.25,scaleY:1.25,y:-96.2,alpha:1},14).wait(2));

	// Слой 1
	this.instance_5 = new lib.Символ30();
	this.instance_5.setTransform(0,-149.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:-230,alpha:0},15).to({_off:true},54).wait(47));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-212.4,-206.3,423.9,415.6);
...
(lib.Символ28 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(99).to({_off:false},0).to({alpha:1},8).wait(9));

	// Слой 5
	this.instance_1 = new lib.Символ2копия();
	this.instance_1.setTransform(9,141.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(99).to({_off:false},0).to({x:5,y:-14.2},8).wait(9));

	// Слой 2
	this.instance_2 = new lib.Символ21();
	this.instance_2.setTransform(2.4,-68,0.731,0.731);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:0},11).wait(105));

	// Слой 1
	this.instance_3 = new lib.Символ2();
	this.instance_3.setTransform(5,-14.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:145.8,alpha:0},11).wait(105));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-204.6,-161.6,414.2,210.2);
	...
	this.frame_0 = function() {
		...
		var onClick_1 = function () {
			_this.plate.gotoAndPlay(1);
				_this.plate.proc.gotoAndPlay(1);
				_this.plate.mask.gotoAndPlay(1);
