...
lib.properties = {
	...
	color: "#666666",
	manifest: [
		{src:"images/banner.png?1464262313817", id:"banner"},
		{src:"images/bg2.png?1464262313817", id:"bg2"},
		{src:"images/body_1.png?1464262313817", id:"body_1"},
		{src:"images/body_2.png?1464262313817", id:"body_2"},
		{src:"images/btn.png?1464262313817", id:"btn"},
		{src:"images/eye_1.png?1464262313817", id:"eye_1"},
		{src:"images/eye_bow.png?1464262313817", id:"eye_bow"},
		{src:"images/fire.png?1464262313817", id:"fire"},
		{src:"images/front.png?1464262313817", id:"front"},
		{src:"images/gun.png?1464262313817", id:"gun"},
		{src:"images/hand_1.png?1464262313817", id:"hand_1"},
		{src:"images/hand_2.png?1464262313817", id:"hand_2"},
		{src:"images/moon.png?1464262313817", id:"moon"},
		{src:"images/mouth_1.png?1464262313817", id:"mouth_1"},
		{src:"images/mouth_2.png?1464262313817", id:"mouth_2"}
	]
};
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#3E2A43","#000000"],[0,1],0,0,0,0,0,6.9).s().p("AgqArQgSgSAAgZQAAgYASgSQASgSAYAAQAZAAASASQASASAAAYQAAAZgSASQgSASgZAAQgYAAgSgSg");
...
(lib.Символ4_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regY:-20,scaleY:0.42,y:-90.6},0).wait(1).to({scaleY:0.61,y:-101.7},0).wait(1).to({scaleY:0.73,y:-108.7},0).wait(1).to({scaleY:0.82,y:-113.8},0).wait(1).to({scaleY:0.89,y:-117.9},0).wait(1).to({scaleY:0.93,y:-120.6},0).wait(1).to({scaleY:0.96,y:-122.2},0).wait(1).to({scaleY:0.98,y:-123.2},0).wait(1).to({scaleY:0.99,y:-123.8},0).wait(1).to({scaleY:1,y:-124.2},0).wait(1).to({regY:0,scaleY:1,y:-104.5},0).wait(58).to({alpha:0},13).to({_off:true},10).wait(12));

	// Символ 7
	this.instance_1 = new lib.Символ7();
	this.instance_1.setTransform(-66.3,-59.6,1,0.04);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regY:-20,scaleY:0.42,y:-77.7},0).wait(1).to({scaleY:0.61,y:-86.3},0).wait(1).to({scaleY:0.73,y:-91.6},0).wait(1).to({scaleY:0.82,y:-95.6},0).wait(1).to({scaleY:0.89,y:-98.7},0).wait(1).to({scaleY:0.93,y:-100.8},0).wait(1).to({scaleY:0.96,y:-102},0).wait(1).to({scaleY:0.98,y:-102.8},0).wait(1).to({scaleY:0.99,y:-103.3},0).wait(1).to({scaleY:1,y:-103.6},0).wait(1).to({regY:0,scaleY:1,y:-83.8},0).wait(15).to({scaleY:0.04,y:-99.6},3).wait(1).to({regY:-20,scaleY:0.79,y:-103},0).wait(1).to({scaleY:0.97,y:-103.7},0).wait(1).to({regY:0,scaleY:1,y:-83.8},0).wait(37).to({alpha:0},13).to({_off:true},10).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(46).to({_off:false},0).to({alpha:1},5).to({y:14.6},3,cjs.Ease.get(-1)).to({y:4.6},3,cjs.Ease.get(1)).to({y:14.6},3,cjs.Ease.get(-1)).to({y:4.6},3,cjs.Ease.get(1)).to({y:14.6},3,cjs.Ease.get(-1)).to({y:4.6},3,cjs.Ease.get(1)).wait(1).to({regX:10,scaleX:0.99,scaleY:0.99,x:2.4,y:4.3,alpha:0.982},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:2.2,y:3.9,alpha:0.951},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:2.1,y:3.4,alpha:0.903},0).wait(1).to({scaleX:0.94,scaleY:0.94,x:1.8,y:2.5,alpha:0.833},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:1.4,y:1.3,alpha:0.739},0).wait(1).to({scaleX:0.86,scaleY:0.86,x:1,y:0,alpha:0.633},0).wait(1).to({scaleX:0.82,scaleY:0.82,x:0.6,y:-1.2,alpha:0.527},0).wait(1).to({scaleX:0.77,scaleY:0.77,x:0.1,y:-3,alpha:0.381},0).wait(1).to({regX:-0.1,scaleX:0.62,scaleY:0.62,x:-7.6,y:-7.8,alpha:0},0).to({_off:true},1).wait(25));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(46).to({_off:false},0).to({alpha:1},5).to({y:21.7},3,cjs.Ease.get(-1)).to({y:29.2},3,cjs.Ease.get(1)).to({y:21.7},3,cjs.Ease.get(-1)).to({y:29.2},3,cjs.Ease.get(1)).to({y:21.7},3,cjs.Ease.get(-1)).to({y:29.2},3,cjs.Ease.get(1)).wait(1).to({regX:10,scaleX:0.99,scaleY:0.99,x:2.9,y:28.8,alpha:0.982},0).wait(1).to({scaleX:0.98,scaleY:0.98,x:2.7,y:28.1,alpha:0.951},0).wait(1).to({scaleX:0.96,scaleY:0.96,x:2.6,y:27.1,alpha:0.903},0).wait(1).to({scaleX:0.94,scaleY:0.94,x:2.3,y:25.6,alpha:0.833},0).wait(1).to({scaleX:0.9,scaleY:0.9,x:1.9,y:23.5,alpha:0.739},0).wait(1).to({scaleX:0.86,scaleY:0.86,x:1.5,y:21.2,alpha:0.633},0).wait(1).to({scaleX:0.82,scaleY:0.82,x:1.1,y:18.9,alpha:0.527},0).wait(1).to({scaleX:0.77,scaleY:0.77,x:0.5,y:15.8,alpha:0.381},0).wait(1).to({regX:0,scaleX:0.62,scaleY:0.62,x:-7.3,y:7.5,alpha:0},0).to({_off:true},1).wait(25));

	// Слой 1
	this.instance_4 = new lib.Символ5();
	this.instance_4.setTransform(0,-54.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({y:-34.1},0).wait(1).to({y:-22.4},0).wait(1).to({y:-14.9},0).wait(1).to({y:-9},0).wait(1).to({y:-4.8},0).wait(1).to({y:-2.1},0).wait(1).to({y:-0.4},0).wait(1).to({y:0.5},0).to({y:-19.5},6,cjs.Ease.get(1)).wait(29).to({scaleX:1.05,scaleY:1.05,y:-24.3},0).wait(1).to({scaleX:1.09,scaleY:1.09,y:-27.7},0).wait(1).to({scaleX:1.12,scaleY:1.12,y:-29.7},0).wait(1).to({scaleX:1.13,scaleY:1.13,y:-31},0).wait(1).to({scaleX:1.14,scaleY:1.14,y:-31.8},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:-32.4},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:-32.7},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:-33.1},0).wait(1).to({scaleX:1.16,scaleY:1.16,y:-33.4},0).to({y:-23.4},3,cjs.Ease.get(-1)).to({y:-33.4},3,cjs.Ease.get(1)).to({y:-23.4},3,cjs.Ease.get(-1)).to({y:-33.4},3,cjs.Ease.get(1)).to({y:-23.4},3,cjs.Ease.get(-1)).to({y:-33.4},3,cjs.Ease.get(1)).wait(1).to({scaleX:1.16,scaleY:1.16,y:-33.8},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:-34.1},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:-34.5},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:-35},0).wait(1).to({scaleX:1.14,scaleY:1.14,y:-35.6},0).wait(1).to({scaleX:1.14,scaleY:1.14,y:-36.4},0).wait(1).to({scaleX:1.13,scaleY:1.13,y:-37.5},0).wait(1).to({scaleX:1.12,scaleY:1.12,y:-39.1},0).wait(1).to({scaleX:1.1,scaleY:1.1,y:-40.9},0).wait(1).to({scaleX:1.09,scaleY:1.09,y:-43.1},0).wait(1).to({scaleX:1.07,scaleY:1.07,y:-45.8},0).wait(1).to({scaleX:1.04,scaleY:1.04,y:-49.5},0).wait(1).to({scaleX:1,scaleY:1,y:-54.5},0).wait(10).to({scaleX:1.18,scaleY:1.18,y:-59.2},5,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,y:-54.5},6,cjs.Ease.get(1)).wait(1));

	// Символ 6
	this.instance_5 = new lib.Символ6();
	this.instance_5.setTransform(0.2,-17.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1).to({regY:19.5,y:22.7},0).wait(1).to({y:34.4},0).wait(1).to({y:41.9},0).wait(1).to({y:47.8},0).wait(1).to({y:52},0).wait(1).to({y:54.7},0).wait(1).to({y:56.4},0).wait(1).to({regY:0,y:37.8},0).to({y:17.8},6,cjs.Ease.get(1)).wait(29).to({regY:19.5,scaleX:1.05,scaleY:1.05,y:48.4},0).wait(1).to({scaleX:1.09,scaleY:1.09,y:56.6},0).wait(1).to({scaleX:1.12,scaleY:1.12,y:61.1},0).wait(1).to({scaleX:1.13,scaleY:1.13,y:64.1},0).wait(1).to({scaleX:1.14,scaleY:1.14,y:66.1},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:67.3},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:68.3},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:69},0).wait(1).to({regY:0,scaleX:1.16,scaleY:1.16,y:47.2},0).to({y:37.2},3,cjs.Ease.get(-1)).to({y:47.2},3,cjs.Ease.get(1)).to({y:37.2},3,cjs.Ease.get(-1)).to({y:47.2},3,cjs.Ease.get(1)).to({y:37.2},3,cjs.Ease.get(-1)).to({y:47.2},3,cjs.Ease.get(1)).wait(1).to({regY:19.5,scaleX:1.16,scaleY:1.16,y:68.6},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:67.5},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:66.2},0).wait(1).to({scaleX:1.15,scaleY:1.15,y:64.8},0).wait(1).to({scaleX:1.14,scaleY:1.14,y:62.8},0).wait(1).to({scaleX:1.14,scaleY:1.14,y:60.2},0).wait(1).to({scaleX:1.13,scaleY:1.13,y:56.6},0).wait(1).to({scaleX:1.12,scaleY:1.12,y:51.5},0).wait(1).to({scaleX:1.1,scaleY:1.1,y:45.7},0).wait(1).to({scaleX:1.09,scaleY:1.09,y:38.8},0).wait(1).to({scaleX:1.07,scaleY:1.07,y:30},0).wait(1).to({scaleX:1.04,scaleY:1.04,y:18.3},0).wait(1).to({regY:0,scaleX:1,scaleY:1,y:-17.2},0).wait(10).to({scaleX:1.18,scaleY:1.18,y:-15.3},5,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,y:-17.2},6,cjs.Ease.get(1)).wait(1));
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0.1,0,1,1,0,0,0,-1.4,-27.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.23,scaleY:1.23},3,cjs.Ease.get(1)).to({regX:-1.5,regY:-27.7,scaleX:0.27,scaleY:0.27,x:0,alpha:0},8,cjs.Ease.get(-1)).to({regX:-1.4,regY:-27.8,scaleX:1.23,scaleY:1.23,x:0.1,alpha:1},8,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},3,cjs.Ease.get(-1)).wait(1));
...
(lib.game_banner = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function MonsterKill(){
				var windowSize = getWindowSize();
				var green_1 = _this.green_1.nominalBounds;
				var green_2 = _this.green_2.nominalBounds;
				if(_this.target.x < (windowSize.width/4) + (windowSize.width/8) && _this.target.y > windowSize.height - green_1.height){
				...
				if(_this.target.x > (windowSize.width * 0.75) - (windowSize.width/8) && _this.target.y > windowSize.height - green_2.height){
		...
		var onTouchStart = function() {
			...
			_this.target.x = touch.pageX;
			_this.target.y = touch.pageY;
		...
		var onTouchMove = function() {
			...
			_this.target.x = touch.pageX;
			_this.target.y = touch.pageY;
			_this.front.x = touch.pageX/20;
			_this.sky.x = -touch.pageX/20;
			event.preventDefault(); 
		};
		...
		var onTouchEnd = function() {
			console.log('end');
			var touch = event.targetTouches[0];
			_this.pricel.bow.play();
			_this.target.visible = false;
			MonsterKill();
			_this.title.gotoAndPlay(12);
			event.preventDefault();
	...
	this.win.setTransform(512,338.1,1,1,0,0,0,1.7,129.7);
