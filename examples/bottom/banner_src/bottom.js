...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1472727012298", id:"bg"},
		{src:"images/bgg.png?1472727012298", id:"bgg"},
		{src:"images/body.jpg?1472727012298", id:"body"},
		{src:"images/head.jpg?1472727012298", id:"head"}
	]
};
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(78.3,14.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-95.1,0.8,346.8,28);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,979);

	this.instance_1 = new lib.body();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,704);

	this.instance_2 = new lib.body();
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,429);
...
p.nominalBounds = new cjs.Rectangle(0,0,375,1254);
...
(lib.Symbol1_1 = function(mode,startPosition,loop) {
	...
	this.shape_2.graphics.f("#FFFFFF").s().p("AAAAWIgsAuIgYgWIAuguIgugtIAYgWIAsAuIAuguIAWAWIguAtIAuAuIgWAWg");
	this.shape_2.setTransform(382.8,107.2);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(88.1,579,1,1,0,0,0,26.2,26.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(127).to({_off:false},0).wait(1).to({regX:26.1,regY:26.1,scaleX:9.95,scaleY:9.95,x:93.1,y:415.9,alpha:0.455},0).wait(1).to({scaleX:13.56,scaleY:13.56,x:95.2,y:350.4,alpha:0.639},0).wait(1).to({scaleX:15.7,scaleY:15.7,x:96.4,y:311.3,alpha:0.748},0).wait(1).to({scaleX:17.34,scaleY:17.34,x:97.3,y:281.5,alpha:0.831},0).wait(1).to({scaleX:18.48,scaleY:18.48,x:98,y:260.6,alpha:0.889},0).wait(1).to({scaleX:19.17,scaleY:19.17,x:98.4,y:248.2,alpha:0.924},0).wait(1).to({scaleX:19.6,scaleY:19.6,x:98.6,y:240.3,alpha:0.946},0).wait(1).to({scaleX:19.92,scaleY:19.92,x:98.8,y:234.5,alpha:0.962},0).wait(1).to({scaleX:20.18,scaleY:20.18,x:98.9,y:229.7,alpha:0.976},0).wait(1).to({scaleX:20.43,scaleY:20.43,x:99.1,y:225.3,alpha:0.988},0).wait(1).to({regX:25.2,regY:26.2,scaleX:20.66,scaleY:20.66,x:101.2,y:222,alpha:1},0).to({alpha:0},6).to({_off:true},1).wait(58));

	// Layer 4
	this.instance_1 = new lib.Symbol1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-62.9,262,0.622,0.622,0,0,0,47.6,47.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(28).to({_off:false},0).wait(1).to({regX:45.6,x:-13.7},0).wait(1).to({x:24.5},0).wait(1).to({x:54.5},0).wait(1).to({x:78.6},0).wait(1).to({x:98.4},0).wait(1).to({x:114.8},0).wait(1).to({x:129.1},0).wait(1).to({x:141.2},0).wait(1).to({x:150.9},0).wait(1).to({x:158.7},0).wait(1).to({x:164.9},0).wait(1).to({x:170.1},0).wait(1).to({x:174.6},0).wait(1).to({x:178.7},0).wait(1).to({x:182.4},0).wait(1).to({regX:47.6,x:187.1},0).wait(1).to({regX:45.6,x:185.9,y:260.4},0).wait(1).to({y:258.2},0).wait(1).to({y:255.3},0).wait(1).to({y:251.6},0).wait(1).to({y:246.9},0).wait(1).to({y:240.9},0).wait(1).to({y:233.3},0).wait(1).to({y:224},0).wait(1).to({y:212.4},0).wait(1).to({y:192.3},0).wait(1).to({regX:47.6,x:187.1,y:162},0).wait(1).to({regX:45.6,x:185.9,y:189.1},0).wait(1).to({y:204.2},0).wait(1).to({y:215.2},0).wait(1).to({y:224.4},0).wait(1).to({y:232.9},0).wait(1).to({y:241.4},0).wait(1).to({y:248.5},0).wait(1).to({y:253.6},0).wait(1).to({y:257},0).wait(1).to({y:259.4},0).wait(1).to({y:260.9},0).wait(1).to({regX:47.6,x:187.1,y:262},0).wait(1).to({regX:45.6,x:185.9,y:260.4},0).wait(1).to({y:258.2},0).wait(1).to({y:255.3},0).wait(1).to({y:251.6},0).wait(1).to({y:246.9},0).wait(1).to({y:240.9},0).wait(1).to({y:233.3},0).wait(1).to({y:224},0).wait(1).to({y:212.4},0).wait(1).to({y:192.3},0).wait(1).to({regX:47.6,x:187.1,y:162},0).wait(1).to({regX:45.6,x:185.9,y:189.1},0).wait(1).to({y:204.2},0).wait(1).to({y:215.2},0).wait(1).to({y:224.4},0).wait(1).to({y:232.9},0).wait(1).to({y:241.4},0).wait(1).to({y:248.5},0).wait(1).to({y:253.6},0).wait(1).to({y:257},0).wait(1).to({y:259.4},0).wait(1).to({y:260.9},0).wait(1).to({regX:47.6,x:187.1,y:262},0).wait(9).to({regX:47.7,regY:47.7,x:143.2,y:402.9},8,cjs.Ease.get(-1)).to({regX:47.6,regY:47.6,x:88.1,y:579},10,cjs.Ease.get(1)).wait(8).to({regX:47.7,regY:47.7,scaleX:0.47,scaleY:0.47},2,cjs.Ease.get(-1)).to({regX:47.6,regY:47.6,scaleX:0.62,scaleY:0.62},3,cjs.Ease.get(1)).wait(20).to({regX:47.7,regY:47.7,x:203.1,y:492},7,cjs.Ease.get(-1)).to({regX:47.6,regY:47.6,x:351,y:380},9,cjs.Ease.get(1)).wait(4).to({scaleX:0.51,scaleY:0.51},3,cjs.Ease.get(-1)).to({scaleX:0.62,scaleY:0.62},4,cjs.Ease.get(1)).to({alpha:0},7).to({_off:true},1).wait(18));

	// Symbol 1
	this.instance_2 = new lib.Symbol1_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(963,718.9,1,1,0,0,0,996,180.5);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).wait(1).to({regX:221.1,regY:215.3,x:188.1,y:696.9},0).wait(1).to({y:651.6},0).wait(1).to({y:617.6},0).wait(1).to({y:592.2},0).wait(1).to({y:572.8},0).wait(1).to({y:557.9},0).wait(1).to({y:546.1},0).wait(1).to({y:536},0).wait(1).to({y:527.5},0).wait(1).to({y:520.5},0).wait(1).to({y:514.7},0).wait(1).to({y:510},0).wait(1).to({y:506.2},0).wait(1).to({y:503},0).wait(1).to({y:500.3},0).wait(1).to({y:498.1},0).wait(1).to({y:496.1},0).wait(1).to({y:494.4},0).wait(1).to({y:492.9},0).wait(1).to({y:491.5},0).wait(1).to({y:490.2},0).wait(1).to({regX:996,regY:180.5,x:963,y:454.2},0).wait(145).to({alpha:0},4).to({_off:true},1).wait(25));

	// Symbol 2
	this.instance_3 = new lib.Symbol2();
	this.instance_3.parent = this;
	this.instance_3.setTransform(187.5,217,1,1,0,0,0,187.5,214.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(45).to({regY:627,y:627.5},0).wait(1).to({y:624.9},0).wait(1).to({y:621.5},0).wait(1).to({y:617},0).wait(1).to({y:611.3},0).wait(1).to({y:604.2},0).wait(1).to({y:595},0).wait(1).to({y:583.9},0).wait(1).to({y:570},0).wait(1).to({y:545.9},0).wait(1).to({regY:214.5,y:97},0).to({y:-23},12,cjs.Ease.get(1)).wait(1).to({regY:627,y:387.7},0).wait(1).to({y:385.2},0).wait(1).to({y:381.8},0).wait(1).to({y:377.5},0).wait(1).to({y:372.1},0).wait(1).to({y:365.2},0).wait(1).to({y:356.8},0).wait(1).to({y:347.5},0).wait(1).to({y:336.3},0).wait(1).to({y:318.3},0).wait(1).to({regY:214.5,y:-123.9},0).to({y:-243},13,cjs.Ease.get(1)).wait(93).to({y:27},0).to({alpha:0},7,cjs.Ease.get(-1)).to({y:217},1,cjs.Ease.get(-1)).to({alpha:1},10).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,2.5,375,1254);
...
p.nominalBounds = new cjs.Rectangle(187.5,308,375,1254);
