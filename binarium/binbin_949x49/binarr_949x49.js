...
(lib.binarr_949x49 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.btn.setTransform(345.1,23.8,0.809,0.809,0,0,0,98.8,20.4);

	this.timeline.addTween(cjs.Tween.get(this.btn).wait(1));

	// Слой 9
	this.instance = new lib.Символ21();
	this.instance.setTransform(759.3,26.6,1,1,0,0,0,155.1,7.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 8
	this.instance_1 = new lib.Символ20();
	this.instance_1.setTransform(477.3,24,1,1,180,0,0,84.4,36.1);
	this.instance_1.alpha = 0.102;

	this.instance_2 = new lib.Символ20();
	this.instance_2.setTransform(148.7,24,1,1,0,0,0,18.2,36.1);
	...
	this.instance_3.setTransform(88,24.9,0.864,0.864,0,0,0,88,17.8);
...
p.nominalBounds = new cjs.Rectangle(474.5,-77.1,1066.7,183.6);
