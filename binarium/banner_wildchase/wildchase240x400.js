...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/avto.png?1467879073083", id:"avto"},
		{src:"images/baseGameBackground.jpg?1467879073083", id:"baseGameBackground"},
		{src:"images/button2.png?1467879073083", id:"button2"},
		{src:"images/goldconfetti1.png?1467879073083", id:"goldconfetti1"},
		{src:"images/lobbymockupM1mid_01.png?1467879073083", id:"lobbymockupM1mid_01"},
		{src:"images/lobbymockupM1mid_03.png?1467879073083", id:"lobbymockupM1mid_03"},
		{src:"images/lobbymockupM1mid_06.png?1467879073083", id:"lobbymockupM1mid_06"},
		{src:"images/LogoChase.png?1467879073083", id:"LogoChase"},
		{src:"images/ramka.png?1467879073083", id:"ramka"},
		{src:"images/reelGridFrame.png?1467879073083", id:"reelGridFrame"},
		{src:"images/slot.png?1467879073083", id:"slot"},
		{src:"images/text.png?1467879073083", id:"text"}
	]
};
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(100.1,14.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-0.7,5.6,201.8,17.5);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-7.7,-29.3,0.808,0.808);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-7.7,-29.3,206.8,126);
...
(lib.Символ20 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(85).to({_off:false},0).to({x:92.9,y:47.6,alpha:0.488},20).to({y:47.9,alpha:1},22).to({y:48.1,alpha:0.488},23).to({alpha:1},25).wait(20).to({alpha:0},5).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(85).to({_off:false},0).to({x:98.6,alpha:1},20).wait(90).to({alpha:0},5).wait(1));
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(160.3,85.6,1,1,0,0,0,108.7,43.9);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(85).to({_off:false},0).to({alpha:0.25},15).to({alpha:1},15).to({alpha:0.25},15).to({alpha:1},15).to({alpha:0.25},15).to({alpha:1},15).wait(20).to({alpha:0},5).wait(1));

	// Слой 7
	this.instance_3 = new lib.Символ14();
	this.instance_3.setTransform(245.2,22.8,1,1,0,0,0,54.4,228.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(16).to({y:7.5},4,cjs.Ease.get(-1)).to({y:240.1},15,cjs.Ease.get(1)).wait(5).to({y:222.1},5,cjs.Ease.get(-1)).to({y:458.8},15,cjs.Ease.get(1)).wait(5).to({y:440.4},5,cjs.Ease.get(-1)).to({y:937.6},15,cjs.Ease.get(1)).wait(115).to({y:22.8},0).wait(1));

	// Слой 5
	this.instance_4 = new lib.Символ15();
	this.instance_4.setTransform(202.7,64.5,1,1,0,0,0,54.4,228.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(12).to({y:49.2},4,cjs.Ease.get(-1)).to({y:281.9},15,cjs.Ease.get(1)).wait(5).to({y:263.9},5,cjs.Ease.get(-1)).to({y:500.6},15,cjs.Ease.get(1)).wait(5).to({y:482.1},5,cjs.Ease.get(-1)).to({y:935.7},15,cjs.Ease.get(1)).wait(119).to({y:64.5},0).wait(1));

	// Слой 4
	this.instance_5 = new lib.Символ16();
	this.instance_5.setTransform(159.1,109.7,1,1,0,0,0,54.4,228.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(8).to({y:94.4},4,cjs.Ease.get(-1)).to({y:327},15,cjs.Ease.get(1)).wait(5).to({y:309},5,cjs.Ease.get(-1)).to({y:545.7},15,cjs.Ease.get(1)).wait(5).to({y:527.3},5,cjs.Ease.get(-1)).to({y:936.8},15,cjs.Ease.get(1)).wait(123).to({y:109.7},0).wait(1));

	// Слой 3
	this.instance_6 = new lib.Символ17();
	this.instance_6.setTransform(116.7,22.3,1,1,0,0,0,54.4,228.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({y:7},4,cjs.Ease.get(-1)).to({y:239.7},15,cjs.Ease.get(1)).wait(5).to({y:221.7},5,cjs.Ease.get(-1)).to({y:458.4},15,cjs.Ease.get(1)).wait(5).to({y:439.9},5,cjs.Ease.get(-1)).to({y:936.7},15,cjs.Ease.get(1)).wait(127).to({y:22.3},0).wait(1));

	// Слой 2
	this.instance_7 = new lib.Символ18();
	this.instance_7.setTransform(72.7,67.2,1,1,0,0,0,54.4,228.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({y:51.9},4,cjs.Ease.get(-1)).to({y:284.5},15,cjs.Ease.get(1)).wait(5).to({y:266.5},5,cjs.Ease.get(-1)).to({y:503.2},15,cjs.Ease.get(1)).wait(5).to({y:484.8},5,cjs.Ease.get(-1)).to({y:937.5},15,cjs.Ease.get(1)).wait(131).to({y:67.2},0).wait(1));
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(85).to({_off:false},0).to({y:54.5,alpha:1},15).wait(95).to({alpha:0},5).wait(1));
