...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/avto.png?1467900431908", id:"avto"},
		{src:"images/baseGameBackground.jpg?1467900431908", id:"baseGameBackground"},
		{src:"images/button2.png?1467900431908", id:"button2"},
		{src:"images/coin2_0.png?1467900431908", id:"coin2_0"},
		{src:"images/coin2_1.png?1467900431908", id:"coin2_1"},
		{src:"images/coin2_2.png?1467900431908", id:"coin2_2"},
		{src:"images/coin2_3.png?1467900431908", id:"coin2_3"},
		{src:"images/coin2_4.png?1467900431908", id:"coin2_4"},
		{src:"images/coin2_5.png?1467900431908", id:"coin2_5"},
		{src:"images/coin2_6.png?1467900431908", id:"coin2_6"},
		{src:"images/coin2_7.png?1467900431908", id:"coin2_7"},
		{src:"images/evro.png?1467900431908", id:"evro"},
		{src:"images/lobbymockupM1mid_01.png?1467900431908", id:"lobbymockupM1mid_01"},
		{src:"images/lobbymockupM1mid_03.png?1467900431908", id:"lobbymockupM1mid_03"},
		{src:"images/lobbymockupM1mid_06.png?1467900431908", id:"lobbymockupM1mid_06"},
		{src:"images/LogoChase.png?1467900431908", id:"LogoChase"},
		{src:"images/ramka.png?1467900431908", id:"ramka"},
		{src:"images/reelGridFrame.png?1467900431908", id:"reelGridFrame"},
		{src:"images/slot.png?1467900431908", id:"slot"},
		{src:"images/yelow_avto.png?1467900431908", id:"yelow_avto"}
	]
};
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},39).to({state:[{t:this.instance}]},40).to({state:[{t:this.instance_1}]},121).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:false},0).to({scaleX:0.68,scaleY:0.68,x:216.5,y:-25.6},40,cjs.Ease.get(-1)).to({_off:true,scaleX:1,scaleY:1,x:392,y:-29.1},121).wait(1));

	// Слой 1
	this.instance_2 = new lib.Символ25();
	this.instance_2.setTransform(-203.9,-9.3,1,1,0,0,0,75,43);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:0.62,scaleY:0.61,skewY:5.7,x:306,y:-20.3},39,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,skewY:0,x:815.2,y:-35.9},161).wait(1));
