...
(lib.Символ4 = function() {
	...
	// Слой 4 - копия
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(87.4,18.5);
...
(lib.bin_950x50 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
