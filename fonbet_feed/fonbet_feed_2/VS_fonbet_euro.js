...
lib.properties = {
	...
	color: "#669933",
	manifest: [
		{src:"images/blick.png?1465561395885", id:"blick"},
		{src:"images/circle_blick.png?1465561395885", id:"circle_blick"},
		{src:"images/gaz.jpg?1465561395885", id:"gaz"},
		{src:"images/zagl.png?1465561395885", id:"zagl"},
		{src:"images/zagl_2.png?1465561395885", id:"zagl_2"}
	]
};
...
(lib.VS_fonbet_euro = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var tween = createjs.Tween.get(this.flag_1, {loop: true}).to({y: 239}, 2000, createjs.Ease.quadInOut).to({y: 113}, 2000, createjs.Ease.quadInOut);
		
		var tween_2 = createjs.Tween.get(this.flag_2, {loop: true}).to({y: 113}, 2000, createjs.Ease.quadInOut).to({y: 239}, 2000, createjs.Ease.quadInOut);
