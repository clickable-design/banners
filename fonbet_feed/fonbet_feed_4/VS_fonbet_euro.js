...
lib.properties = {
	...
	color: "#669933",
	manifest: [
		{src:"images/blick.png?1465561990934", id:"blick"},
		{src:"images/circle_blick.png?1465561990934", id:"circle_blick"},
		{src:"images/gaz.jpg?1465561990934", id:"gaz"},
		{src:"images/zagl.png?1465561990934", id:"zagl"},
		{src:"images/zagl_2.png?1465561990934", id:"zagl_2"}
	]
};
...
(lib.VS_fonbet_euro = function(mode,startPosition,loop) {
	...
	this.flag_2.setTransform(537.3,177,0.327,0.327);

	this.flag_1 = new lib.flag_1();
	this.flag_1.setTransform(60.3,177,0.327,0.327);
