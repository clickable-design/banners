...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bgg.png?1474032433901", id:"bgg"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,281.2,72.6);
...
p.nominalBounds = new cjs.Rectangle(0,0,366.7,72.6);
...
p.nominalBounds = new cjs.Rectangle(0,0,366.7,150.8);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.text.parent = this;
	this.text.setTransform(24,13.4,0.599,0.599);

	this.instance = new lib.Symbol8();
	this.instance.parent = this;
	this.instance.setTransform(111.2,22.8,0.599,0.599,0,0,0,16,11.7);
...
(lib.down = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(111.1,24.4,0.599,0.599,0,0,0,16,11.7);

	this.text = new cjs.Text("ВНИЗ", "italic bold 34px 'Roboto'", "#F6BC03");
	this.text.lineHeight = 42;
	this.text.lineWidth = 133;
	this.text.parent = this;
	this.text.setTransform(25.7,12.5,0.599,0.599);
...
(lib.up = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(71.6,24.4,1,1,0,0,0,71.6,24.4);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function () {
			...
			var StageScale = windowSize.width/320;
			var StageScale1 = 414/320;
			var GraphScale = 0.7;
			
			_this.graph.x = 0;
			_this.graph.y = 250;
			_this.graph.scaleX = GraphScale;
			_this.graph.scaleY = GraphScale;
	...
	this.down.setTransform(313.9,238.8,1,1,0,0,0,143.2,48.9);

	this.up = new lib.up();
	this.up.parent = this;
	this.up.setTransform(8.9,238.8,1,1,0,0,0,0,48.9);
	...
	this.title.setTransform(-2,15.3,0.761,0.761,0,0,0,-2.6,-1.5);
	...
	this.graph.setTransform(-2,249,1,1,0,0,0,81,253.9);

	this.timeline.addTween(cjs.Tween.get(this.graph).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-396.5,120.2,15696.5,309.9);
