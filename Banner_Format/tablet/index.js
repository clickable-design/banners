...
(lib.index = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function () {
			...
			var StageScale = 1;
			var StageScale1 = windowSize.height / 230;
			var StageScale2 = 200 / 230;
			...
			_this.title.x = 0;
			_this.title.y = windowSize.height * 0.25;
			_this.title.scaleX = StageScale;
			_this.title.scaleY = StageScale;
			
			_this.up.x = windowSize.width * 0.97;
			_this.up.y = windowSize.height * 0.25;
			_this.up.scaleX = StageScale;
			_this.up.scaleY = StageScale;
			
			_this.down.x = windowSize.width * 0.97;
			_this.down.y = windowSize.height * 0.75;
			_this.down.scaleX = StageScale;
			_this.down.scaleY = StageScale;
			
			if (windowSize.height < 230) {
				_this.title.scaleX = StageScale1;
				_this.title.scaleY = StageScale1;
				_this.up.scaleX = StageScale1;
				_this.up.scaleY = StageScale1;
				_this.down.scaleX = StageScale1;
				_this.down.scaleY = StageScale1;
				_this.graph.scaleX = StageScale1;
				_this.graph.scaleY = StageScale1;
			}
			if (windowSize.width < 630) {
				_this.title.scaleX = StageScale2;
				_this.title.scaleY = StageScale2;
				_this.up.scaleX = StageScale2;
				_this.up.scaleY = StageScale2;
				_this.down.scaleX = StageScale2;
				_this.down.scaleY = StageScale2;
				_this.graph.scaleX = StageScale;
				_this.graph.scaleY = StageScale;
				_this.up.x = windowSize.width * 0.38;
				_this.up.y = windowSize.height * 0.80;
				_this.down.x = windowSize.width * 0.97;
				_this.down.y = windowSize.height * 0.80;
			}
	...
	this.down.setTransform(970.9,177.1,1,1,0,0,0,239,40.8);

	this.up = new lib.up();
	this.up.parent = this;
	this.up.setTransform(970.9,78.7,1,1,0,0,0,239,40.8);
	...
	this.title.setTransform(-2,78.4,1,1,0,0,0,-2,41.9);
