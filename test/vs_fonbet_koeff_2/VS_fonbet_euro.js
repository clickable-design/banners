...
lib.properties = {
	...
	color: "#669933",
	manifest: [
		{src:"images/gaz.jpg?1465482604488", id:"gaz"},
		{src:"images/zagl.png?1465482604488", id:"zagl"},
		{src:"images/zagl_2.png?1465482604488", id:"zagl_2"}
	]
};
...
(lib.kom_2 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("Команда", "bold 20px 'Roboto Condensed'", "#FFFFFF");
...
(lib.koef_3 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("1.45", "bold 21px 'Roboto Condensed'", "#FFFFFF");
...
(lib.koef_2 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("1.79", "bold 21px 'Roboto Condensed'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 27;
	this.text.lineWidth = 82;
...
(lib.date = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("10 сентября 16:08", "bold 20px 'Roboto Condensed'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 25;
...
(lib.VS_fonbet_euro = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		var tween = createjs.Tween.get(this.flag_1, {loop: true}).to({y: 239}, 1000, createjs.Ease.quadInOut).to({y: 113}, 1000, createjs.Ease.quadInOut);
		var tween_2 = createjs.Tween.get(this.flag_2, {loop: true}).to({y: 113}, 1000, createjs.Ease.quadInOut).to({y: 239}, 1000, createjs.Ease.quadInOut);
