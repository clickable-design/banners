...
lib.properties = {
	...
	color: "#FF0066",
	manifest: [
		{src:"images/a1.png?1461159313129", id:"a1"},
		{src:"images/a2.png?1461159313129", id:"a2"},
		{src:"images/a3.png?1461159313129", id:"a3"},
		{src:"images/bg.jpg?1461159313129", id:"bg"},
		{src:"images/ggg.png?1461159313129", id:"ggg"},
		{src:"images/ooo.png?1461159313129", id:"ooo"}
	]
};
...
(lib.text_header = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("КАК НРАВИТСЯ ТЕБЕ?", "bold 45px 'Tahoma'", "#FFFFFF");
...
(lib.o_btn_1 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.text = new cjs.Text("ГЛУБЖЕ", "bold 50px 'Tahoma'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 62;
	this.text.lineWidth = 343;
	this.text.setTransform(-2.1,-35.5);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-173.5,-35.5,347.1,71);
...
(lib.g_btn_1 = function(mode,startPosition,loop) {
	...
	// Слой 2
	this.text = new cjs.Text("БЫСТРЕЕ", "bold 50px 'Tahoma'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 62;
	this.text.lineWidth = 357;
	this.text.setTransform(-2.5,-32.5);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-181,-32.5,361.1,65.6);
...
(lib.o_btn_2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.o_btn_1).wait(1).to({scaleX:1.03,scaleY:1.03,rotation:1.3},0).wait(1).to({scaleX:1.06,scaleY:1.06,rotation:2.3},0).wait(1).to({scaleX:1.08,scaleY:1.08,rotation:3},0).wait(1).to({scaleX:1.09,scaleY:1.09,rotation:3.6},0).wait(1).to({scaleX:1.1,scaleY:1.1,rotation:4},0).wait(1).to({scaleX:1.11,scaleY:1.11,rotation:4.4},0).wait(1).to({scaleX:1.12,scaleY:1.12,rotation:4.7},0).wait(1).to({scaleX:1.13,scaleY:1.13,rotation:5},0).wait(1).to({scaleX:1.14,scaleY:1.14,rotation:5.3},0).wait(1).to({scaleX:1.15,scaleY:1.15,rotation:5.6},0).wait(1).to({scaleX:1.15,scaleY:1.15,rotation:5.9},0).wait(1).to({scaleX:1.16,scaleY:1.16,rotation:6.1},0).wait(1).to({scaleX:1.16,scaleY:1.16,rotation:6.3},0).wait(1).to({scaleX:1.17,scaleY:1.17,rotation:6.5},0).wait(1).to({scaleX:1.17,scaleY:1.17,rotation:6.6},0).wait(1).to({scaleX:1.17,scaleY:1.17,rotation:6.7},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:6.8},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:6.9},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:7},0).wait(1).to({scaleX:1.18,scaleY:1.18},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:7.1},0).wait(1).to({scaleX:1.19,scaleY:1.19},0).wait(1).to({scaleX:1.19,scaleY:1.19,rotation:7.2},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:7},0).wait(1).to({scaleX:1.16,scaleY:1.16,rotation:6.7},0).wait(1).to({scaleX:1.14,scaleY:1.14,rotation:6.3},0).wait(1).to({scaleX:1.11,scaleY:1.11,rotation:5.8},0).wait(1).to({scaleX:1.08,scaleY:1.08,rotation:5.2},0).wait(1).to({scaleX:1.03,scaleY:1.03,rotation:4.4},0).wait(1).to({scaleX:0.99,scaleY:0.99,rotation:3.5},0).wait(1).to({scaleX:0.93,scaleY:0.93,rotation:2.4},0).wait(1).to({scaleX:0.87,scaleY:0.87,rotation:1.4},0).wait(1).to({scaleX:0.81,scaleY:0.81,rotation:0.3},0).wait(1).to({scaleX:0.73,scaleY:0.73,rotation:-1.3},0).wait(1).to({scaleX:0.59,scaleY:0.59,rotation:-3.7},0).wait(1).to({scaleX:0.37,scaleY:0.37,rotation:-7.8},0).to({scaleX:1,scaleY:1,rotation:0},13,cjs.Ease.get(1)).wait(37));
...
(lib.g_btn_2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.g_btn_1).wait(50).to({regX:-0.5,regY:0.3,x:-4.4,y:0.3},0).wait(1).to({x:-6.7},0).wait(1).to({x:-8.2},0).wait(1).to({x:-9.3},0).wait(1).to({x:-10.4},0).wait(1).to({x:-11.3},0).wait(1).to({x:-12.1},0).wait(1).to({x:-12.7},0).wait(1).to({x:-13.2},0).wait(1).to({x:-13.6},0).wait(1).to({x:-14},0).wait(1).to({x:-14.2},0).wait(1).to({regX:0,regY:0,x:-14,y:0},0).to({x:0},5,cjs.Ease.get(-1)).to({x:-14},2).to({x:0},2).to({x:-14},2).to({x:21},8,cjs.Ease.get(-1)).to({x:0},4,cjs.Ease.get(1)).wait(1));
	...
	this.frame_0 = function() {
		...
		window.onmessage = function(message) {
					if(
						...
						&& message.data.key === 'clikky_banner_141956'
					) {
						...
						clikkyTAG = message.data.target_url;
					}
				};
				
				//_this.header.text_header_1.text_header.text.text = '';
				//_this.g_btn.g_btn_2.g_btn_1.text.text = '';
				//_this.o_btn.o_btn_2.o_btn_1.text.text = '';
		...
		window._setCanvasSize = function() {
			...
			_this.header.x = stage.canvas.width/2;
			_this.header.y = 0;
			...
			_this.g_btn.x = 0;
			_this.g_btn.y = (stage.canvas.height/2) - (stage.canvas.height/9);
		
			_this.o_btn.x = stage.canvas.width;
			_this.o_btn.y = (stage.canvas.height/2) - (stage.canvas.height/9);
