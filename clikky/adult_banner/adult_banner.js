...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-76.8,-21.4,153.7,42.8);
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-132.7,-21.3,265.5,42.7);
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-50.3,-20.8,100.7,41.6);
...
(lib.Символ19 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-106.8,-21.2,213.7,42.5);
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-118.6,-21.5,237.3,43);
...
(lib.Символ21 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(198.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(31).to({scaleX:1.09,scaleY:1.09,x:217},7,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,x:198.5},8,cjs.Ease.get(1)).wait(1));

	// Символ 23
	this.instance_1 = new lib.Символ23();
	this.instance_1.setTransform(-25.9,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(16).to({scaleX:1.09,scaleY:1.09,x:-28.3},7,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,x:-25.9},8,cjs.Ease.get(1)).wait(16));

	// Символ 22
	this.instance_2 = new lib.Символ22();
	this.instance_2.setTransform(-225,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({scaleX:1.09,scaleY:1.09,x:-246},7,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1,x:-225},8,cjs.Ease.get(1)).wait(31));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-275.4,-21.4,550.8,42.8);
...
(lib.Символ20 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-125.3,-227,0.878,0.878);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 2 - копия
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(141,1,46,0.518)").s().p("EiGVgO0MEMsAAAIAAcGQpjh8tyhvUgsngFjg/EAAAUg/CAAAgsmAFjQzJCaq7Czg");
	this.shape.setTransform(-124.9,-191.4);
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:1.03,scaleY:1.03,rotation:1.3},0).wait(1).to({scaleX:1.06,scaleY:1.06,rotation:2.3},0).wait(1).to({scaleX:1.08,scaleY:1.08,rotation:3},0).wait(1).to({scaleX:1.09,scaleY:1.09,rotation:3.6},0).wait(1).to({scaleX:1.1,scaleY:1.1,rotation:4},0).wait(1).to({scaleX:1.11,scaleY:1.11,rotation:4.4},0).wait(1).to({scaleX:1.12,scaleY:1.12,rotation:4.7},0).wait(1).to({scaleX:1.13,scaleY:1.13,rotation:5},0).wait(1).to({scaleX:1.14,scaleY:1.14,rotation:5.3},0).wait(1).to({scaleX:1.15,scaleY:1.15,rotation:5.6},0).wait(1).to({scaleX:1.15,scaleY:1.15,rotation:5.9},0).wait(1).to({scaleX:1.16,scaleY:1.16,rotation:6.1},0).wait(1).to({scaleX:1.16,scaleY:1.16,rotation:6.3},0).wait(1).to({scaleX:1.17,scaleY:1.17,rotation:6.5},0).wait(1).to({scaleX:1.17,scaleY:1.17,rotation:6.6},0).wait(1).to({scaleX:1.17,scaleY:1.17,rotation:6.7},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:6.8},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:6.9},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:7},0).wait(1).to({scaleX:1.18,scaleY:1.18},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:7.1},0).wait(1).to({scaleX:1.19,scaleY:1.19},0).wait(1).to({scaleX:1.19,scaleY:1.19,rotation:7.2},0).wait(1).to({scaleX:1.18,scaleY:1.18,rotation:7},0).wait(1).to({scaleX:1.16,scaleY:1.16,rotation:6.7},0).wait(1).to({scaleX:1.14,scaleY:1.14,rotation:6.3},0).wait(1).to({scaleX:1.11,scaleY:1.11,rotation:5.8},0).wait(1).to({scaleX:1.08,scaleY:1.08,rotation:5.2},0).wait(1).to({scaleX:1.03,scaleY:1.03,rotation:4.4},0).wait(1).to({scaleX:0.99,scaleY:0.99,rotation:3.5},0).wait(1).to({scaleX:0.93,scaleY:0.93,rotation:2.4},0).wait(1).to({scaleX:0.87,scaleY:0.87,rotation:1.4},0).wait(1).to({scaleX:0.81,scaleY:0.81,rotation:0.3},0).wait(1).to({scaleX:0.73,scaleY:0.73,rotation:-1.3},0).wait(1).to({scaleX:0.59,scaleY:0.59,rotation:-3.7},0).wait(1).to({scaleX:0.37,scaleY:0.37,rotation:-7.8},0).to({scaleX:1,scaleY:1,rotation:0},13,cjs.Ease.get(1)).wait(37));
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50).to({x:-4},0).wait(1).to({x:-6.2},0).wait(1).to({x:-7.7},0).wait(1).to({x:-8.9},0).wait(1).to({x:-9.9},0).wait(1).to({x:-10.9},0).wait(1).to({x:-11.6},0).wait(1).to({x:-12.3},0).wait(1).to({x:-12.8},0).wait(1).to({x:-13.2},0).wait(1).to({x:-13.5},0).wait(1).to({x:-13.8},0).wait(1).to({x:-14},0).to({x:0},5,cjs.Ease.get(-1)).to({x:-14},2).to({x:0},2).to({x:-14},2).to({x:21},8,cjs.Ease.get(-1)).to({x:0},4,cjs.Ease.get(1)).wait(1));
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0.9,-2.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 1
	this.instance_1 = new lib.ggg();
	this.instance_1.setTransform(-213.5,-106);
...
(lib.adult_banner = function(mode,startPosition,loop) {
	...
	// Слой 6
	this.title = new lib.Символ20();
	this.title.setTransform(589.4,0.4,1,1,0,0,0,-125,-286.4);

	this.timeline.addTween(cjs.Tween.get(this.title).wait(1));

	// Слой 5
	this.o_btn = new lib.Символ14();
	this.o_btn.setTransform(1169,813,1,1,0,0,0,232.5,128.8);

	this.timeline.addTween(cjs.Tween.get(this.o_btn).wait(1));

	// Слой 3
	this.g_btn = new lib.Символ15();
