...
lib.properties = {
	...
	color: "#D82C2A",
	manifest: [
		{src:"images/arrows.png?1461657045719", id:"arrows"},
		{src:"images/bg.jpg?1461657045719", id:"bg"},
		{src:"images/bg2.jpg?1461657045719", id:"bg2"},
		{src:"images/btn11.png?1461657045719", id:"btn11"}
	]
};
...
(lib.device_type = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой 1
	this.text = new cjs.Text("Device : Smartphone", "bold 35px 'Arial'", "#FFFFFF");
	this.text.lineHeight = 41;
	this.text.lineWidth = 490;
...
(lib.title = function(mode,startPosition,loop) {
	...
	this.title_device.setTransform(0,74.3);

	this.timeline.addTween(cjs.Tween.get(this.title_device).wait(20));
...
(lib.log = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.device_type = new lib.device_type();
	this.device_type.setTransform(141.6,-73);

	this.timeline.addTween(cjs.Tween.get(this.device_type).wait(1));
...
(lib.app_banner = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		if( isMobile.Android() ){ 
			...
			_this.main.title.title_device.text.text = 'Android';
		}
		...
		if( isMobile.iPad() ){ 
			_this.main.title.title_device.text.text = 'iPad';
			_this.main.log.device_type.text.text = 'Device : Tablet';
		}
		if( isMobile.iPhone() ){ 
			_this.main.title.title_device.text.text = 'iPhone';
			_this.main.log.device_type.text.text = 'Device : Smartphone';
		}
		if( isMobile.iPod() ){ 
			_this.main.title.title_device.text.text = 'iPod';
			_this.main.log.device_type.text.text = 'Device : Media Player';
		}
