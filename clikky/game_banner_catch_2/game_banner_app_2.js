...
lib.properties = {
	...
	color: "#00CCCC",
	manifest: [
		{src:"images/banner.png?1462455139788", id:"banner"},
		{src:"images/blink.png?1462455139788", id:"blink"},
		{src:"images/cactus.png?1462455139788", id:"cactus"},
		{src:"images/cloud.png?1462455139788", id:"cloud"},
		{src:"images/handle_1.png?1462455139788", id:"handle_1"},
		{src:"images/handle_2.png?1462455139788", id:"handle_2"},
		{src:"images/net.png?1462455139788", id:"net"},
		{src:"images/rock.png?1462455139788", id:"rock"},
		{src:"images/score.png?1462455139788", id:"score"},
		{src:"images/sqare.png?1462455139788", id:"sqare"},
		{src:"images/stars.png?1462455139788", id:"stars"},
		{src:"images/sun.png?1462455139788", id:"sun"}
	]
};
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.net).wait(1).to({regX:6.1,regY:50.3,x:-139.2,y:95.3},0).wait(1).to({x:-199.3},0).wait(1).to({x:-236.6},0).wait(1).to({x:-257.2},0).wait(1).to({x:-269.2},0).wait(1).to({regX:0,regY:0,x:-283.7,y:45},0).wait(1).to({regX:6.1,regY:50.3,x:-202,y:95.3},0).wait(1).to({x:-153.9},0).wait(1).to({x:-121.2},0).wait(1).to({x:-96.9},0).wait(1).to({x:-76.9},0).wait(1).to({x:-59.6},0).wait(1).to({x:-45.2},0).wait(1).to({x:-33.5},0).wait(1).to({x:-24.3},0).wait(1).to({x:-17},0).wait(1).to({x:-11.1},0).wait(1).to({x:-6.2},0).wait(1).to({x:-2.1},0).wait(1).to({x:1.4},0).wait(1).to({x:4.5},0).wait(1).to({regX:0,regY:0,x:1.3,y:45},0).wait(1).to({regX:6.1,regY:50.3,x:160.3,y:95.3},0).wait(1).to({x:226.8},0).wait(1).to({x:270.2},0).wait(1).to({x:297.4},0).wait(1).to({x:313.7},0).wait(1).to({x:324.3},0).wait(1).to({regX:0,regY:0,x:326.2,y:45},0).wait(1).to({regX:6.1,regY:50.3,x:241.7,y:95.3},0).wait(1).to({x:185.5},0).wait(1).to({x:147.9},0).wait(1).to({x:119.8},0).wait(1).to({x:96.6},0).wait(1).to({x:76.8},0).wait(1).to({x:60.7},0).wait(1).to({x:48.1},0).wait(1).to({x:38.3},0).wait(1).to({x:30.5},0).wait(1).to({x:24.3},0).wait(1).to({x:19.1},0).wait(1).to({x:14.7},0).wait(1).to({x:10.8},0).wait(1).to({regX:0,regY:0,x:1.3,y:45},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-105.6,-45.5,207.9,183.8);
...
(lib.game_banner_app_2 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		_this.net_2.net_1.net.star_1.visible = false;
		_this.net_2.net_1.net.star_2.visible = false;
		_this.net_2.net_1.net.star_3.visible = false;
		_this.net_2.net_1.net.star_4.visible = false;
		...
		function Star_1() {
			...
			_this.net_2.net_1.net.star_1.visible = true;
			_this.score.play();
		...
		function Star_2() {
			...
			_this.net_2.net_1.gotoAndPlay(1);
			_this.net_2.net_1.net.play();
			_this.net_2.net_1.net.star_2.visible = true;
			_this.score.play();
			event.preventDefault();
		}
		...
		function Star_3() {
			...
			_this.net_2.net_1.net.play();
			_this.net_2.net_1.net.star_3.visible = true;
			_this.score.play();
			event.preventDefault();
		}
		...
		function Star_4() {
			...
			_this.net_2.net_1.gotoAndPlay(23);
			_this.net_2.net_1.net.play();
			_this.net_2.net_1.net.star_4.visible = true;
			_this.score.play();
			event.preventDefault();
		}
	...
	this.star_4.setTransform(649.6,-1.4,1,1,0,0,0,-8,207.6);

	this.star_3 = new lib.star_3();
	this.star_3.setTransform(887.1,-1,1,1,-0.3,0,0,-1,207.6);

	this.star_2 = new lib.star_2();
	this.star_2.setTransform(142,-0.8,1,1,0.1,0,0,3,206.6);

	this.star_1 = new lib.star_1();
	this.star_1.setTransform(364.4,-1,1,1,0,0,0,2.6,206.6);
...
p.nominalBounds = new cjs.Rectangle(19.9,89.4,2010.4,1064.9);
