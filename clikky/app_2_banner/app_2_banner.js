...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/arrow.png?1461753821625", id:"arrow"},
		{src:"images/button.png?1461753821625", id:"button"},
		{src:"images/front_plate.png?1461753821625", id:"front_plate"},
		{src:"images/green.png?1461753821625", id:"green"},
		{src:"images/plate.png?1461753821625", id:"plate"},
		{src:"images/stripe.png?1461753821625", id:"stripe"}
	]
};
...
(lib.title_2 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("ВАШЕ УСТРОЙСТВО\nМОЖЕТ РАБОТАТЬ\nБЫСТРЕЕ", "bold 35px 'Arial'", "#666666");
	this.text.textAlign = "center";
	this.text.lineHeight = 41;
...
p.nominalBounds = new cjs.Rectangle(-300,-67.3,600.2,134.6);
...
(lib.button_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(133).to({_off:false},0).wait(1).to({regY:25.3,y:76.4,alpha:0.479},0).wait(1).to({y:55.3,alpha:0.69},0).wait(1).to({y:41.3,alpha:0.83},0).wait(1).to({y:32.7,alpha:0.916},0).wait(1).to({y:27.5,alpha:0.968},0).wait(1).to({regY:0,y:-1,alpha:1},0).wait(1));
...
(lib.app_2_banner = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window.onmessage = function(message) {
			...
			_this.plate.title.title_2.text.text = message.data.header_2;
