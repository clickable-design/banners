...
lib.properties = {
	...
	color: "#00CCCC",
	manifest: [
		{src:"images/banner.png?1462535814275", id:"banner"},
		{src:"images/blink.png?1462535814275", id:"blink"},
		{src:"images/cactus.png?1462535814275", id:"cactus"},
		{src:"images/cloud.png?1462535814275", id:"cloud"},
		{src:"images/net.png?1462535814275", id:"net"},
		{src:"images/rock.png?1462535814275", id:"rock"},
		{src:"images/score.png?1462535814275", id:"score"},
		{src:"images/slingshot.png?1462535814275", id:"slingshot"},
		{src:"images/sqare.png?1462535814275", id:"sqare"},
		{src:"images/stars.png?1462535814275", id:"stars"},
		{src:"images/sun.png?1462535814275", id:"sun"}
	]
};
...
(lib.title_2 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("ПОЛУЧАЙ ПРИЛОЖЕНИЕ", "bold 40px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 47;
	this.text.setTransform(-2,-23.1);
...
(lib.title_1 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(" СОБИРАЙ ЗВЕЗДЫ", "bold 40px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 47;
	this.text.setTransform(-2,-24.4);
...
(lib.score_1 = function(mode,startPosition,loop) {
	...
	this.icon.setTransform(4.3,-111.4,0.296,0.296,15);

	this.timeline.addTween(cjs.Tween.get(this.icon).wait(22));
...
(lib.header = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.title_1).wait(21).to({regX:0.2,regY:3.2,x:5.4,y:6.8,alpha:0.495},0).wait(1).to({y:14.6,alpha:0.278},0).wait(1).to({y:19.4,alpha:0.145},0).wait(1).to({y:22.2,alpha:0.069},0).wait(1).to({y:23.7,alpha:0.027},0).wait(1).to({regX:0,regY:0,x:5.2,y:21.5,alpha:0},0).wait(34).to({regX:0.2,regY:3.2,x:5.4,y:6.5,alpha:0.505},0).wait(1).to({y:-1.3,alpha:0.722},0).wait(1).to({y:-6.1,alpha:0.855},0).wait(1).to({y:-8.8,alpha:0.931},0).wait(1).to({y:-10.3,alpha:0.973},0).wait(1).to({regX:0,regY:0,x:5.2,y:-14.5,alpha:1},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.title_2).wait(26).to({_off:false},0).wait(1).to({regX:0.2,regY:4.5,x:5.4,y:8.1,alpha:0.505},0).wait(1).to({y:0.4,alpha:0.722},0).wait(1).to({y:-4.3,alpha:0.855},0).wait(1).to({y:-7,alpha:0.931},0).wait(1).to({y:-8.5,alpha:0.973},0).wait(1).to({regX:0,regY:0,x:5.2,y:-14,alpha:1},0).wait(22).to({regX:0.2,regY:4.5,x:5.4,y:8.4,alpha:0.495},0).wait(1).to({y:16.1,alpha:0.278},0).wait(1).to({y:20.9,alpha:0.145},0).wait(1).to({y:23.6,alpha:0.069},0).wait(1).to({y:25,alpha:0.027},0).wait(1).to({regX:0,regY:0,x:5.2,y:21.5,alpha:0},0).wait(7));
...
(lib.victory_mc = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-1.9,-0.9,1.567,1.567);
	this.instance._off = true;
...
(lib.game_banner_app_2 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window.onmessage = function(message) {
			...
			_this.score.icon.instance.image.src = message.data.icon;
			...
			_this.header_1.header.title_2.text.text = message.data.title_2;
