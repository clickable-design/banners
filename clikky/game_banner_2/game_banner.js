...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/_9NtcjSdolr0qXe8f8KMACfcBbOogGBpAAAAABJRU5ErkJggg.png?1461849418378", id:"_9NtcjSdolr0qXe8f8KMACfcBbOogGBpAAAAABJRU5ErkJggg"},
		{src:"images/arrow.png?1461849418378", id:"arrow"},
		{src:"images/bg_field.png?1461849418378", id:"bg_field"},
		{src:"images/bow.png?1461849418378", id:"bow"},
		{src:"images/cloud.png?1461849418378", id:"cloud"},
		{src:"images/grass.png?1461849418378", id:"grass"},
		{src:"images/light.png?1461849418378", id:"light"},
		{src:"images/target.png?1461849418378", id:"target"}
	]
};
...
(lib._9NtcjSdolr0qXe8f8KMACfcBbOogGBpAAAAABJRU5ErkJggg = function() {
	this.initialize(img._9NtcjSdolr0qXe8f8KMACfcBbOogGBpAAAAABJRU5ErkJggg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,144,142);
...
(lib.Символ27 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("rgba(185,104,0,0.318)").s().p("AAAmCMg5gAeGIjhh2MA9Bgf8MA9CAf8IjhB2gAAAtNMg5gAeHIjhh2MA9Bgf9MA9CAf9IjhB2gAAA0YMg5gAeHIjhh2MA9Bgf8MA9CAf8IjhB2g");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-390.6,-154.1,781.2,308.2);
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#935300").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-21.6,-20.7,43.3,41.4);
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(486.7,-79.5);

	this.instance_1 = new lib.grass();
	this.instance_1.setTransform(-512,-79.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-512,-79.5,2022.7,159);
...
(lib.game_title = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой 1
	this.text = new cjs.Text("CLASH OF CLANS", "bold 35px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 41;
...
(lib.game_img = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой 1
	this.instance = new lib._9NtcjSdolr0qXe8f8KMACfcBbOogGBpAAAAABJRU5ErkJggg();
	this.instance.setTransform(-72,-96);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-72,-96,144,142);
...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(52.7,-10.9,1,1,30);

	this.instance_1 = new lib.Символ24();
	this.instance_1.setTransform(-55.5,-10.9,1,1,-15);

	this.instance_2 = new lib.Символ24();
	this.instance_2.setTransform(-1.1,-22.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-81.7,-42.8,163.5,60.8);
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(1.1,42.2);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regY:-12.5,y:19.6,alpha:0.31},0).wait(1).to({y:12.8,alpha:0.519},0).wait(1).to({y:8.3,alpha:0.657},0).wait(1).to({y:4.7,alpha:0.767},0).wait(1).to({y:1.7,alpha:0.861},0).wait(1).to({y:-0.6,alpha:0.929},0).wait(1).to({y:-1.9,alpha:0.972},0).wait(1).to({y:-2.6,alpha:0.994},0).wait(1).to({regY:0,y:9.7,alpha:1},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-80.6,-0.7,163.5,60.8);
...
(lib.btn = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-0.6,5.1);
...
p.nominalBounds = new cjs.Rectangle(-165.3,-67.5,330,116.7);
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(409,230.2,1,1,30);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(22).to({_off:false},0).wait(1).to({x:404.3,y:226.8},0).wait(1).to({x:398,y:222.3},0).wait(1).to({x:388.3,y:215.2},0).wait(1).to({x:372.5,y:203.8},0).wait(1).to({x:345.7,y:184.3},0).wait(1).to({x:297.5,y:149.4},0).wait(1).to({x:205.3,y:82.5},0).wait(1).to({x:53.8,y:-27.4},0).wait(1));
...
(lib.Символ5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.1,scaleY:1.1},3,cjs.Ease.get(1)).to({scaleX:0.31,scaleY:0.31,x:-0.2,alpha:0},12,cjs.Ease.get(-1)).to({_off:true},1).wait(1));
...
(lib.title = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(80).call(this.frame_80).wait(71).call(this.frame_151).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn).wait(141).to({_off:false},0).wait(1).to({regX:-0.4,regY:-9.2,x:-4.5,y:530.3,alpha:0.316},0).wait(1).to({y:526.4,alpha:0.514},0).wait(1).to({y:523.8,alpha:0.647},0).wait(1).to({y:521.9,alpha:0.747},0).wait(1).to({y:520.4,alpha:0.822},0).wait(1).to({y:519.3,alpha:0.88},0).wait(1).to({y:518.4,alpha:0.924},0).wait(1).to({y:517.8,alpha:0.957},0).wait(1).to({y:517.3,alpha:0.982},0).wait(1).to({regX:0,regY:0,x:-4.1,y:526.2,alpha:1},0).wait(1));

	// Слой 11
	this.game_title = new lib.game_title();
	this.game_title.setTransform(0,469.2);
	this.game_title.alpha = 0;
	this.game_title._off = true;

	this.timeline.addTween(cjs.Tween.get(this.game_title).wait(138).to({_off:false},0).wait(1).to({y:457,alpha:0.324},0).wait(1).to({y:449,alpha:0.536},0).wait(1).to({y:443.6,alpha:0.68},0).wait(1).to({y:439.5,alpha:0.79},0).wait(1).to({y:436.4,alpha:0.872},0).wait(1).to({y:434.5,alpha:0.924},0).wait(1).to({y:433.3,alpha:0.956},0).wait(1).to({y:432.4,alpha:0.98},0).wait(1).to({y:431.7,alpha:1},0).wait(5));

	// Слой 9
	this.instance = new lib.Символ25();
	this.instance.setTransform(0,338.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(138).to({_off:false},0).wait(14));

	// Слой 6
	this.game_img = new lib.game_img();
	this.game_img.setTransform(0,231.3,0.349,0.349,-15);
	this.game_img._off = true;

	this.timeline.addTween(cjs.Tween.get(this.game_img).wait(124).to({_off:false},0).wait(1).to({regY:-25,scaleX:0.64,scaleY:0.64,rotation:-8.4,x:-2.3,y:215.6},0).wait(1).to({scaleX:0.75,scaleY:0.75,rotation:-5.8,x:-1.9,y:212.7},0).wait(1).to({scaleX:0.82,scaleY:0.82,rotation:-4.1,x:-1.5,y:210.9},0).wait(1).to({scaleX:0.88,scaleY:0.88,rotation:-2.8,x:-1,y:209.4},0).wait(1).to({scaleX:0.92,scaleY:0.92,rotation:-1.9,x:-0.7,y:208.4},0).wait(1).to({scaleX:0.95,scaleY:0.95,rotation:-1.2,x:-0.5,y:207.6},0).wait(1).to({scaleX:0.97,scaleY:0.97,rotation:-0.7,x:-0.3,y:207.1},0).wait(1).to({scaleX:0.98,scaleY:0.98,rotation:-0.4,x:-0.1,y:206.7},0).wait(1).to({scaleX:0.99,scaleY:0.99,rotation:-0.2,x:0,y:206.5},0).wait(1).to({regY:0,scaleX:1,scaleY:1,rotation:0,y:231.3},0).wait(18));

	// Слой 8
	this.instance_1 = new lib.Символ22();
	this.instance_1.setTransform(1.4,231.3,0.192,0.192,30);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(130).to({_off:false},0).wait(1).to({regY:-25,scaleX:0.55,scaleY:0.55,rotation:16.8,x:5.3,y:218.2},0).wait(1).to({scaleX:0.69,scaleY:0.69,rotation:11.5,x:4.8,y:214.4},0).wait(1).to({scaleX:0.78,scaleY:0.78,rotation:8.3,x:4.2,y:212},0).wait(1).to({scaleX:0.85,scaleY:0.85,rotation:5.6,x:3.4,y:210.1},0).wait(1).to({scaleX:0.9,scaleY:0.9,rotation:3.7,x:2.8,y:208.8},0).wait(1).to({scaleX:0.94,scaleY:0.94,rotation:2.4,x:2.4,y:207.9},0).wait(1).to({scaleX:0.96,scaleY:0.96,rotation:1.4,x:2,y:207.3},0).wait(1).to({scaleX:0.98,scaleY:0.98,rotation:0.8,x:1.7,y:206.8},0).wait(1).to({scaleX:0.99,scaleY:0.99,rotation:0.3,x:1.5,y:206.5},0).wait(1).to({regY:0,scaleX:1,scaleY:1,rotation:0,x:1.4,y:231.3},0).wait(12));

	// Слой 7
	this.instance_2 = new lib.Символ23();
	this.instance_2.setTransform(1.3,231.2,0.304,0.304,-45);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(136).to({_off:false},0).wait(1).to({regY:-25,scaleX:0.59,scaleY:0.59,rotation:-26.3,x:-5.2,y:217.9},0).wait(1).to({scaleX:0.72,scaleY:0.72,rotation:-18.4,x:-4.3,y:214.2},0).wait(1).to({scaleX:0.79,scaleY:0.79,rotation:-13.6,x:-3.3,y:212},0).wait(1).to({scaleX:0.85,scaleY:0.85,rotation:-9.7,x:-2.2,y:210.3},0).wait(1).to({scaleX:0.9,scaleY:0.9,rotation:-6.7,x:-1.3,y:209},0).wait(1).to({scaleX:0.93,scaleY:0.93,rotation:-4.6,x:-0.5,y:208.1},0).wait(1).to({scaleX:0.95,scaleY:0.95,rotation:-3,x:0.1,y:207.4},0).wait(1).to({scaleX:0.97,scaleY:0.97,rotation:-1.8,x:0.5,y:207},0).wait(1).to({scaleX:0.99,scaleY:0.99,rotation:-1,x:0.9,y:206.6},0).wait(1).to({scaleX:0.99,scaleY:0.99,rotation:-0.4,x:1.2,y:206.4},0).wait(1).to({regY:0,scaleX:1,scaleY:1,rotation:0,x:1.3,y:231.2},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.title_4).wait(124).to({_off:false},0).wait(1).to({regY:12.5,y:149.6,alpha:0.291},0).wait(1).to({y:141.9,alpha:0.495},0).wait(1).to({y:137.3,alpha:0.62},0).wait(1).to({y:133.5,alpha:0.72},0).wait(1).to({y:130.3,alpha:0.806},0).wait(1).to({y:127.9,alpha:0.868},0).wait(1).to({y:126.3,alpha:0.912},0).wait(1).to({y:125,alpha:0.946},0).wait(1).to({y:124,alpha:0.974},0).wait(1).to({regY:0,y:110.5,alpha:1},0).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.title_3).wait(117).to({_off:false},0).wait(1).to({regY:37.5,y:106.5},0).wait(1).to({y:87},0).wait(1).to({y:74.3},0).wait(1).to({y:65.1},0).wait(1).to({y:57.4},0).wait(1).to({y:50.8},0).wait(1).to({y:45.7},0).wait(1).to({y:42.1},0).wait(1).to({y:39.6},0).wait(1).to({y:37.8},0).wait(1).to({y:36.4},0).wait(1).to({y:35.3},0).wait(1).to({regY:0,y:-3.2},0).wait(22));

	// Слой 10
	this.instance_3 = new lib.Символ27();
	this.instance_3.setTransform(0,908);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(124).to({_off:false},0).wait(1).to({y:861.5,alpha:0.404},0).wait(1).to({y:834.8,alpha:0.637},0).wait(1).to({y:818.5,alpha:0.778},0).wait(1).to({y:807.9,alpha:0.871},0).wait(1).to({y:801.5,alpha:0.926},0).wait(1).to({y:798,alpha:0.956},0).wait(1).to({y:796,alpha:0.974},0).wait(1).to({y:794.5,alpha:0.987},0).wait(1).to({y:793,alpha:1},0).wait(19));

	// Слой 5
	this.instance_4 = new lib.Символ21();
	this.instance_4.setTransform(0,277.7,0.037,0.037);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(111).to({_off:false},0).to({scaleX:0.49,scaleY:0.49,y:270.7},7,cjs.Ease.get(-1)).to({scaleX:1.24,scaleY:1.24,y:262.7},12,cjs.Ease.get(1)).wait(22));
...
(lib.game_banner = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var onTouchStart = function() {
			...
			_this.mishen.target.gotoAndStop(126);
	...
	this.grass.setTransform(512.6,767,1,1,0,0,0,499.9,78.5);
	...
	this.bg_field.setTransform(512,767,1,1,0,0,0,0,172.1);
...
p.nominalBounds = new cjs.Rectangle(12.6,84.1,2022.7,1483);
