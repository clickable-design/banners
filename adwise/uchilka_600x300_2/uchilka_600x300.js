...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({x:235.5},8,cjs.Ease.get(1)).wait(1).to({x:85.5},4,cjs.Ease.get(1)).wait(1));

	// mouse
	this.instance_1 = new lib.Символ17();
	this.instance_1.setTransform(21,31.1,0.63,0.63,0,0,0,23,29.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({x:171},8,cjs.Ease.get(1)).wait(1).to({x:21},4,cjs.Ease.get(1)).wait(1));
...
(lib.uchilka_600x300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.classroom.setTransform(53,-35,1,1,0,0,0,172,-35);

	this.timeline.addTween(cjs.Tween.get(this.classroom).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(181,70,838,459.5);
