...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/fon.jpg?1464703855534", id:"fon"},
		{src:"images/hrch_03.png?1464703855534", id:"hrch_03"},
		{src:"images/hrch_05.png?1464703855534", id:"hrch_05"},
		{src:"images/hrch_10.png?1464703855534", id:"hrch_10"},
		{src:"images/hrch_12.png?1464703855534", id:"hrch_12"},
		{src:"images/hrch_14.png?1464703855534", id:"hrch_14"},
		{src:"images/hrch_20.png?1464703855534", id:"hrch_20"}
	]
};
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.48},8,cjs.Ease.get(-1)).to({scaleX:0.09},6,cjs.Ease.get(1)).wait(1).to({scaleX:0.55},7,cjs.Ease.get(-1)).to({scaleX:1},7,cjs.Ease.get(1)).wait(1));
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(64.5,64.5,0.069,1,0,0,0,64.5,64.5);
	this.instance.filters = [new cjs.ColorFilter(0.61, 0.61, 0.61, 1, 0, 0, 0, 0)];
	this.instance.cache(-2,-2,133,133);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.54},7,cjs.Ease.get(-1)).to({scaleX:1},7,cjs.Ease.get(1)).to({scaleX:0.57},7,cjs.Ease.get(-1)).to({scaleX:0.07},8,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(60.1,0,8.9,129);
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	this.vs.setTransform(408.5,122.4,1,1,0,0,0,15.7,9.3);

	this.che = new lib.Символ12();
	this.che.setTransform(598.1,138.2,0.833,0.833,0,0,0,176.1,134.1);

	this.rus = new lib.Символ11();
	this.rus.setTransform(226.1,140.6,0.833,0.833,0,0,0,191.6,152.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.rus},{t:this.che},{t:this.vs}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0.1,789,302.8);


// stage content:
(lib.hock_rus_che_1200120 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.logo.setTransform(27.1,58.5,0.632,0.632,0,0,0,-22.3,33.5);

	this.timeline.addTween(cjs.Tween.get(this.logo).wait(1));

	// vs
	this.rus = new lib.Символ32();
	this.rus.setTransform(347.8,89.9,1,1,0,0,0,178.2,151.3);

	this.timeline.addTween(cjs.Tween.get(this.rus).wait(1));

	// but
	this.but = new lib.Символ27();
	this.but.setTransform(1221.1,59.9,1,1,0,0,0,185.8,45.1);

	this.timeline.addTween(cjs.Tween.get(this.but).wait(1));

	// time
	this.time = new lib.Символ13();
	this.time.setTransform(953.1,62.8,0.793,0.793,0,0,0,69.5,46.5);

	this.timeline.addTween(cjs.Tween.get(this.time).wait(1));

	// fon
	this.fon = new lib.Символ1();
	this.fon.setTransform(-9.4,-85.8,1,1,0,0,0,-91.3,-16.1);

	this.timeline.addTween(cjs.Tween.get(this.fon).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(590.6,-25.8,2102.6,370.5);
