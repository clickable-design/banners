...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/apteka.png?1464074679260", id:"apteka"},
		{src:"images/back.jpg?1464074679260", id:"back"},
		{src:"images/fire.png?1464074679260", id:"fire"},
		{src:"images/gun1.png?1464074679260", id:"gun1"},
		{src:"images/man.png?1464074679260", id:"man"},
		{src:"images/patron.png?1464074679260", id:"patron"},
		{src:"images/pricel.png?1464074679260", id:"pricel"}
	]
};
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(1,59.9,0.622,0.622);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AiJDRQAAgSAGgRQALgdAXgbQAXgbAsgkQBCg3AYggQAYggAAgdQAAgfgVgVQgWgVgjAAQgjAAgXAWQgWAXAAAnIg1gFQAGg7AjgfQAjgfA6AAQA8AAAjAhQAjAhAAAyQAAAZgKAYQgLAYgXAZQgYAbg3AvIg6A0QgNAOgIAOIDLAAIAAAxg");
	this.shape.setTransform(89,88.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAfBAIgfgkIgdAkIgoAAIAAgKIAvg2Igvg1IAAgKIAoAAIAdAkIAfgkIAnAAIAAAKIguA1IAuA2IAAAKg");
	this.shape_1.setTransform(64,89.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhgCxQgjgggGg0IA2gFQAGAnAWAVQAVATAgAAQAiAAAagcQAagcAAguQAAgsgYgXQgZgZgmgBQgZAAgUALQgUAMgMAQIgvgGIAojVIDNAAIAAAxIikAAIgXBwQAmgaAnAAQA3AAAlAmQAmAkAAA7QAAA5ghAqQgoAyhDAAQg6AAgkggg");
	this.shape_2.setTransform(89.7,28.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAfBAIgfgkIgdAkIgoAAIAAgKIAvg2Igvg1IAAgKIAoAAIAdAkIAfgkIAnAAIAAAKIguA1IAuA2IAAAKg");
	this.shape_3.setTransform(64,27.1);

	this.instance_1 = new lib.Символ15();
	this.instance_1.setTransform(46.8,25.8,1,1,0,0,0,4.2,25.8);

	this.instance_2 = new lib.Символ15();
	this.instance_2.setTransform(36.2,25.8,1,1,0,0,0,4.2,25.8);

	this.instance_3 = new lib.Символ15();
	this.instance_3.setTransform(25.5,25.8,1,1,0,0,0,4.2,25.8);

	this.instance_4 = new lib.Символ15();
	this.instance_4.setTransform(14.9,25.8,1,1,0,0,0,4.2,25.8);

	this.instance_5 = new lib.Символ15();
	this.instance_5.setTransform(4.2,25.8,1,1,0,0,0,4.2,25.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-8.5,110.6,135.1);
...
(lib.Символ8 = function(mode,startPosition,loop) {
	...
	// Слой 4
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.rf(["rgba(51,0,153,0)","rgba(51,0,153,0.2)","rgba(51,0,153,0.941)","#330099"],[0.192,0.58,0.973,1],0,0,0,0,0,124.3).s().p("AtmNnQlplpAAn+QAAn8FplqQFplpH9AAQH+AAFpFpQFpFqAAH8QAAH+lpFpQlpFpn+AAQn9AAlplpg");
...
(lib.Символ13 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(410.7,192.8,1,1,0,0,0,56,15);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,regX:56,regY:15,x:410.7,y:192.8},4).to({_off:false,regX:0,regY:0,x:570.1,y:196.1},5).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:false},4).to({_off:true,regX:0,regY:0,x:570.1,y:196.1},5).wait(1));

	// Слой 1
	this.instance_2 = new lib.Анимация1();
	this.instance_2.setTransform(90.7,39.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-131.6},4).to({x:90.7},5).wait(1));
...
// stage content:
(lib.snip640x305 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(29.4,223.4,0.681,0.681,0,0,0,4.2,25.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// pricel
	this.pricel = new lib.Символ10();
	this.pricel.setTransform(-819.6,252.9,1,1,0,0,0,469.4,447.9);
...
p.nominalBounds = new cjs.Rectangle(-1222.5,-75.1,2359.9,974.7);
