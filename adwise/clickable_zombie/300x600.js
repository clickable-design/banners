...
(lib.Символ95 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#990F17").s().p("ApXV4MAAAgrvISuAAMAAAArvg");
	this.shape.setTransform(60,140);
...
(lib.Символ94 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#990F17").s().p("ApXWqMAAAgtTISuAAMAAAAtTg");
	this.shape.setTransform(60,145);
	this.shape._off = true;
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.left.addEventListener("mouseover", fl_MouseOverHandler_2);
		
		function fl_MouseOverHandler_2()
		{
			_this.zomb_2.gotoAndPlay(1);
		}
		...
		{
		     _this.zomb_2.gotoAndPlay(5);
		}
		
		
		var frequency = 30;
		stage.enableMouseOver(frequency);
		this.left.addEventListener("mouseout", fl_MouseOutHandler_4);
		
		function fl_MouseOutHandler_4()
		{
			_this.zomb_2.gotoAndPlay(0);
		}
		this.cursor = "none";
	...
	// right
	this.right = new lib.Символ95();
	this.right.setTransform(248,381.5,1.56,1.56,0,0,0,60,140);
	new cjs.ButtonHelper(this.right, 0, 1, 2, false, new lib.Символ95(), 3);

	this.timeline.addTween(cjs.Tween.get(this.right).wait(1));

	// left
	this.left = new lib.Символ94();
	this.left.setTransform(57.7,380,1.56,1.56,0,0,0,60,145);
	new cjs.ButtonHelper(this.left, 0, 1, 2, false, new lib.Символ94(), 3);
...
p.nominalBounds = new cjs.Rectangle(-74,255,862.1,651.3);
