...
p.nominalBounds = new cjs.Rectangle(-18.5,-35,37,70);
...
(lib.kosinka640305 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.prik.setTransform(822.8,231.8,1,1,28.7);
	...
	this.instance.setTransform(624,152.4);
	...
	this.woma.setTransform(559.7,172.4);
...
p.nominalBounds = new cjs.Rectangle(-99.9,49.6,1631.5,561.9);
