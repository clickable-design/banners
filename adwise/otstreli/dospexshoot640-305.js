...
(lib.dospexshoot640305 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.but2.setTransform(465,160.7,1.688,1.224);
	new cjs.ButtonHelper(this.but2, 0, 1, 2, false, new lib.Символ34(), 3);

	this.but1 = new lib.Символ34();
	this.but1.setTransform(107.4,160.7,1.688,1.224);
	...
	this.instance.setTransform(157.7,35.2);
...
p.nominalBounds = new cjs.Rectangle(-992.8,-45.3,2204.1,1747);
