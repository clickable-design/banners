...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/flame_effect_by_mrjumpmanv4d36ve94.png?1464952651380", id:"flame_effect_by_mrjumpmanv4d36ve94"},
		{src:"images/fon.jpg?1464952651380", id:"fon"},
		{src:"images/high_tech_gui_by_karsten.png?1464952651380", id:"high_tech_gui_by_karsten"},
		{src:"images/MAAWS_CoDG.png?1464952651380", id:"MAAWS_CoDG"},
		{src:"images/maxresdefault.jpg?1464952651380", id:"maxresdefault"},
		{src:"images/robot_03.png?1464952651380", id:"robot_03"},
		{src:"images/robot_05.png?1464952651380", id:"robot_05"},
		{src:"images/robot_10.png?1464952651380", id:"robot_10"},
		{src:"images/robot_14_03.png?1464952651380", id:"robot_14_03"},
		{src:"images/robot_14_06.png?1464952651380", id:"robot_14_06"},
		{src:"images/robot_14_09.png?1464952651380", id:"robot_14_09"},
		{src:"images/robot_14_15.png?1464952651380", id:"robot_14_15"},
		{src:"images/robot_14_18.png?1464952651380", id:"robot_14_18"},
		{src:"images/sambik.png?1464952651380", id:"sambik"},
		{src:"images/smoke_path.png?1464952651380", id:"smoke_path"},
		{src:"images/soldier.png?1464952651380", id:"soldier"},
		{src:"images/stone.png?1464952651380", id:"stone"}
	]
};
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:227},16).to({y:225},1).to({y:227},19).to({y:225},1).wait(1));
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:22.4,scaleX:0.99,scaleY:0.99,x:50.9,y:3.7},14,cjs.Ease.get(-1)).wait(25).to({regY:22.5,scaleX:1,scaleY:1,x:51.3,y:3.3},20).wait(1));

	// robot_05.png
	this.instance_1 = new lib.Символ3();
	this.instance_1.setTransform(159.6,10.6,1,1,0,0,0,26.5,20);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:0.99,scaleY:0.99,x:158.1,y:11},14,cjs.Ease.get(-1)).wait(25).to({scaleX:1,scaleY:1,x:159.6,y:10.6},20).wait(1));

	// robot_10.png
	this.instance_2 = new lib.Символ4();
	this.instance_2.setTransform(82.3,13,1,1,0,0,0,73.5,42);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:0.99,scaleY:0.99,x:81.6,y:13.4},14,cjs.Ease.get(-1)).wait(25).to({scaleX:1,scaleY:1,x:82.3,y:13},20).wait(1));

	// robot_14_06.png
	this.instance_3 = new lib.Символ40();
	this.instance_3.setTransform(120,41,1,1,0,0,0,21,4.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(17).to({regY:4.6,rotation:14.7,x:121.2,y:39.8},17).to({regX:20.9,regY:4.5,rotation:3.9,x:119.6,y:40.9},3).to({rotation:3.9},22).wait(1));

	// robot_14_18.png
	this.instance_4 = new lib.Символ41();
	this.instance_4.setTransform(115.3,89.5,1,1,0,0,0,12.6,6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(17).to({rotation:-2.2,x:104,y:83.3},17).to({rotation:2,x:111.2,y:89.8},3).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:44.4,rotation:11,x:64.2,y:53.6},14).to({rotation:3.5,x:62.4,y:52.8},3).wait(17).to({x:62,y:51.2},3).wait(23));

	// robot_14_15.png
	this.instance_7 = new lib.Символ39();
	this.instance_7.setTransform(46.5,101.2,1,1,0,0,0,32.5,11.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:38.4,y:95.2},14).to({regX:32.4,rotation:3.3,x:42.5,y:98.1},3).wait(17).to({x:42.1,y:96.5},3).wait(23));
...
(lib.Символ42 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(69.6,242.7,1,1,0,0,0,77.5,82);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-16.4,y:264.7},19).wait(21).to({skewY:180,x:53.6,y:254.7},0).to({x:121.2,y:239.9},13).to({x:152.4,y:233.1},6).wait(20).to({x:96.4,y:247.1},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,302.9,352.1);
...
(lib.crisis600x300 = function(mode,startPosition,loop) {
	...
	this.gun.setTransform(465.7,225.6,1,1,0,0,0,150,83.5);

	this.timeline.addTween(cjs.Tween.get(this.gun).wait(1));

	// text
	this.text = new lib.Символ31();
	this.text.setTransform(161.4,40.4,1,1,0,0,0,137.4,12.6);
