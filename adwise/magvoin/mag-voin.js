...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/back.jpg?1469716701479", id:"back"},
		{src:"images/bird1.png?1469716701479", id:"bird1"},
		{src:"images/bird2.png?1469716701479", id:"bird2"},
		{src:"images/bli.png?1469716701479", id:"bli"},
		{src:"images/blurr.png?1469716701479", id:"blurr"},
		{src:"images/clouds.png?1469716701479", id:"clouds"},
		{src:"images/mag.png?1469716701479", id:"mag"},
		{src:"images/pla.png?1469716701479", id:"pla"},
		{src:"images/wall.png?1469716701479", id:"wall"},
		{src:"images/war.png?1469716701479", id:"war"}
	]
};
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(259,444.7);
...
p.nominalBounds = new cjs.Rectangle(0,-670,1996.4,1076.6);
...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({scaleX:1,scaleY:1,x:140},3).wait(1).to({scaleX:1.04,scaleY:1.04},4,cjs.Ease.get(-1)).to({scaleX:1.09,scaleY:1.09},5,cjs.Ease.get(1)).to({regX:140.1,scaleX:1.04,scaleY:1.04,x:140.2},5,cjs.Ease.get(-1)).to({regX:140,scaleX:1.03,scaleY:1.03,x:140.1},1,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-8,-670,1996.4,1076.6);
...
(lib.Символ19 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:2903.5},79).wait(1).to({regX:202.9,regY:152.5,scaleX:1.14,skewX:16.2,skewY:-163.8,x:2593.4,y:428.6},0).to({x:138.8,y:-81.5},79).wait(1));
...
(lib.magvoin = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function() {
			...
			_this.clouds.x = windowSize.width/2;
			_this.clouds.y = 0;
			
			_this.bottom.x = windowSize.width/2;
			_this.bottom.y = 0;
			
			_this.woman.x = (windowSize.width/2) - 390;
			_this.woman.y = 0;
			...
			_this.plate.y = -100;
			_this.plate.scaleX = _this.plate.scaleY = 0.6;
			_this.woman.alpha = 0;
			_this.bottom.alpha = 0;
	...
	// woman1
	this.woman = new lib.Символ13();
	this.woman.setTransform(542.6,-0.5,1,1,0,0,0,287,-28.6);

	this.timeline.addTween(cjs.Tween.get(this.woman).wait(1));

	// botom
	this.bottom = new lib.Символ3();
	this.bottom.setTransform(964.2,-0.9,1,1,0,0,0,972.2,-676.9);

	this.timeline.addTween(cjs.Tween.get(this.bottom).wait(1));

	// plate
	this.plate = new lib.Символ5();
	this.plate.setTransform(964.3,3,1,1,0,0,0,384.6,-186.1);

	this.timeline.addTween(cjs.Tween.get(this.plate).wait(1));

	// clouds
	this.clouds = new lib.Символ12();
	this.clouds.setTransform(964.3,0,1,1,0,0,0,4601.1,-397.2);

	this.timeline.addTween(cjs.Tween.get(this.clouds).wait(1));

	// bg
	this.bg = new lib.Символ4();
	this.bg.setTransform(964.2,2,1,1,0,0,0,964.2,2);
