...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/back.jpg?1464273609998", id:"back"},
		{src:"images/hand.png?1464273609998", id:"hand"},
		{src:"images/kabinan1.png?1464273609998", id:"kabinan1"},
		{src:"images/oblakos.png?1464273609998", id:"oblakos"},
		{src:"images/sam11.png?1464273609998", id:"sam11"},
		{src:"images/sam2.png?1464273609998", id:"sam2"},
		{src:"images/w256h2561380453915MouseOptions256x25632.png?1464273609998", id:"w256h2561380453915MouseOptions256x25632"}
	]
};
...
(lib.Символ53копия2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(20,1,1).p("AHutWIFpAAIAAIqANXE6IAAIdIlpAAAtWkpIAAotIGWAAAnANXImWAAIAAodAittWIFHAAACnNXIlQAA");
	this.shape.setTransform(85.5,85.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10,-10,191,191);
...
(lib.Символ53копия = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(2,1,1).p("AHutWIFpAAIAAIqANXE6IAAIdIlpAAAtWkpIAAotIGWAAAnANXImWAAIAAodACnNXIlQAAAittWIFHAA");
	this.shape.setTransform(85.5,85.5);
...
(lib.Символ51копия = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.Символ53копия2();
...
(lib.Символ52копия = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.instance = new lib.Символ51копия();
	this.instance.setTransform(7.8,9.8,0.099,0.099,0,0,0,85.7,85.7);

	this.instance_1 = new lib.Символ51();
	this.instance_1.setTransform(14.5,16.2,0.099,0.099,0,0,0,85.7,85.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},69).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,guide:{path:[7.9,9.9,7.9,9.9,7.8,9.9,7.1,9.6,7,9.3,7,9.1,6.9,8.9,7,8.7,7.1,8.5,5.2,6.9,3.3,5.3,0.7,3.1,-0.7,2.3,-4.2,0.3,-9.3,0.2,-12.6,0.1,-18.4,0.8,-21,1.2,-21.9,2.1,-22.9,3.1,-23.3,5.7,-23.8,9,-24.3,12.3,-24.9,15.8,-24.3,17.7,-23.2,21.1,-19.1,22.6,-17.6,23.1,-15.5,23.4,-14.3,23.5,-11.8,23.6,-5.3,23.8,-2.5,23.4,2.8,22.5,6,19.9,8.6,17.6,11.1,12.1,14.1,5.9,15.8,3.9,17.7,1.7,20.2,0,23.2,-2.2,25.8,-2.7,28.9,-2.9,30.5,-2.9,33.1,-2.8,35.1,-2.1,39.1,-0.7,42,3.4,43.6,5.5,44.5,7.9,45.8,11.3,45.1,14.9,44.4,18.6,42.1,21.5,39.9,24.3,36.4,25.8,32.9,27.3,29.3,27.2,25.7,27,22.3,25.2,19,23.5,16.8,20.6,15.1,18.4,14.8,18.1,14.2,17.6,13.9,17.4,13.4,16.9,13.2,16.5,13,16,13.1,15.4,13.3,14.8,13.9,14.7,14.3,14.7,15,15.1,15,15.2,15,15.2]}},69).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.7,0.3,19,19);
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(286,77.5,1,1,0,0,0,286,77.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 2
	this.instance_1 = new lib.Символ7();
	this.instance_1.setTransform(288.8,28.1,1.924,1.924,0,0,0,20.2,45.3);
	this.instance_1.alpha = 0.32;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Слой 3
	this.instance_2 = new lib.Символ52копия();
	this.instance_2.setTransform(285.4,-60,1,1,0,0,0,8.4,8.4);

	this.instance_3 = new lib.Символ51();
	this.instance_3.setTransform(285.5,-59.9,0.968,0.968,0,0,0,85.5,85.5);

	this.instance_4 = new lib.Символ51();
	this.instance_4.setTransform(285.5,-59.9,1,1,0,0,0,85.5,85.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3},{t:this.instance_2}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-146.4,572,301.5);
...
p.nominalBounds = new cjs.Rectangle(0,-98.9,572,301.5);
