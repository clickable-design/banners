...
lib.properties = {
	...
	color: "#000000",
	manifest: [
		{src:"images/bg2.jpg?1465312172236", id:"bg2"},
		{src:"images/blrck.png?1465312172236", id:"blrck"},
		{src:"images/gb.jpg?1465312172236", id:"gb"},
		{src:"images/gun.png?1465312172236", id:"gun"},
		{src:"images/light.png?1465312172236", id:"light"}
	]
};
...
(lib.Символ31 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.8)").s().p("EDxaBRvMgADijeMHaIAAAMAAACjegEAyrBRvIAAg9IgBA9MlGuAAAMAAAijeMCytAAAIACCkIACikMFSqAAAMAAACjegA6vtXQjFDGAAEYQAAEXDFDDQDHDGEXABQEYgBDFjGQDGjDAAkXQAAkYjGjGQjFjFkYAAQkXAAjHDFgErLGBRvMgAYijeMG3XAAAMAADCjeg");
	this.shape.setTransform(1013.7,523.2);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-3565.4,0,9158.3,1046.4);
...
(lib.Символ36 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(318,145.6,1.611,1.611,0,0,0,2.7,2.7);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(9).to({_off:false},0).to({alpha:0},4).to({_off:true},1).wait(25).to({_off:false,alpha:1},0).to({_off:true},1).wait(4).to({_off:false},0).to({alpha:0},4).to({_off:true},1).wait(26));
...
p.nominalBounds = new cjs.Rectangle(-4456.2,-483.8,9158.3,1046.4);
