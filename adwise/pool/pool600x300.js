...
(lib.Символ32 = function() {
	...
	this.shape.graphics.f("#FFFF00").s().p("");
	this.shape.setTransform(44,7.9);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,88,15.8);
...
(lib.Символ24 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFF00").s().p("");
	this.shape.setTransform(33.5,8.3);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,67,16.5);
...
(lib.Символ18 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(2,1,1).p("");
...
(lib.Символ11 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(5.5,189.5);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,10.9,379);
...
(lib.Символ10 = function() {
	...
	this.instance.setTransform(121.7,152.6,0.807,0.807,15);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(78.1,152.6,205.8,206.4);
...
p.nominalBounds = new cjs.Rectangle(-235.2,-1156.6,2217.7,1573.6);
...
(lib.Символ23 = function() {
	...
	this.instance.setTransform(3.1,212.8,1.089,1.089,0,0,0,5.4,189.6);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-2.8,6.4,11.9,412.7);
...
(lib.Символ22 = function() {
	...
	this.instance.setTransform(58.1,8.9,1.654,1.654,0,0,0,33.5,8.2);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(2.7,-4.6,110.9,27.3);
...
(lib.Символ21 = function() {
	...
	this.instance.setTransform(54.2,13.3,0.913,0.913,0,0,0,57.9,9);

	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("ApeC0QgigBABgiIADkxQABgjAiABIS4APQAhAAAAAiIgEEyQgBAigiAAg");
	this.shape.setTransform(53.8,13);
...
(lib.Символ20 = function() {
	...
	this.instance.setTransform(68.1,13.3,1.505,1.505,0,0,0,44,7.9);

	// Слой 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("Aq3DVQgkAAAAglIABljQAAgkAlgBIVsAFQAmAAgBAkIgBFjQAAAlglAAg");
	this.shape.setTransform(67.9,13.1);
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(48.3,219.4,1.141,1.141,0,0,0,80.1,240.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:246.2,scaleX:1.23,scaleY:1.23,x:46.3,y:294.4},9,cjs.Ease.get(1)).to({regY:246.1,scaleX:0.83,scaleY:0.83,x:47.7,y:202.6},10,cjs.Ease.get(-1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-43,-55.3,182.6,549.7);
...
(lib.Символ14 = function() {
	...
	this.instance.setTransform(10.9,248.4,1,1,0,0,0,5.2,215.1);

	// Слой 3
	this.instance_1 = new lib.Символ17();
	this.instance_1.setTransform(10.2,244.2,1.425,1.425,0,0,0,12.2,162.8);
	this.instance_1.alpha = 0.512;

	// Слой 1
	this.instance_2 = new lib.Символ13();
	this.instance_2.setTransform(11.1,250.7,1.536,1.536,0,0,0,24.6,163.2);

	this.addChild(this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-26.7,0,76.7,508.1);


// stage content:
(lib.pool600x300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(288.5,82.6,0.916,0.916,0,0,0,234.5,35.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 7
	this.movieClip_2 = new lib.Символ10();
	this.movieClip_2.setTransform(399,195.9,0.484,0.484,0,0,0,84,84.2);

	this.timeline.addTween(cjs.Tween.get(this.movieClip_2).wait(1));

	// Слой 1
	this.instance_1 = new lib.Символ12();
	this.instance_1.setTransform(48.2,261.2,0.573,0.573,0,0,0,77.8,42.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Слой 5
	this.movieClip_1 = new lib.Символ18();
	this.movieClip_1.setTransform(301.5,59.9,0.692,0.692,0,0,0,30.9,30.6);

	this.timeline.addTween(cjs.Tween.get(this.movieClip_1).wait(1));

	// Слой 2
	this.girl = new lib.Символ30();
	this.girl.setTransform(293.5,158.4,0.781,0.781,0,0,0,46.5,202.4);

	this.timeline.addTween(cjs.Tween.get(this.girl).wait(1));

	// Слой 3
	this.instance_2 = new lib.Символ14();
	this.instance_2.setTransform(579.7,99.2,0.573,0.564,0,0,0,24.5,163.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// Слой 4
	this.fon = new lib.Символ28();
	this.fon.setTransform(300.5,135.5,0.917,0.893,0,0,0,327.8,192);

	this.timeline.addTween(cjs.Tween.get(this.fon).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(300,107.1,601,371.8);
