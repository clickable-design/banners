...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1473087929157", id:"back"},
		{src:"images/blick.png?1473087929157", id:"blick"},
		{src:"images/bot1.png?1473087929157", id:"bot1"},
		{src:"images/for_03.png?1473087929157", id:"for_03"},
		{src:"images/for_06.png?1473087929157", id:"for_06"},
		{src:"images/for_09.png?1473087929157", id:"for_09"},
		{src:"images/for_13.png?1473087929157", id:"for_13"},
		{src:"images/for_15.png?1473087929157", id:"for_15"},
		{src:"images/for_18.png?1473087929157", id:"for_18"},
		{src:"images/for_24.png?1473087929157", id:"for_24"},
		{src:"images/for_27.png?1473087929157", id:"for_27"},
		{src:"images/logo.jpg?1473087929157", id:"logo"},
		{src:"images/u2rez_17.png?1473087929157", id:"u2rez_17"},
		{src:"images/zir.png?1473087929157", id:"zir"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,82,72);
...
(lib.Символ45 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0,-21,0,21).s().p("AiWDSIAAmiIDTAAQA9AAAWA6QAHAPAAAPIAAAyQAAAwgkAVQAbAMAIAmQAAACABAKIAAAnQAABuhhAAgAhaCVICHAAQAYgBANgWQAHgMAAgJIAAgpQAAgSgXgLQgJgEgKAAIiJAAgAhZgcICKAAQASAAAMgLQALgLAAgTIAAgoQAAgegkgIIgGgBIiJAAg");
	this.shape.setTransform(19.1,25.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0,-21,0,21).s().p("ACBDSIAAmiIA8AAIAAGigAi8DSIAAmiIA9AAIAACyIB/AAQBnAAAABaIAAAoQgCBuhhAAgAiACVIB+AAQAWgBAPgWQAHgLAAgKIAAgqQAAgTgagLQgIgDgJAAIh/AAg");
	this.shape_1.setTransform(60.1,25.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0,-21.4,0,21.5).s().p("AhbDWIgHAAQgVgCgOgQQgNgQAAgWIAAlvIA9AAIAAFYIB8kyQAPgjAYgFQALgCAIAAQAyAAAAA+IAAFoIg8AAIAAlSIh9EtQgSAqgiAAIgBAAg");
	this.shape_2.setTransform(100.7,25.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0.9,-21,0.9,21).s().p("AiBDSIAAk0QABg8AegbQAcgYA+ABICJAAIAAA8IihAAIgLACQgZAKAAAfIAAE7g");
	this.shape_3.setTransform(135.8,25.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0,-21,0,21).s().p("AiVDSIAAmiIC0AAQB3AAAABjIAAA9QAAAwgfAcQgeAbg0AAIh9AAIAACbgAhYgDIB9AAQAYAAAMgJQAMgIADgYIAAhEQgDgTgJgIQgJgGgTgCIgFgBIiDAAg");
	this.shape_4.setTransform(167.8,25.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0,-21,0,21).s().p("ACADSIAAmiIA9AAIAAGigAi8DSIAAmiIA8AAIAACyICAAAQBnAAAABaIAAAoQgCBuhhAAgAiACVIB+AAQAVgBAQgWQAGgLAAgKIAAgqQAAgTgZgLQgIgDgJAAIh/AAg");
	this.shape_5.setTransform(207,25.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0,-21,0,21).s().p("AhoDSQgRgBgUgHQg8gZAAhHIAAk6IA8AAIAAEyQAAAyAuABIBCAAIAAllIA7AAIAAFlIBBAAQAZAAAKgLQALgLAAgZIAAk2IA9AAIAAE6QAABGg9AaQgTAHgRABg");
	this.shape_6.setTransform(253.2,25.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#381D1F").s().p("");
	this.shape_7.setTransform(138.7,25.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,277.5,51);
...
(lib.Символ44 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0.1,-34.5,0.1,34.6).s().p("AANEGQAcAAAHgcQAFgPAAgkIAAlvQAAgjgFgPQgIgbgbAAIAAg1QDNAAAUEDQgCAbAAAcQAAAdACAcQgUECjNAAgAjtAAQAAk6DjAAIAAA1QgbAAgIAbQgFAPAAAjIAAFvQAAAkAFAPQAHAcAcAAIAAA1QjjAAAAk7g");
	this.shape.setTransform(29.8,37.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0.1,-34.5,0.1,34.6).s().p("AANEGQAcAAAHgcQAFgPgBgkIAAlvQABgjgFgPQgIgbgbAAIAAg1QDOAAATEFQgCAaAAAbQAAAbACAaQgTEGjOAAgAjtAAQAAk6DiAAIAAA1QgaAAgJAbQgDANAAAlIAAFvQAAAlADAOQAIAcAbAAIAAA1QjiAAAAk7g");
	this.shape_1.setTransform(83.3,37.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0,-34.5,0,34.6).s().p("AAMEGQAbAAAJgcQADgQAAgjIAAlvQAAgigDgQQgKgbgaAAIAAg1QDiAAAAE6QAAE7jiAAgAjuAAQAAk6DiAAIAAA1QgZAAgKAbQgDANAAAlIAAFvQAAAlADAOQAIAcAbAAIAAA1QjiAAAAk7g");
	this.shape_2.setTransform(136.9,37.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#3A1E20").s().p("");
	this.shape_3.setTransform(83.4,37.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,166.8,75.1);
...
(lib.Символ43 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0,-34,0,34.1).s().p("AhjE2QgxAAABgeQAAgSAPgFIAhgIQAPgJABgYIAAmjQgBghgWgGQgXgHABgSQgBgcAugDICvgLIAAINQAAAfAdAHQAcAGAAAUQAAAegsAAg");
	this.shape.setTransform(20.9,37.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0.1,-34.5,0.1,34.6).s().p("AANEGQAcAAAHgcQAEgOAAglIAAlvQAAglgEgNQgJgbgaAAIAAg1QDOAAATEGQgCAaAAAaQAAAbACAaQgTEGjOAAgAjtAAQAAk6DjAAIAAA1QgbAAgIAbQgFAPAAAjIAAFvQAAAkAFAPQAHAcAcAAIAAA1QjjAAAAk7g");
	this.shape_1.setTransform(74.6,37.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#FFFFFF","#FFD569"],[0,1],0,-34.5,0,34.6).s().p("AAMEGQAcAAAHgcQAFgPAAgkIAAlvQAAgjgFgPQgIgbgbAAIAAg1QDjAAAAE6QAAE7jjAAgAjuAAQAAk6DjAAIAAA1QgbAAgIAbQgFAPAAAjIAAFvQAAAkAFAPQAHAcAcAAIAAA1QjjAAAAk7g");
	this.shape_2.setTransform(128.1,37.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#3A1E20").s().p("");
	this.shape_3.setTransform(79,37.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,158.1,75.1);
...
(lib.Символ41 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(41,38.1,0.329,0.329,0,0,0,41,42.2);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1,scaleY:1,rotation:360,y:42.2,alpha:1},9).to({scaleX:0.33,scaleY:0.33,rotation:720,y:38.1,alpha:0},10).to({rotation:1080},20).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(27.5,24.2,27,23.7);
...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(101.4,17.2,0.725,0.725,0,0,0,138.7,25.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0.8,-1.2,201.1,37);
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(24.6,12.7,0.462,0.462,0,0,0,79,37.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-11.9,-4.7,73,34.7);
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(32.8,12.4,0.452,0.452,0,0,0,83.4,37.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-4.9,-4.5,75.4,33.9);
...
p.nominalBounds = new cjs.Rectangle(-5.6,-4.6,75.4,34);
...
p.nominalBounds = new cjs.Rectangle(-7.2,-0.5,73,34.7);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(161.2,41.7,1,1,0,0,0,41,36);
	this.instance_2.compositeOperation = "lighter";

	this.instance_3 = new lib.Символ41();
	this.instance_3.parent = this;
	this.instance_3.setTransform(21.8,101.5,1,1,0,0,0,41,36);
	this.instance_3.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3},{t:this.instance_2}]},102).wait(81));

	// Слой 12 - копия: 2 - копия: 2
	this.instance_4 = new lib.Символ20();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-54.4,13.2,0.41,0.41,0,0,0,81.5,70.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(122).to({_off:false},0).to({rotation:360,alpha:1},5).to({rotation:720,x:-124.4,y:-18.8,alpha:0},5).to({_off:true},1).wait(50));

	// Слой 12 - копия: 2 - копия
	this.instance_5 = new lib.Символ20();
	this.instance_5.parent = this;
	this.instance_5.setTransform(53.6,16.2,0.41,0.41,0,0,0,81.5,70.5);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(145).to({_off:false},0).to({rotation:360,alpha:1},7).to({rotation:720,alpha:0},7).to({_off:true},1).wait(23));

	// Слой 12 - копия: 2
	this.instance_6 = new lib.Символ20();
	this.instance_6.parent = this;
	this.instance_6.setTransform(215.6,21.2,0.41,0.41,0,0,0,81.5,70.5);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(158).to({_off:false},0).to({rotation:360,alpha:1},7).to({rotation:720,alpha:0},7).to({_off:true},1).wait(10));

	// Слой 12 - копия
	this.instance_7 = new lib.Символ20();
	this.instance_7.parent = this;
	this.instance_7.setTransform(108.6,64.2,0.41,0.41,0,0,0,81.5,70.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(114).to({_off:false},0).to({rotation:360,alpha:1},7).to({rotation:720,alpha:0},7).to({_off:true},1).wait(54));

	// Слой 12
	this.instance_8 = new lib.Символ20();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-51.4,13.2,0.41,0.41,0,0,0,81.5,70.5);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(102).to({_off:false},0).to({rotation:360,alpha:1},7).to({rotation:720,alpha:0},7).to({_off:true},1).wait(66));

	// Слой 10
	this.instance_9 = new lib.Символ18();
	this.instance_9.parent = this;
	this.instance_9.setTransform(525,26.4,3.09,3.09,0,0,0,29.7,13.8);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(96).to({_off:false},0).to({scaleX:3.09,scaleY:3.09,x:355.1,y:18.7},3,cjs.Ease.get(-1)).to({scaleX:2.26,scaleY:2.26,x:155.8,y:81.5},3,cjs.Ease.get(1)).wait(71).to({scaleX:3.09,scaleY:3.09,x:185,y:26.4},0).to({scaleX:3.09,scaleY:3.09,x:355.1,y:26.5},3).to({scaleX:3.09,scaleY:3.09,x:525,y:26.4},3).to({_off:true},1).wait(3));

	// Слой 9
	this.instance_10 = new lib.Символ17();
	this.instance_10.parent = this;
	this.instance_10.setTransform(-353.6,35.7,3.101,3.101,0,0,0,33.6,21);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(96).to({_off:false},0).to({x:-193.6,y:28},3,cjs.Ease.get(-1)).to({scaleX:2.26,scaleY:2.26,x:-3.8,y:88.3},3,cjs.Ease.get(1)).wait(71).to({scaleX:3.1,scaleY:3.1,x:-33.6,y:35.7},0).to({x:-193.6,y:35.8},3).to({x:-353.6,y:35.7},3).to({_off:true},1).wait(3));

	// Слой 8
	this.instance_11 = new lib.Анимация1("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(77.5,317);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(96).to({_off:false},0).to({y:274.5},3,cjs.Ease.get(-1)).to({scaleX:0.69,scaleY:0.69,y:174.8},3,cjs.Ease.get(1)).to({regX:0.1,regY:0.1,x:77.6,y:173.9},8).to({startPosition:0},62).to({startPosition:0},1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:77.5,y:274.5},3).to({y:317},3,cjs.Ease.get(1)).to({_off:true},1).wait(3));

	// Слой 3
	this.instance_12 = new lib.Символ20_1();
	this.instance_12.parent = this;
	this.instance_12.setTransform(-212.7,-222.7,1.659,1.659,0,0,0,17.4,9.5);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(103).to({_off:false},0).to({_off:true},73).wait(7));

	// Слой 4
	this.instance_13 = new lib.Символ25();
	this.instance_13.parent = this;
	this.instance_13.setTransform(105,96.1,1,1,0,0,0,372.9,205);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(126).to({_off:false},0).to({_off:true},1).wait(1).to({_off:false},0).to({_off:true},1).wait(1).to({_off:false},0).to({_off:true},1).wait(1).to({_off:false},0).to({_off:true},1).wait(50));

	// Слой 2
	this.instance_14 = new lib.Символ13();
	this.instance_14.parent = this;
	this.instance_14.setTransform(91,428,1,1,0,0,0,362.7,172.3);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(89).to({_off:false},0).to({y:88},9).wait(75).to({y:428},9).wait(1));

	// Слой 1
	this.instance_15 = new lib.Символ12();
	this.instance_15.parent = this;
	this.instance_15.setTransform(90.7,-283.7,1,1,0,0,0,362.7,172.3);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(89).to({_off:false},0).to({y:76.3},9).wait(75).to({y:-283.7},9).wait(1));

	// Слой 6
	this.instance_16 = new lib.Символ10();
	this.instance_16.parent = this;
	this.instance_16.setTransform(315.5,81.6,1,1,0,0,0,38,3.5);

	this.instance_17 = new lib.Символ10();
	this.instance_17.parent = this;
	this.instance_17.setTransform(195.3,81.6,1,1,0,0,0,38,3.5);

	this.instance_18 = new lib.Символ10();
	this.instance_18.parent = this;
	this.instance_18.setTransform(79.7,81.6,1,1,0,0,0,38,3.5);

	this.instance_19 = new lib.Символ10();
	this.instance_19.parent = this;
	this.instance_19.setTransform(-32.7,81.6,1,1,0,0,0,38,3.5);

	this.instance_20 = new lib.Символ10();
	this.instance_20.parent = this;
	this.instance_20.setTransform(-151.6,81.6,1,1,0,0,0,38,3.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16}]},52).to({state:[{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16}]},46).to({state:[{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16}]},74).to({state:[{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16}]},10).wait(1));

	// Слой 1
	this.instance_21 = new lib.Символ8();
	this.instance_21.parent = this;
	this.instance_21.setTransform(-151.1,-284.8,1,1,0,0,0,47.9,505.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_21).to({y:-294.8},9,cjs.Ease.get(-1)).to({x:-152.1,y:224.2},9).wait(1).to({x:-151.1,y:-284.8},0).to({x:-152.1,y:224.2},9).wait(1).to({x:-151.1,y:-284.8},0).to({y:331.2},10,cjs.Ease.get(1)).wait(144));

	// Символ 8
	this.instance_22 = new lib.Символ8();
	this.instance_22.parent = this;
	this.instance_22.setTransform(-33.1,-216.8,1,1,0,0,0,47.9,505.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(2).to({y:-226.8},9,cjs.Ease.get(-1)).to({x:-34.1,y:292.2},9).wait(1).to({x:-33.1,y:-216.8},0).to({x:-34.1,y:292.2},9).wait(1).to({x:-33.1,y:-216.8},0).to({y:331.2},10,cjs.Ease.get(1)).wait(142));

	// Символ 8
	this.instance_23 = new lib.Символ8();
	this.instance_23.parent = this;
	this.instance_23.setTransform(78.9,-145.8,1,1,0,0,0,47.9,505.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(4).to({y:-155.8},9,cjs.Ease.get(-1)).to({x:77.9,y:363.2},9).wait(1).to({x:78.9,y:-145.8},0).to({x:77.9,y:363.2},9).wait(1).to({x:78.9,y:-145.8},0).to({y:331.2},10,cjs.Ease.get(1)).wait(140));

	// Символ 8
	this.instance_24 = new lib.Символ8();
	this.instance_24.parent = this;
	this.instance_24.setTransform(194.9,79.2,1,1,0,0,0,47.9,505.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(6).to({y:69.2},9,cjs.Ease.get(-1)).to({x:193.9,y:588.2},9).wait(1).to({x:194.9,y:79.2},0).to({x:193.9,y:588.2},9).wait(1).to({x:194.9,y:79.2},0).to({y:330.2},10,cjs.Ease.get(1)).wait(138));

	// Символ 8
	this.instance_25 = new lib.Символ8();
	this.instance_25.parent = this;
	this.instance_25.setTransform(314.9,-64.8,1,1,0,0,0,47.9,505.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(8).to({y:-74.8},9,cjs.Ease.get(-1)).to({x:313.9,y:444.2},9).wait(1).to({x:314.9,y:-64.8},0).to({x:313.9,y:444.2},9).wait(1).to({x:314.9,y:-64.8},0).to({y:330.2},10,cjs.Ease.get(1)).wait(136));
...
(lib.index2 = function(mode,startPosition,loop) {
	...
	this.fon.setTransform(-28.1,0,1.056,1.056,0,0,0,15.8,41.6);
