...
(lib.Символ43 = function() {
	...
	this.shape.graphics.f("#FFFFFF").s().p("AgWB1IAAgpIAtAAIAAApgAgWAkIAAiYIAtAAIAACYg");

	// Слой 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#663300").s().p("AgWB1IAAgpIAtAAIAAApgAgWAkIAAiYIAtAAIAACYg");
	this.shape_1.setTransform(0,2);

	this.addChild(this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-2.3,-11.7,4.7,25.5);
...
(lib.Символ42 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	// Слой 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#663300").s().p("");
	this.shape_1.setTransform(0,2);

	this.addChild(this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-22.6,-11.7,45.3,25.5);
...
(lib.Символ41 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	// Слой 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#663300").s().p("");
	this.shape_1.setTransform(0,2);

	this.addChild(this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-117.4,-11.7,234.8,25.5);
...
(lib.Символ40 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AguASIAAgjIBdAAIAAAjg");

	// Слой 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#663300").s().p("AguASIAAgjIBdAAIAAAjg");
	this.shape_1.setTransform(0,1.5);

	this.addChild(this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-4.7,-1.8,9.5,5.2);
...
(lib.Символ39 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	// Слой 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#663300").s().p("");
	this.shape_1.setTransform(0,2.2);

	this.addChild(this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-32.7,-12,65.4,26.3);
...
(lib.Символ38 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");

	// Слой 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#663300").s().p("");
	this.shape_1.setTransform(0,1.9);

	this.addChild(this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-65.5,-12,131,26);
...
p.nominalBounds = new cjs.Rectangle(-104.1,-30.4,210.4,63.4);
...
(lib.Символ8 = function() {
	...
	this.shape.setTransform(2.3,0.8,1.304,1.051,0,0,180);
...
(lib.Символ7 = function() {
	...
	this.shape.setTransform(1.9,1.8,1.325,1.068,0,0,180);
...
(lib.Символ6 = function() {
	...
	this.shape.setTransform(-1,2.5,1.362,1.098,0,0,180);
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,94);

	this.instance_1 = new lib.Символ43();
	this.instance_1.setTransform(268.7,0,1.62,1.62);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},73).to({state:[{t:this.instance_1}]},10).to({state:[{t:this.instance_1}]},16).to({state:[{t:this.instance_1}]},100).to({state:[{t:this.instance_1}]},21).to({state:[{t:this.instance_1}]},10).to({state:[{t:this.instance}]},19).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(73).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},10,cjs.Ease.get(1)).wait(137).to({scaleX:1.62,scaleY:1.62,alpha:0},10).to({_off:true},19).wait(1));

	// Символ 42
	this.instance_2 = new lib.Символ42();
	this.instance_2.setTransform(239.4,0,1.368,1.368);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(68).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},10,cjs.Ease.get(1)).wait(147).to({scaleX:1.37,scaleY:1.37,alpha:0},10).to({_off:true},9).wait(6));

	// Символ 41
	this.instance_3 = new lib.Символ41();
	this.instance_3.setTransform(87.9,0,1.292,1.292);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(64).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},10,cjs.Ease.get(1)).wait(155).to({scaleX:1.29,scaleY:1.29,alpha:0},10).to({_off:true},1).wait(10));

	// Символ 40
	this.instance_4 = new lib.Символ40();
	this.instance_4.setTransform(-47.1,1.7,1.931,1.931);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(61).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},10,cjs.Ease.get(1)).wait(156).to({scaleX:1.93,scaleY:1.93,alpha:0},10).wait(13));

	// Символ 39
	this.instance_5 = new lib.Символ39();
	this.instance_5.setTransform(-97.2,0,1.326,1.326);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(58).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},10,cjs.Ease.get(1)).wait(156).to({scaleX:1.33,scaleY:1.33,alpha:0},10).wait(16));

	// Символ 38
	this.instance_6 = new lib.Символ38();
	this.instance_6.setTransform(-205.5,0,1.324,1.324);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(54).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},10,cjs.Ease.get(1)).wait(156).to({scaleX:1.32,scaleY:1.32,alpha:0},10).wait(20));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-271,82,542.1,26.3);
...
(lib.Символ35 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({x:438.8,y:-30.1},0).to({x:102.8,y:-14},15,cjs.Ease.get(1)).wait(180).to({x:-851.5,y:-30},10,cjs.Ease.get(-1)).wait(6));
