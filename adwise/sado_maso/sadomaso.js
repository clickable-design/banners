...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/a5188ccde417b1fb93bf0cf390303e0e.png?1470821746295", id:"a5188ccde417b1fb93bf0cf390303e0e"},
		{src:"images/bita.png?1470821746295", id:"bita"},
		{src:"images/button1.png?1470821746295", id:"button1"},
		{src:"images/button2.png?1470821746295", id:"button2"},
		{src:"images/MA8KpFnZW_o.jpg?1470821746295", id:"MA8KpFnZW_o"},
		{src:"images/mouse.png?1470821746295", id:"mouse"},
		{src:"images/razvrat_02.png?1470821746295", id:"razvrat_02"},
		{src:"images/razvrat_06.png?1470821746295", id:"razvrat_06"},
		{src:"images/razvrat_09.png?1470821746295", id:"razvrat_09"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,300,137);
...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-0.9,37,0.632,0.632);

	this.instance_1 = new lib.button1();
	this.instance_1.setTransform(-1.2,39.5,0.633,0.633);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-0.9,37,189.6,86.6);
...
(lib.Символ16_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:-89.8},9).to({y:107.2},10).wait(1));
