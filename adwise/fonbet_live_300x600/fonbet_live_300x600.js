...
(lib.Символ16 = function() {
	...
	this.shape.setTransform(244,31.5,2,2);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-244,-31.4,976,125.8);
...
(lib.Символ10 = function() {
	...
	this.instance.setTransform(38.9,-4);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(38.9,-4,253,53);
...
(lib.Символ15 = function() {
	...
	this.instance.setTransform(-55.2,100.5,1,1,0,0,0,94.6,23.4);

	// Слой 2
	this.instance_1 = new lib.Символ16();
	this.instance_1.setTransform(218,99.4,1,1,0,0,0,224,31.4);

	this.addChild(this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-250,36.6,976,125.8);
...
(lib.Символ12 = function() {
	...
	this.instance.setTransform(199.7,98.6,1.678,1.678,0,0,0,76.7,10.8);

	// Слой 4
	this.instance_1 = new lib.Символ21();
	this.instance_1.setTransform(263,100.2,1,1,0,0,0,244,31.4);

	this.addChild(this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-225,37.3,566,125.8);
...
(lib.Символ9 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(69).to({x:229.5},10,cjs.Ease.get(1)).to({x:239.5},10,cjs.Ease.get(1)).wait(70).to({x:699.5},10,cjs.Ease.get(1)).to({x:719.5},10,cjs.Ease.get(1)).wait(1).to({regY:31.4,scaleX:0.79,scaleY:0.79,x:499.5,y:159.4},0).to({x:182.5},9,cjs.Ease.get(1)).to({regY:31.5,scaleX:1,scaleY:1,x:719.5,y:59.5},1,cjs.Ease.get(1)).to({x:718.5},9,cjs.Ease.get(1)).wait(1));

	// Слой 2
	this.instance_1 = new lib.Символ12();
	this.instance_1.setTransform(18,44.5,1,1,0,0,0,211.5,17.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(59).to({x:28},10,cjs.Ease.get(1)).to({x:-482},10,cjs.Ease.get(1)).wait(80).to({x:28},10,cjs.Ease.get(1)).to({x:18},10,cjs.Ease.get(1)).wait(1).to({scaleX:0.74,scaleY:0.74,x:-352,y:61.5},0).to({x:4},9,cjs.Ease.get(1)).to({scaleX:1,scaleY:1,x:-472,y:44.5},1,cjs.Ease.get(1)).to({x:18},9,cjs.Ease.get(1)).wait(1));

	// logo
	this.instance_2 = new lib.Символ10();
	this.instance_2.setTransform(-73.5,30.5,0.77,0.77,0,0,0,126.5,26.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(200));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-418.5,7,1639,183.3);
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(69).to({_off:false},0).to({x:140.5},9,cjs.Ease.get(1)).to({x:150.5},11,cjs.Ease.get(1)).wait(70).to({x:490.5},5,cjs.Ease.get(1)).to({x:840.5},10,cjs.Ease.get(1)).wait(6).to({x:674.5},0).to({x:144.5},9,cjs.Ease.get(1)).to({x:154.5},5,cjs.Ease.get(1)).wait(1).to({x:384.5},0).to({x:694.5},9,cjs.Ease.get(1)).wait(1));

	// foot1.png
	this.instance_1 = new lib.Символ7();
	this.instance_1.setTransform(109.5,126.5,1,1,0,0,0,109.5,126.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(59).to({x:119.5},10,cjs.Ease.get(1)).to({x:-120.5},9,cjs.Ease.get(1)).wait(81).to({x:139.5},10,cjs.Ease.get(1)).to({x:109.5},10,cjs.Ease.get(1)).wait(1).to({x:-410.5},0).to({x:-150.5},9,cjs.Ease.get(1)).to({x:-160.5},5,cjs.Ease.get(1)).wait(1).to({x:109.5},9,cjs.Ease.get(1)).wait(1));
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(69).to({x:-744.5},10,cjs.Ease.get(1)).wait(80).to({x:487.5},10,cjs.Ease.get(1)).to({x:477.5},10,cjs.Ease.get(1)).wait(1).to({alpha:0},0).to({x:-122.5,alpha:1},5,cjs.Ease.get(1)).to({scaleX:1.11,scaleY:1.11,x:-140.4,y:137.6},5,cjs.Ease.get(1)).to({scaleX:1,scaleY:1,x:-112.5,y:154.5},1,cjs.Ease.get(1)).to({x:477.5},8).wait(1));
...
(lib.fonbet_live_300x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// ramka
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#0045B4").ss(1,1,1).p("EgSvg+fMAlfAAAMAAAB8/MglfAAAg");
	this.shape.setTransform(150,300,1.25,0.75);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// btn.png
	this.btn1 = new lib.Символ4();
	this.btn1.setTransform(150,533,1,1,0,0,0,106,28.5);
	...
	this.people.setTransform(300.5,383,1,1,0,0,0,310.5,126.5);
...
p.nominalBounds = new cjs.Rectangle(-423.9,120.5,3159.8,1181);
