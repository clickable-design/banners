...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/angle.png", id:"angle"},
		{src:"images/arm.png", id:"arm"},
		{src:"images/arrr2.png", id:"arrr2"},
		{src:"images/ass.png", id:"ass"},
		{src:"images/book.png", id:"book"},
		{src:"images/bra.png", id:"bra"},
		{src:"images/chupy.png", id:"chupy"},
		{src:"images/cursor.png", id:"cursor"},
		{src:"images/fono.jpg", id:"fono"},
		{src:"images/foot.png", id:"foot"},
		{src:"images/fot2.png", id:"fot2"},
		{src:"images/hand.png", id:"hand"},
		{src:"images/Hands_03.png", id:"Hands_03"},
		{src:"images/Hands_05.png", id:"Hands_05"},
		{src:"images/Hands_10.png", id:"Hands_10"},
		{src:"images/hed.png", id:"hed"},
		{src:"images/leg2.png", id:"leg2"},
		{src:"images/leg3.png", id:"leg3"},
		{src:"images/sandal.png", id:"sandal"},
		{src:"images/styl.png", id:"styl"},
		{src:"images/styl2.png", id:"styl2"},
		{src:"images/tent.png", id:"tent"}
	]
};
...
(lib.wpagat = function(mode,startPosition,loop) {
	...
	this.piks.setTransform(119.2,270,1,1,0,0,0,-136,76.7);

	this.timeline.addTween(cjs.Tween.get(this.piks).wait(1));

	// Символ 4
	this.instance = new lib.Символ25();
	this.instance.setTransform(258.1,154.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Слой 5
	this.instance_1 = new lib.Символ54();
	this.instance_1.setTransform(-37.6,384);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Символ 3
	this.fon = new lib.Символ47();
	this.fon.setTransform(341.9,121);

	this.timeline.addTween(cjs.Tween.get(this.fon).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(289.6,59.7,749.6,428);
