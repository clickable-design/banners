...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/radar.png", id:"radar"},
		{src:"images/radarpngкопия.png", id:"radarpngкопия"},
		{src:"images/radar2.png", id:"radar2"},
		{src:"images/ter_03.png", id:"ter_03"},
		{src:"images/ter_06.png", id:"ter_06"},
...
p.nominalBounds = new cjs.Rectangle(0,0,368,137);
...
(lib.radarpngкопия = function() {
	this.initialize(img.radarpngкопия);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,396,270);
