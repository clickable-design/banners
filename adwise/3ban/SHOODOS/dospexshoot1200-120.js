...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/darek_zabrocki_05.jpg?1465476459511", id:"darek_zabrocki_05"},
		{src:"images/dospexi_02.png?1465476459511", id:"dospexi_02"},
		{src:"images/dospexi_05.png?1465476459511", id:"dospexi_05"},
		{src:"images/dospexi_08.png?1465476459511", id:"dospexi_08"},
		{src:"images/dospexi_11.png?1465476459511", id:"dospexi_11"},
		{src:"images/dospexi_14.png?1465476459511", id:"dospexi_14"},
		{src:"images/dospexi_18.png?1465476459511", id:"dospexi_18"},
		{src:"images/weap.png?1465476459511", id:"weap"}
	]
};
...
(lib.Символ56 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f().s("#66FF00").ss(2,1,1).p("EhzUgXlMAAACfjEhrMgbzMIGOAAAEhzUiH9MAAABoQEmbBgbzMEgDAAA");
	this.shape.setTransform(726.2,0);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1905.4,-871.2,5263.3,1742.5);
...
(lib.Символ6 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(1068,-200);

	this.instance_1 = new lib.darek_zabrocki_05();
	this.instance_1.setTransform(1072.2,-200,0.991,1,0,0,180);

	this.instance_2 = new lib.darek_zabrocki_05();
	this.instance_2.setTransform(-360,-200);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-360,-200,2148,400);
...
(lib.Символ50 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(360,175);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-25,2148,400);
...
(lib.Символ38 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-8,-2.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-85,-64.3,154,123.2);
...
(lib.Символ37 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(124.3,0);
...
p.nominalBounds = new cjs.Rectangle(39.3,-64.3,154,123.2);
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(304.3,-3,0.947,0.947,-1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Символ 47
	this.instance_1 = new lib.Символ47();
	this.instance_1.setTransform(133.3,1.7,0.747,0.747,-3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// Символ 46
	this.instance_2 = new lib.Символ46();
	this.instance_2.setTransform(469.1,-3.7,0.791,0.791,-2.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(56.4,-34.1,486.6,66.3);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-46.7,77.3);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]}).wait(1));

	// Слой 3
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FF0000").ss(1,1,1).p("ABQAAQAAAhgYAXQgXAYghAAQgfAAgYgYQgYgXAAghQAAggAYgXQAYgYAfAAQAhAAAXAYQAYAXAAAgg");
	this.shape_2.setTransform(-0.8,-2.9);

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(1));

	// Слой 1
	this.instance_19 = new lib.Символ56();
	this.instance_19.setTransform(11.2,175.1);
	this.instance_19.filters = [new cjs.BlurFilter(2, 2, 1)];
	this.instance_19.cache(-1907,-873,5267,1747);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1895.3,-697.1,5269,1748);
...
p.nominalBounds = new cjs.Rectangle(-1895.2,-694.4,5269,1748);
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(172.9,0);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:352.4},19,cjs.Ease.get(-1)).to({x:425.6},16,cjs.Ease.get(1)).to({x:250.4},22,cjs.Ease.get(-1)).to({x:180.7},17,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.2,-147.9,337.4,295.1);
...
(lib.dospexshoot1200120 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function() {
			...
			_this.tek.x = windowSize.width;
			_this.tek.y = 60;
			
			_this.girl.x = (windowSize.width/2)-(windowSize.width/2);
			_this.girl.y = 60;
			...
			_this.gun2.x = (windowSize.width/2)-(windowSize.width/2);
			_this.gun2.y = 80;
	...
	this.gun2.setTransform(288.3,75.9,0.739,0.739,0,0,0,-316.8,-9.5);

	this.gun = new lib.Символ37();
	this.gun.setTransform(539.1,83.7,0.782,0.782);
	...
	this.instance.setTransform(1168.9,55.6,15.726,1.224,0,0,0,0.2,0);
	...
	this.tek.setTransform(1285.9,53.9,1.047,1.047,0,0,0,551.3,-6.7);

	this.girl = new lib.Символ30();
	this.girl.setTransform(326.4,59,0.614,0.614,0,0,0,-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.girl},{t:this.tek}]}).wait(1));

	// Слой 6
	this.fon = new lib.Символ50();
	this.fon.setTransform(-88.1,-153.2,1.116,1);

	this.timeline.addTween(cjs.Tween.get(this.fon).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1577.1,-137.8,5269,1747);
