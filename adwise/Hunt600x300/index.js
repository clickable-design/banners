...
(lib.Символ12копия = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(650.7,134.9,1,1,0,0,0,82.2,23.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Символ 9
	this.instance_1 = new lib.Символ33();
	this.instance_1.setTransform(930,224.6,0.665,1,0,0,0,9.6,68.5);

	this.instance_2 = new lib.Символ16();
	this.instance_2.setTransform(867.2,351.7,1,1,0,0,0,73.8,36.5);

	this.instance_3 = new lib.Символ9();
	this.instance_3.setTransform(400.5,358,1,1,0,0,0,32.5,32);
...
(lib.Символ12 = function() {
	...
	this.cir.setTransform(386.7,133.1,0.499,0.499,0,0,0,27.6,27.6);

	// Слой 12
	this.instance = new lib.Символ19();
	this.instance.setTransform(658.6,123.5,1,1,0,0,0,102.9,15.1);
	...
	this.instance_10.setTransform(400.5,358,1,1,0,0,0,32.5,32);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.main.setTransform(136,155.1,1,1,0,0,0,484.9,155.1);

	this.timeline.addTween(cjs.Tween.get(this.main).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-51.6,149,1004.4,309.3);
