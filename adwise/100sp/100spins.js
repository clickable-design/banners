...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/button1.png?1470314202166", id:"button1"},
		{src:"images/button2.png?1470314202166", id:"button2"},
		{src:"images/Lara_6.png?1470314202166", id:"Lara_6"},
		{src:"images/NetEntGameGonzosQuest2.png?1470314202166", id:"NetEntGameGonzosQuest2"},
		{src:"images/purplestarswallpaper2.jpg?1470314202166", id:"purplestarswallpaper2"},
		{src:"images/ReelStealNetent.png?1470314202166", id:"ReelStealNetent"},
		{src:"images/spins.png?1470314202166", id:"spins"},
		{src:"images/text_03.png?1470314202166", id:"text_03"},
		{src:"images/text_07.png?1470314202166", id:"text_07"},
		{src:"images/TheExterminatorkaraktär.png?1470314202166", id:"TheExterminatorkaraktär"}
	]
};
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-2.2,-1.9,0.783,0.783);

	this.instance_1 = new lib.button2();
	this.instance_1.setTransform(-2.7,-1.3,0.788,0.788);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.2,-1.9,156.7,156.7);
...
(lib._100spins = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.setTransform(126.3,21.4,1,1,0,0,0,104.2,20.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

	// character
	this.instance_2 = new lib.Символ1();
	this.instance_2.setTransform(149.5,155,1,1,0,0,0,90,90);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1));

	// fon
	this.instance_3 = new lib.purplestarswallpaper2();
	this.instance_3.setTransform(-25,-5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(83.5,17.7,416.5,528.2);
