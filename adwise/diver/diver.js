...
p.nominalBounds = new cjs.Rectangle(0,0,128,544);
...
p.nominalBounds = new cjs.Rectangle(-64,-272,128,544);
...
(lib.Символ32 = function() {
	...
	// Слой 1
	this.instance = new lib.ruggo();
	this.instance.setTransform(-117.7,-123.3,0.61,0.61,-30.4);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-117.7,-162.8,235.5,325.7);
...
(lib.Символ43 = function() {
	...
	this.instance.setTransform(0,0,0.115,0.115,-21.2);
...
p.nominalBounds = new cjs.Rectangle(-18.1,-31.7,98.3,63.4);
...
(lib.Символ41 = function(mode,startPosition,loop) {
	...
	// Слой 4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AinB7IAAj1IFPAAIAAD1g");
	this.shape.setTransform(-68.2,77.1);
...
p.nominalBounds = new cjs.Rectangle(-85,64.7,33.7,24.8);
...
p.nominalBounds = new cjs.Rectangle(-100.3,-155,235.5,325.7);
...
(lib.Символ22 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-910.5},69).wait(1));
...
(lib.Символ21 = function() {
	...
	this.shape_1.graphics.f("#000000").s().p("EiD+hMoMEH9AAAMgABCZRMkH8AAAgEgn/AXmMBUHAAAMAAAgvMMhUHAAAg");
...
(lib.Символ29 = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("EgPYAqYMAAAhUvIewAAMAAABUvg");
	this.shape_1.setTransform(388.2,31.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1},{t:this.instance}]},1).wait(1));
...
(lib.Символ28 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-5.8},11).to({y:1.9},13).to({y:15.9},12).to({y:1.9},13).wait(1));
...
(lib.Символ13копия = function() {
	...
	this.instance.setTransform(530,14.4,1.058,1,0,0,180);
...
p.nominalBounds = new cjs.Rectangle(184,-145.7,3463.6,572.2);
...
(lib.Символ13 = function() {
	...
	this.instance.setTransform(385.5,-81.4);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-511.1,-105.4);
...
(lib.diver = function(mode,startPosition,loop) {
	...
	this.klv.setTransform(788,390.9);
